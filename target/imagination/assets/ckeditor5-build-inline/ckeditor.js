...
(function (e) {
    ...
    'object' == typeof exports && 'object' == typeof module ? module.exports = t() : 'function' == typeof define && define.amd ? define([], t) : 'object' == typeof exports ? exports.InlineEditor = t() : e.InlineEditor = t()
    ...
    return function (e) {
        ...
        function n(e) {
            const t = e.match(/^([^:]+):/);
            return t ? e + ` Read more: ${Ja}#error-${t[1]}\n` : e
        }

        function i() {
            let e = 'e';
            for (let t = 0; 8 > t; t++)e += Da(65536 * (1 + Math.random())).toString(16).substring(1);
            return e
        }

        function r(e, t) {
            return e[ts] && e[ts][t] ? e[ts][t].emitter : null
        }
        ...
        {
            t.forEach((t) = > {Object.getOwnPropertyNames(t).concat(Object.getOwnPropertySymbols(t)).forEach((o) = > {if(
            !(o in e.prototype)
        )
            {
        ...
        function _(e) {
            this.__data__ = new ds(e)
        }

        function w(e, t, o) {
            var n = e[t];
            zs.call(e, t) && rs(n, o) && (o !== void 0 || t in e) || (e[t] = o)
        }

        function v(e, t) {
            return Us.call(e, t) || 'object' == typeof e && t in e && null === La(e)
        }
        ...
        function C(e, t, o, n, i, r, a) {
            ...
            var l = al(e);
            if (!l) {
                var d = Hl(e), c = d == wd || d == vd;
                if (Object(kd.a)(e))return bl(e, t);
                if (d == yd || d == _d || c && !r) {
                    if (za(e))return r ? e : {};
                    if (s = bd(c ? {} : e), !t)return vl(e, hl(s, e))
                } else {
                    if (!xd[d])return r ? e : {};
                    s = gd(e, d, C, t)
                }
            } else if (s = $l(e), !t)return kl(e, s);
            a || (a = new Ds);
            var u = a.get(e);
            if (u)return u;
            if (a.set(e, s), !l)var m = o ? Cl(e) : fl(e);
            return Bs(m || e, function (i, r) {
                m && (r = i, i = e[r]), js(s, r, C(i, t, o, n, r, e, a))
            }), s
        }

        function A(e, t) {
            const o = Ma(e.length, t.length);
        ...
        function M(e) {
            return 'string' == typeof e ? [new Pd(e)] : (P(e) || (e = [e]), Array.from(e).map((e) = > 'string' == typeof e ? new Pd(e) : e instanceof Ed ? new Pd(e.data) : e)
        )
        }
        ...
        function B(e, t, o) {
            if (!cs(o))return !1;
            var n = typeof t;
            return !('number' == n ? !(Xs(o) && ml(t, o.length)) : !('string' == n && t in o)) && rs(o[t], e)
        }
        ...
        function z(e) {
            cc in e || (Object.defineProperty(e, cc, {value: new Map}), Object.defineProperty(e, uc, {value: new Map}), Object.defineProperty(e, mc, {value: new Map}))
        }
        ...
        )
        {
            ...
            o = Array.from(this._bindings.keys()), n = o.length;
            if (!t.callback && 1 < t.to.length)throw new Qa('observable-bind-to-no-callback: Binding multiple observables only possible with callback.');
            if (1 < n && t.callback)throw new Qa('observable-bind-to-extra-callback: Cannot bind multiple properties and use a callback in one binding.');
            t.to.forEach((e) = > {if(e.properties.length && e.properties.length !== n
        )
            throw new Qa('observable-bind-to-properties-length: The number of properties must match.');
        ...
        function q(e, t, o) {
            if (1 < this._bindings.size)throw new Qa('observable-bind-to-many-not-one-binding: Cannot bind multiple properties with toMany().');
            this.to(...W(e, t), o
        )
        }
        ...
        {
            if (!e.length)throw new Qa('observable-bind-to-parse-error: Invalid argument syntax in `to()`.');
            const t = {to: []};
            let o;
            ...
            if ('object' == typeof e) o = {
                observable: e,
                properties: []
            }, t.to.push(o); else throw new Qa('observable-bind-to-parse-error: Invalid argument syntax in `to()`.')
        }),
            t
        }
        function K(e, t, o, n) {
            const i = e[uc], r = i.get(o), a = r || {};
            a[n] || (a[n] = new Set), a[n].add(t), r || i.set(o, a)
        }

        function G(e) {
            let t;
            e._bindings.forEach((o, n) = > {e._to.forEach((i) = > {
                t=i.properties[o.callback ? 0 : e._bindProperties.indexOf(n)],
                o.to.push([i.observable, t]), K(e._observable, o, i.observable, t)
        })
        })
        }

        function $(e, t) {
            const o = e[mc], n = o.get(t);
            let i;
            n.callback ? i = n.callback.apply(e, n.to.map((e) = > e[0][e[1]])
        ):
            (i = n.to[0], i = i[0][i[1]]), e.hasOwnProperty(t) ? e[t] = i : e.set(t, i)
        }

        function J(e, t) {
            t.forEach((t) = > {const o = e[uc];
            let n;
            o.get(t.observable) || e.listenTo(t.observable, 'change', (i, r) = > {
                n=o.get(t.observable)[r],
                n && n.forEach((t) = > {$(e, t.property
        )
        })
        })
        })
        ...
        function te(e) {
            let t;
            if ('string' != typeof e) t = e.keyCode + (e.altKey ? Fc.alt : 0) + (e.ctrlKey ? Fc.ctrl : 0) + (e.shiftKey ? Fc.shift : 0); else if (t = Fc[e.toLowerCase()], !t)throw new Qa('keyboard-unknown-key: Unknown key name.', {key: e});
            return t
        }

        function oe(e) {
            return 'string' == typeof e && (e = ie(e)), e.map((e) = > 'string' == typeof e ? te(e) : e
        ).
            reduce((e, t) = > t + e, 0
        )
        }
        ...
        function ne(e) {
            return Rc.isMac ? ie(e).map((e) = > Vc[e.toLowerCase()] || e
        ).
            reduce((e, t) = > e.slice(-1) in Ic ? e + t : e + '+' + t
        ):
            e
        }
        ...
        function me(e) {
            ...
            if (t && t.is('text'))return new wc(t, t.data.length);
            const o = e.nodeAfter;
            return o && o.is('text') ? new wc(o, 0) : e
        }

        function pe(e) {
            if (e.offset == e.parent.data.length)return new wc(e.parent.parent, e.parent.index + 1);
            if (0 === e.offset)return new wc(e.parent.parent, e.parent.index);
            const t = e.parent.data.slice(e.offset);
            return e.parent._data = e.parent.data.slice(0, e.offset), e.parent.parent._insertChild(e.parent.index + 1, new Pd(t)), new wc(e.parent.parent, e.parent.index + 1)
        }

        function ge(e, t) {
            const o = e.data.length;
            return e._data += t.data, t._remove(), new wc(e, o)
        }
        ...
        function he(e) {
            for (const t of e) {
                if (!Bc.some((e) = > t instanceof e))
                throw new Qa('view-writer-insert-invalid-node');
        ...
        function ke(e) {
            ...
            if (!t || !o || t !== o)throw new Qa('view-writer-invalid-range-container')
        }
        ...
        function we(e) {
            return e instanceof Text && e.data.substr(0, jc) === qc
        }

        function ve(e) {
            return e.data.length == jc && we(e)
        }

        function ye(e) {
            return we(e) ? e.data.slice(jc) : e.data
        }

        function xe(e, t) {
            let o = Wc.get(t);
            return o || (o = t(window.document), Wc.set(t, o)), e.isEqualNode(o)
        }
        ...
        function Ne(e, t) {
            for (; e && e != Hc.document;)t(e), e = e.parentNode
        }
        ...
        function Le(e) {
            var t = -1, o = e ? e.length : 0;
            for (this.__data__ = new Ms; ++t < o;)this.add(e[t])
        }

        function ze(e, t, o, n, i, r) {
            var a = i & nu, s = fl(e), l = s.length, d = fl(t), c = d.length;
            if (l != c && !a)return !1;
            for (var u = l, m; u--;)if (m = s[u], a ? !(m in t) : !Hs(t, m))return !1;
            var p = r.get(e);
            if (p)return p == t;
            var g = !0;
            r.set(e, t);
        ...
        function je(e, t, o, n, i) {
            return !(e !== t) || (null != e && null != t && (cs(e) || ja(t)) ? pu(e, t, je, o, n, i) : e !== e && t !== t)
        }
        ...
        function qe(e, t, o) {
            ...
            if ('function' != typeof e)throw new TypeError(yu);
            return t = Wd(t) || 0, cs(o) && (g = !!o.leading, f = 'maxWait' in o, _ = f ? xu(Wd(o.maxWait) || 0, t) : _, h = 'trailing' in o ? !!o.trailing : h), u.cancel = d, u.flush = c, u
        }

        function We(e) {
            return e == Fc.arrowright || e == Fc.arrowleft || e == Fc.arrowup || e == Fc.arrowdown
        }
        ...
        function Ke(e, t) {
            for (const o of Fu)e[o] = t[o]
        }

        function Ge(e) {
            return !!Iu(e) && e === e.ownerDocument.body
        }
        ...
        function Je(e, t, o) {
            const n = t.clone().moveBy(0, o), i = t.clone().moveBy(0, -o), r = new Vu(e).excludeScrollbarsAndBorders();
        ...
        function Qe(e, t) {
            const o = tt(e);
            for (let n, i; e != o.document.body;)i = t(), n = new Vu(e).excludeScrollbarsAndBorders(), n.contains(i) || (Xe(i, n) ? e.scrollTop -= n.top - i.top : Ye(i, n) && (e.scrollTop += i.bottom - n.bottom), Ze(i, n) ? e.scrollLeft -= n.left - i.left : et(i, n) && (e.scrollLeft += i.right - n.right)), e = e.parentNode
        }
        ...
        function it(e, t) {
            const o = tt(e), n = new Vu(e);
            if (o === t)return n;
            for (let i = o; i != t;) {
                const e = i.frameElement, t = new Vu(e).excludeScrollbarsAndBorders();
        ...
        function rt(e) {
            return Ga(e) ? T(e) : new Map(e)
        }

        function at(e) {
            return 'string' == typeof e ? [new Du(e)] : (P(e) || (e = [e]), Array.from(e).map((e) = > 'string' == typeof e ? new Du(e) : e instanceof Bu ? new Du(e.data, e.getAttributes()) : e)
        )
        }
        ...
        function dt(e, t, o) {
            ...
            i.shift(), i.reverse();
            const r = i.some((e) = > {if(n.containsItem(e)
        )
            {
        ...
        function mt() {
            ...
            this.listenTo(this.root.document.model, 'applyOperation', (t, o) = > {const n = o[0];
        ...
        function pt(e) {
            ...
            let n, i;
            'insert' == t ? n = Uu.createFromPositionAndShift(e.position, e.nodes.maxOffset) : (n = Uu.createFromPositionAndShift(e.getMovedRangeStart(), e.howMany), i = e.sourcePosition);
            ...
            const l = Uu.createFromRanges(s), d = !l.isEqual(this), c = this.containsPosition(a),
                u = i && (this.containsPosition(i) || this.start.isEqual(i));
            if (d) {
                const e = Uu.createFromRange(this);
            ...
            } else(c || u) && this.fire('change:content', Uu.createFromRange(this), {
                type: t,
                batch: o,
                range: n,
                sourcePosition: i
        ...
        function gt(e) {
            return e instanceof Bu || e instanceof Du ? e.getAttributes() : null
        }
        ...
        function ft(e, t) {
            ...
            for (const n of o.getChanges()) {
                ...
                i && e.enqueueChange(t, (e) = > {const t = Array.from(o.getAttributeKeys()).filter((e) = > e.startsWith(Qu)
            )
                ;
        ...
        function ht(e) {
            return e = Zu(e), e.view = _t(e.view, 'container'), (t) =
        >
            {
        ...
        function _t(e, t) {
            return 'function' == typeof e ? e : (o, n) =
        >
            wt(e, n, t)
        }
        ...
        >
            {
                const n = o.mapper.toViewPosition(t.position), i = t.position.getShiftedBy(t.length),
                    r = o.mapper.toViewPosition(i, {isPhantom: !0}), a = new vc(n, r),
                    s = o.writer.remove(a.getTrimmed());
                for (const n of vc.createIn(s).getItems())o.mapper.unbindViewElement(n)
            }
        }

        function Tt(e) {
            return e = e || ((e, t) = > ({value: e, key: t.attributeKey})
        ),
            (t, o, n) =
        >
            {
        ...
        >
            {
                ...
                if ((i || r) && n.consumable.consume(o.item, t.name)) {
                    ...
                    if (o.item instanceof $u || o.item instanceof Yu) e.wrap(t.getFirstRange(), r); else {
        ...
        >
            {
                const i = n.newSelection, r = new $u, a = [];
        ...
        function Gt(e) {
            return 'string' == typeof e ? {name: e, * getAttributeKeys(){}, getAttribute()
            {
            }
        }:
            {
        ...
        function Jt(e, t) {
            const o = new Set, n = new Map, i = Uu.createIn(e).getItems();
            for (const n of i)'$marker' == n.name && o.add(n);
            for (const i of o) {
                const e = i.getAttribute('data-name'), o = Wu.createBefore(i);
                n.has(e) ? n.get(e).end = Wu.createFromPosition(o) : n.set(e, new Uu(Wu.createFromPosition(o))), t.remove(i)
            }
            return n
        }
                ...
                if (r) {
                    ...
                    if (t && i.consumable.test(n.viewItem, r.match)) {
                        ...
                        if (e) {
                            ...
                            const o = i.convertChildren(n.viewItem, Wu.createAt(t));
                            i.consumable.consume(n.viewItem, r.match), n.modelRange = new Uu(Wu.createBefore(t), Wu.createAfter(o.modelCursor.parent)), n.modelCursor = e.cursorParent ? Wu.createAt(e.cursorParent) : n.modelRange.end
                        }
                    }
                }
            }
        ...
        function io(e, t=null) {
            const o = 'object' == typeof e.model ? e.model.key : e.model,
                n = 'object' != typeof e.model || 'undefined' == typeof e.model.value ? !(null !== t) || ((e) = > e.getAttribute(t)
        ):
            e.model.value;
        ...
        >
            {
                if (o.schema.checkChild(t.modelCursor, '$text') && o.consumable.consume(t.viewItem)) {
                    ...
                    o.writer.insert(e, t.modelCursor), t.modelRange = Uu.createFromPositionAndShift(t.modelCursor, e.offsetSize), t.modelCursor = t.modelRange.end
                }
            }
        }
        ...
        function ho(e, t) {
            ...
            yo(e);
            const i = e.index;
            return n._insertChild(i, t), vo(n, i + t.length), vo(n, i), new Uu(e, e.getShiftedBy(o))
        }

        function bo(e) {
            if (!e.isFlat)throw new Qa('operation-utils-remove-range-not-flat: Trying to remove a range which starts and ends in different element.');
        ...
        function ko(e, t) {
            if (!e.isFlat)throw new Qa('operation-utils-move-range-not-flat: Trying to move a range which starts and ends in different element.');
            const o = bo(e);
        ...
        function wo(e) {
            ...
            for (let o = 0; o < e.length; o++)if ('string' == typeof e[o]) t.push(new Du(e[o])); else if (e[o] instanceof Bu) t.push(new Du(e[o].data, e[o].getAttributes())); else if (e[o] instanceof mm || e[o] instanceof Lu)for (const n of e[o])t.push(n); else e[o] instanceof Mu && t.push(e[o]);
            for (let o = 1; o < t.length; o++) {
                const e = t[o], n = t[o - 1];
                e instanceof Du && n instanceof Du && xo(e, n) && (t.splice(o - 1, 2, new Du(n.data + e.data, n.getAttributes())), o--)
            }
            return t
        }
        ...
        function vo(e, t) {
            ...
            if (o && n && o.is('text') && n.is('text') && xo(o, n)) {
                const i = new Du(o.data + n.data, o.getAttributes());
        ...
        function yo(e) {
            ...
            if (t) {
                ...
                const r = new Du(t.data.substr(0, n), t.getAttributes()),
                    a = new Du(t.data.substr(n), t.getAttributes());
        ...
        function So(e, t, o) {
            let n = '$graveyard' == t.root.rootName ? bm : '$graveyard' == e.start.root.rootName ? hm : fm;
        ...
        function Oo(e, t, o, n, i) {
            ...
            for (o || (o = jm), i || (i = []); ++r < a;) {
                var s = e[r];
                0 < t && o(s) ? 1 < t ? Oo(s, t - 1, o, n, i) : yl(i, s) : !n && (i[i.length] = s)
            }
            return i
        }
        ...
        function Ro(e, t, o, n) {
            ...
            for (; ++i < r;) {
                ...
                if (!(a && s[2])) {
                    ...
                    if (void 0 === m ? !gu(c, d, n, Xm | Zm, u) : !m)return !1
        ...
        function Io(e, t) {
            if ('function' != typeof e || t && 'function' != typeof t)throw new TypeError(sp);
            var o = function () {
            ...
            return o.cache = new (Io.Cache || Ms), o
        }

        function Vo(e, t) {
            if (al(e))return !1;
            var o = typeof e;
            return !!('number' == o || 'symbol' == o || 'boolean' == o || null == e || Md(e)) || bp.test(e) || !hp.test(e) || null != t && e in Object(t)
        }
        ...
        function Do(e, t) {
            ...
            const r = new Pm;
            for (let o = 0; o < t; o++)r.addOperation(new wm(n++));
            e.push(r)
        }
        ...
        function qo(e, t, o) {
            ...
            for (const n of e.operations) {
                for (const e of t.operations)if (n instanceof fm && e instanceof fm && Wo(n, e)) {
                    i = !0;
                    break
                }
                if (i)break
        ...
        function Ho(e, t) {
            ...
            switch (e) {
                case Rm:
                case Im:
                    for (const e of t)i = e instanceof wm ? new Pm : e instanceof bm ? new Im : new Rm, i.addOperation(e), n.push(i);
                    return n;
                case Sm:
                case Fm:
                    return i = new e, i.addOperation(t[0]), i.addOperation(t[1]), n = Ho(Rm, t.slice(2)), [i].concat(n);
                case Om:
                case Nm:
                    return n = Ho(Rm, t.slice(0, -2)), i = new e, i.addOperation(t[t.length - 2]), i.addOperation(t[t.length - 1]), n.concat(i);
                case Vm:
                    return i = t[0] instanceof wm ? new Pm : new Vm, i.addOperation(t[0]), [i];
                case Em:
                    for (o = 0; o < t.length && !!(t[o] instanceof wm); o++);
                    o == t.length ? i = new Pm : (i = new Em, 0 != o && t.unshift(t.splice(o, 1)[0]));
        ...
        function Go(e, t) {
            function o() {
                const o = new Uu(e.position.getShiftedBy(s), e.position.getShiftedBy(l)),
                    i = new gm(o, t.key, a, t.value, 0);
                n.addOperation(i)
            }

            const n = new Em, r = e.nodes;
        ...
        function $o() {
            const e = new Pm;
            return e.addOperation(new wm(0)), e
        }

        function Jo(e, t, o, n) {
            function i() {
                0 === r.operations.length && e.batch.addDelta(r);
                const n = new Uu(l, d), i = n.root.document ? s.version : null, u = new gm(n, t, c, o, i);
                r.addOperation(u), a.applyOperation(u)
            }

            const r = new Em, a = e.model, s = a.document;
            let l = n.start, d, c, u;
            for (const r of n)u = r.item.getAttribute(t), d && c != u && (c != o && i(), l = d), d = r.nextPosition, c = u;
            d instanceof Wu && d != l && c != o && i()
        }
        ...
        function Qo(e, t, o, n) {
            ...
            let s, l;
            if (a != o) {
                const d = n.root === n, c = d ? new Mg : new Em;
                if (e.batch.addDelta(c), d) {
                    const e = n.document ? r.version : null;
                    l = new ym(n, t, a, o, e)
                } else {
                    s = n.is('element') ? new Uu(Wu.createBefore(n), Wu.createFromParentAndOffset(n, 0)) : new Uu(Wu.createBefore(n), Wu.createAfter(n));
        ...
        function Yo(e, t, o, n) {
            const i = e.model, r = i.document, a = new Ig, s = new _m(t, o, n, i.markers, r.version);
        ...
        function Xo(e, t, o, n) {
            let i;
            if (e.root.document) {
                const o = n.document, r = new Wu(o.graveyard, [0]);
                i = new bm(e, t, r, o.version)
            } else i = new Dg(e, t);
            o.addOperation(i), n.applyOperation(i)
        }

        function Zo(e, t) {
            return !(e !== t) || !!(e instanceof Bg && t instanceof Bg)
        }
        ...
        function tn(e, t) {
            ...
            'e'.repeat(r.offset - n).split('')
        ),
            i += r.offset - n
        ),
            'insert' == r.type ? (o.push(...'i'.repeat(r.howMany).split('')
        ),
            n = r.offset + r.howMany
        ):
            'remove' == r.type ? (o.push(...'r'.repeat(r.howMany).split('')
        ),
            n = r.offset, i += r.howMany
        ):
            (o.push(...
            'a'.repeat(r.howMany).split('')
        ),
            n = r.offset + r.howMany, i += r.howMany
        )
            ;
            return i < e && o.push(...
            'e'.repeat(e - i).split('')
        ...
        function un(e) {
            let t, o;
            'insert' == e.type ? t = Uu.createFromPositionAndShift(e.position, e.nodes.maxOffset) : (t = Uu.createFromPositionAndShift(e.getMovedRangeStart(), e.howMany), o = e.sourcePosition);
            ...
            switch (e.type) {
                ...
                case'remove':
                case'reinsert':
                    const a = Uu.createFromPositionAndShift(o, n),
            ...
            if (!this.isEqual(i)) {
                const e = Wu.createFromPosition(this);
                this.path = i.path, this.root = i.root, this.fire('change', e)
            }
        }

        function mn(e, t, o) {
            e.change((n) = > {o.isCollapsed || e.deleteContent(o);
            const i = new Gg(e, n, o.anchor);
            let r;
            r = t.is('documentFragment') ? t.getChildren() : [t], i.handleNodes(r, {isFirst: !0, isLast: !0});
            const a = i.getSelectionRange();
            a ? o instanceof Yu ? n.setSelection(a) : o.setTo(a) : Eu.warn('insertcontent-no-range: Cannot determine a proper selection range after insertion.')
        })
        }
        ...
        function pn(e, t, o={}) {
            ...
            const n = e.schema;
            e.change((e) = > {if(
            !o.doNotResetEntireContent && _n(n, t)
        )
            return void kn(e, t, n);
            const i = t.getFirstRange(), r = i.start, a = Kg.createFromPosition(i.end);
            i.start.isTouching(i.end) || e.remove(i), o.leaveUnmerged || (gn(e, r, a), n.removeDisallowedAttributes(r.parent.getChildren(), e)), t instanceof Yu ? e.setSelection(r) : t.setTo(r), fn(n, r) && bn(e, r, t), a.detach()
        })
        }
        ...
        function gn(e, t, o) {
            ...
            if (n != i && n.parent && i.parent && hn(t, o, e.model.schema)) {
                for (t = Wu.createAfter(n), o = Wu.createBefore(i), o.isEqual(t) || e.insert(i, t), e.merge(t); o.parent.isEmpty;) {
                    const t = o.parent;
                    o = Wu.createBefore(t), e.remove(t)
                }
                gn(e, t, o)
            }
        }
        ...
        function bn(e, t, o) {
            ...
            e.insert(n, t), o instanceof Yu ? e.setSelection(n, 0) : o.setTo(n, 0)
        }

        function kn(e, t) {
            const o = e.model.schema.getLimitElement(t);
            e.remove(Uu.createIn(o)), bn(e, Wu.createAt(o), t)
        }
        ...
        function wn(e, t, o={}) {
            const n = e.schema, i = 'backward' != o.direction, r = o.unit ? o.unit : 'character', a = t.focus,
                s = new ju({boundaries: Cn(a, i), singleCharacters: !0, direction: i ? 'forward' : 'backward'}),
                l = {walker: s, schema: n, isForward: i, unit: r};
            for (let n; n = s.next();) {
                if (n.done)return;
                const o = vn(l, n.value);
                if (o)return void(t instanceof Yu ? e.change((e) = > {e.setSelectionFocus(o)
            }):
                t.setFocus(o)
            )
            }
        ...
        function vn(e, t) {
            ...
            if (t.type == (e.isForward ? 'elementStart' : 'elementEnd')) {
                if (e.schema.isObject(t.item))return Wu.createAt(t.item, e.isForward ? 'after' : 'before');
        ...
        function xn(e, t) {
            ...
            if (o)for (let n = e.position.offset - o.startOffset; !An(o.data, n, t) && !Tn(o, n, t);) {
                ...
                if (i) {
                    ...
                    $g.includes(n) || (e.next(), o = e.position.textNode)
                }
        ...
        function Cn(e, t) {
            const o = e.root, n = Wu.createAt(o, t ? 'end' : 0);
            return t ? new Uu(e, n) : new Uu(n, e)
        }

        function An(e, t, o) {
            const n = t + (o ? 0 : -1);
            return $g.includes(e.charAt(n))
        }
        ...
        function Pn(e, t) {
            return e.change((e) = > {const o = e.createDocumentFragment(), n=t.getFirstRange();
            if (!n || n.isCollapsed)return o;
            const i = n.start.root, r = n.start.getCommonPath(n.end), a = i.getNodeByPath(r);
            let s = n.start.parent == n.end.parent ? n : Uu.createFromParentsAndOffsets(a, n.start.path[r.length], a, n.end.path[r.length] + 1);
            ...
            if (s != n) {
                const t = n._getTransformedByMove(s.start, Wu.createAt(o, 0), l)[0],
                    i = new Uu(Wu.createAt(o), t.start), r = new Uu(t.end, Wu.createAt(o, 'end'));
                En(r, e), En(i, e)
            }
            return o
        })
        ...
        function En(e, t) {
            const o = [];
            Array.from(e.getItems({direction: 'backward'})).map((e) = > Uu.createOn(e)
        ).
            filter((t) = > {const o = (t.start.isAfter(e.start) || t.start.isEqual(e.start)) && (t.end.isBefore(e.end) || t.end.isEqual(e.end));
            return o
        }).
            forEach((e) = > {o.push(e.start.parent), t.remove(e)
        }),
            o.forEach((e) = > {for(let o=e;
            o.parent && o.isEmpty;
        )
            {
                const e = Uu.createOn(o);
        ...
        function On(e) {
            if (!ps(e.updateElement))throw new Qa('attachtoform-missing-elementapi-interface: ElementApi interface is required.');
            const t = e.element;
            ...
            >
                e.updateElement();
                ps(n.submit) && (o = n.submit, n.submit = () = > {i(), o.apply(n)
            }),
                n.addEventListener('submit', i), e.on('destroy', () = > {n.removeEventListener('submit', i), o && (n.submit = o)
            })
            }
        }
        ...
        function In({origin: e, originKeystrokeHandler: t, originFocusTracker: o, toolbar: n, beforeFocus: i, afterBlur: r}) {
            o.add(n.element), t.set('Alt+F10', (e, t) = > {o.isFocused && !n.focusTracker.isFocused && (i && i(), n.focus(), t())
        }),
            n.keystrokes.set('Esc', (t, o) = > {n.focusTracker.isFocused && (e.focus(), r && r(), o())
        })
        }
        ...
        function Nn(e) {
            return !!e && ((e.value && (e = e.value), Array.isArray(e)) ? e.some(Nn) : !!(e instanceof cf))
        }

        function Mn(e, t) {
            return e.map((e) = > e instanceof cf ? e.getValue(t) : e
        )
        }

        function Dn(e, t, {node: o}) {
            let n = Mn(e, o);
            n = 1 == e.length && e[0] instanceof mf ? n[0] : n.reduce($n, ''), Yn(n) ? t.remove() : t.set(n)
        }
        ...
        function jn(e) {
            const t = lf(e, (e) = > {if(e && (e instanceof cf || Zn(e) || Xn(e) || ei(e))
        )
            return e
        })
            ;
        ...
        function qn(e) {
            if ('string' == typeof e ? e = Hn(e) : e.text && Kn(e), e.on && (e.eventListeners = Un(e.on), delete e.on), !e.text) {
                ...
                const t = [];
                if (e.children)if (ei(e.children)) t.push(e.children); else for (const o of e.children)Zn(o) || Xn(o) || Me(o) ? t.push(o) : t.push(new df(o));
                e.children = t
            }
            return e
        }
        ...
        function Jn(e, t) {
            for (const o in t)e[o] ? e[o].push(...t[o]
        ):
            e[o] = t[o]
        }

        function Qn(e, t) {
            if (t.attributes && (!e.attributes && (e.attributes = {}), Jn(e.attributes, t.attributes)), t.eventListeners && (!e.eventListeners && (e.eventListeners = {}), Jn(e.eventListeners, t.eventListeners)), t.text && e.text.push(...t.text),
            t.children && t.children.length
        )
            {
                if (e.children.length != t.children.length)throw new Qa('ui-template-extend-children-mismatch: The number of children in extended definition does not match.');
                let o = 0;
        ...
        function ni(e) {
            for (; e && 'html' != e.tagName.toLowerCase();) {
                if ('static' != Hc.window.getComputedStyle(e).position)return e;
                e = e.parentElement
            }
            return null
        }

        function ii({element: e, target: t, positions: o, limiter: n, fitInViewport: i}) {
            ps(t) && (t = t()), ps(n) && (n = n());
            const r = ni(e.parentElement), a = new Vu(e), s = new Vu(t);
            let l, d;
            if (!n && !i) [d, l] = ri(o[0], s, a); else {
                const e = n && new Vu(n).getVisible(), t = i && new Vu(Hc.window);
                [d, l] = ai(o, s, a, e, t) || ri(o[0], s, a)
            }
            let {left: c, top: u} = si(l);
            if (r) {
                const e = si(new Vu(r)), t = He(r);
        ...
        function si({left: e, top: t}) {
            const {scrollX: o, scrollY: n} = Hc.window;
            return {left: e + o, top: t + n}
        }

        function li(e) {
            return Iu(e) ? e : Ue(e) ? e.commonAncestorContainer : 'function' == typeof e ? li(e()) : null
        }

        function di(e, t) {
            return e.top - t.height - Af.arrowVerticalOffset
        }

        function ci(e) {
            return e.bottom + Af.arrowVerticalOffset
        }

        function ui(e) {
            return !!(e.focus && 'none' != Hc.window.getComputedStyle(e.element).display)
        }
        ...
        function gi(e) {
            ...
            return t.length ? t : o.filter((e) = > 'file' === e.kind
        ).
            map((e) = > e.getAsFile()
        )
        }
        ...
        function ki(e) {
            ...
            if (e.is('text') || e.is('textProxy')) t = e.data; else if (e.is('img') && e.hasAttribute('alt')) t = e.getAttribute('alt'); else {
                ...
                for (const n of e.getChildren()) {
                    const e = ki(n);
                    o && (o.is('containerElement') || n.is('containerElement')) && (Mf.includes(o.name) || Mf.includes(n.name) ? t += '\n' : t += '\n\n'), t += e, o = n
                }
            }
            return t
        }
        ...
        function _i(e, t, o, n) {
            ...
            if (i) wi(t, o, r.start); else {
                const n = !(r.start.isAtStart && r.end.isAtEnd);
                e.deleteContent(o, {leaveUnmerged: n}), n && (a == s ? wi(t, o, o.focus) : t.setSelection(s, 0))
            }
        }
        ...
        function vi(e, t) {
            ...
            const i = [];
            let r = 0, a;
            return e.forEach((e) = > {'equal' == e ? (o(), r++) : 'insert' == e ? (n('insert') ? a.values.push(t[r]) : (o(), a = {
                type: 'insert',
                index: r,
                values: [t[r]]
        ...
        function yi(e) {
            return !!e.ctrlKey || Kf.includes(e.keyCode)
        }

        function xi(e, t) {
            return e instanceof Pd && t instanceof Pd ? e.data === t.data : e === t
        }

        function Ci(e) {
            if (1 == e.newChildren.length - e.oldChildren.length) {
                const t = Te(e.oldChildren, e.newChildren, xi), o = vi(t, e.newChildren);
                if (!(1 < o.length)) {
                    const e = o[0];
                    return e.values[0] instanceof Pd ? e : void 0
                }
            }
        }
        ...
        function Ti(e) {
            ...
            for (const t of e)if ('children' === t.type && !Ci(t))return !0;
            return !1
        }
        ...
        function Ri() {
            let e = Ii(wh);
            return e && e.length == vh || (e = Fi(vh), Vi(wh, e)), e
        }
        ...
        function Fi(e) {
            ...
            for (let n = 0; n < o.length; n++) {
                const e = yh.charAt(o[n] % yh.length);
        ...
        function Mi(e, t) {
            return t.filter((e) = > e[0] !== void 0 && e[1] !== void 0
        ).
            map((t) = > Uu.createFromParentsAndOffsets(e, t[0], e, t[1])
        )
        }
        ...
        function Li(e) {
            ...
            for (; t < e.length;) {
                const i = e[t], r = e[t + 1];
                o || (o = Wu.createBefore(i)), r && i.nextSibling == r || (n.push(new Uu(o, Wu.createAfter(i))), o = null), t++
            }
            return n
        }
        ...
        function ji(e, t=512) {
            try {
                const o = e.match(Yh)[1], n = atob(e.replace(Yh, '')), i = [];
            ...
            function e(e, t, o) {
                if (o.consumable.test(t.viewItem, {name: !0, classes: 'image'})) {
                    ...
                    if (e && e.hasAttribute('src') && o.consumable.test(e, {name: !0})) {
                        const n = o.convertItem(e, t.modelCursor), i = Di(n.modelRange.getItems());
                        i && (o.convertChildren(t.viewItem, Wu.createAt(i)), t.modelRange = n.modelRange, t.modelCursor = n.modelCursor)
                    }
                }
            }
        ...
        function Ki(e, t) {
            return e && t && e.priority == t.priority && $i(e.classes) == $i(t.classes)
        }

        function Gi(e, t) {
            if (e.priority > t.priority)return !0;
            return !(e.priority < t.priority) && $i(e.classes) > $i(t.classes)
        }
        ...
        function Qi(e, t, o={}) {
            ...
            return t.setAttribute('contenteditable', 'false', e), t.addClass(sb, e), t.setCustomProperty(rb, !0, e), e.getFillerOffset = tr, o.label && Xi(e, o.label, t), Yi(e, t, (e, t, o) = > o.addClass(n(t.classes), e), (e, t, o) =
        >
            o.removeClass(n(t.classes), e)
        ),
            e
        }
        ...
        function Yi(e, t, o, n) {
            const i = new ib;
            i.on('change:top', (t, i) = > {i.oldDescriptor && n(e, i.oldDescriptor, i.writer), i.newDescriptor && o(e, i.newDescriptor, i.writer)
        }),
        ...
        function Xi(e, t, o) {
            o.setCustomProperty(ab, t, e)
        }

        function Zi(e) {
            const t = e.getCustomProperty(ab);
            return t ? 'function' == typeof t ? t() : t : ''
        }

        function er(e, t) {
            return t.addClass(['ck-editor__editable', 'ck-editor__nested-editable'], e), t.setAttribute('contenteditable', e.isReadOnly ? 'false' : 'true', e), e.on('change:isReadOnly', (o, n, i) = > {t.setAttribute('contenteditable', i ? 'false' : 'true', e)
        }),
            e.on('change:isFocused', (o, n, i) = > {i? t.addClass('ck-editor__nested-editable_focused', e) : t.removeClass('ck-editor__nested-editable_focused', e)}
        ),
            e
        }
        ...
        function or(e, t, o) {
            return t.setCustomProperty(db, !0, e), Qi(e, t, {
                label: function () {
        ...
        function nr(e) {
            return !!e.getCustomProperty(db) && Ji(e)
        }
        ...
        function dr(e) {
            for (; e;) {
                if (e instanceof hc && !(e instanceof kc))return !0;
                e = e.parent
            }
            return !1
        }

        function cr({emitter: e, activator: t, callback: o, contextElements: n}) {
        ...
        function ur({view: e}) {
            e.listenTo(e.element, 'submit', (t, o) = > {o.preventDefault(), e.fire('submit')
        },
            {
                useCapture:!0
            }
        ...
        function mr(e) {
            ...
            if (ir(e.editing.view.document.selection)) {
                const o = pr(e);
                t.updatePosition(o)
            }
        }
        ...
        function pr(e) {
            const t = e.editing.view, o = Af.defaultPositions;
            return {
        ...
        function fr(e) {
            const t = e.getSelectedElement();
            if (t)return Wu.createAfter(t);
            const o = e.getSelectedBlocks().next().value;
            if (o) {
                if (o.isEmpty)return Wu.createAt(o);
                const t = Wu.createAfter(o);
                return e.focus.isTouching(t) ? t : Wu.createBefore(o)
            }
            return e.focus
        }
        ...
        function wr(e, t, o, n) {
            const i = yr(t);
            t.insert(wc.createAt(e, 'end'), i), o.on('change:uploadedPercent', (e, t, o) = > {n.change((e) = > {e.setStyle('width', o + '%', i)
        })
        })
        }
        ...
        function vr(e, t) {
            const o = xr(e);
            o && t.remove(vc.createOn(o))
        }

        function yr(e) {
            const t = e.createUIElement('div', {class: 'ck-progress-bar'});
            return e.setCustomProperty(Qb, !0, t), t
        }

        function xr(e) {
            for (const t of e.getChildren())if (t.getCustomProperty(Qb))return t
        }
        ...
        function Tr(e, t, o) {
            ...
            return o.writer.insert(n, t), o.convertItem(e, Wu.createAt(n))
        }
        ...
        function Sr(e, t=gk) {
            const o = new t(e), n = new lk(e), i = new uk(e, o, n);
            return o.bind('isEnabled').to(i), o instanceof gk ? o.bind('isOn').to(i, 'isOpen') : o.arrowView.bind('isOn').to(i, 'isOpen'), Rr(i), i
        }

        function Or(e, t) {
            const o = e.locale, n = e.listView = new bk(o);
            n.items.bindTo(t).using((e) = > {const t = new kk(o);
            return t.bind(...Object.keys(e)
        ).
            to(e), t
        }),
        ...
        function Ir(e) {
            e.on('render', () = > {cr({emitter: e, activator:() =
        >
            e.isOpen, callback
        :
            () =
        ...
        function Vr(e) {
            e.on('execute', () = > {e.isOpen = !1
        })
        }

        function Fr(e) {
            e.keystrokes.set('arrowdown', (t, o) = > {e.isOpen && (e.panelView.focus(), o())
        }),
            e.keystrokes.set('arrowup', (t, o) = > {e.isOpen && (e.panelView.focusLast(), o())
        })
        }

        function Nr(e) {
            const o = e.t, t = {Paragraph: o('s'), "Heading 1": o('t'), "Heading 2": o('u'), "Heading 3": o('v')};
            return e.config.get('heading.options').map((e) = > {const o = t[e.title];
        ...
        function Mr(e, t, o, n) {
            const i = e.document;
            Sk.has(i) || (Sk.set(i, new Map), i.registerPostFixer((e) = > Dr(i, e))
        ),
            Sk.get(i).set(t, {placeholderText: o, checkFunction: n}), e.render()
        }

        function Dr(e, t) {
            const o = Sk.get(e);
            let n = !1;
            for (const [i, r]of o)Br(t, i, r) && (n = !0);
            return n
        }
        ...
        >
            {
                ...
                return o.setCustomProperty(Ok, !0, n), Mr(e, n, t), er(n, o)
            }
        }

        function zr(e) {
            for (const t of e.getChildren())if (t instanceof zu && 'caption' == t.name)return t;
            return null
        }
        ...
        >
            {
                if (n.consumable.consume(o.item, t.name)) {
                    const t = Jr(o.attributeNewValue, e), i = Jr(o.attributeOldValue, e),
        ...
        >
            {
                if (o.modelRange) {
                    const e = o.viewItem, i = Di(o.modelRange.getItems());
        ...
        function Qr(e=[]) {
            return e.map(Yr).map((e) = > Object.assign({}, e)
        )
        }
        ...
        function Yr(e) {
            if ('string' == typeof e) {
                const t = e;
                Uk[t] ? e = Object.assign({}, Uk[t]) : (Eu.warn('image-style-not-found: There is no such image style of given name.', {name: t}), e = {name: t})
            } else if (Uk[e.name]) {
                const t = Uk[e.name], o = Object.assign({}, e);
                for (const n in t)e.hasOwnProperty(n) || (o[n] = t[n]);
                e = o
            }
            return 'string' == typeof e.icon && Hk[e.icon] && (e.icon = Hk[e.icon]), e
        }
        ...
        function Zr(e, t) {
            return new Uu(ea(e, t, !0), ea(e, t, !1))
        }
        ...
        function ea(e, t, o) {
            ...
            return i ? Wu.createAt(i, o ? 'before' : 'after') : e
        }

        function ta(e) {
            return e.is('attributeElement') && !!e.getCustomProperty(e_)
        }

        function oa(e, t) {
            const o = t.createAttributeElement('a', {href: e}, {priority: 5});
            return t.setCustomProperty(e_, !0, o), o
        }

        function na(e, t, o, n) {
            const i = new t_(t, o, n), r = t.document.selection;
            o.listenTo(e.document, 'keydown', (e, t) = > {if(
            !r.isCollapsed
        )
            return;
            if (t.shiftKey || t.altKey || t.ctrlKey)return;
            const o = t.keyCode == Fc.arrowright, n = t.keyCode == Fc.arrowleft;
            if (!o && !n)return;
            ...
            {
                priority:es.get('high') + 1
            }
        )
        }

        function ia(e, t) {
            return ra(e, t) || aa(e, t)
        }
        ...
        function la(e, t) {
            return ia(e.getShiftedBy(-1), t)
        }

        function da(e) {
            return e.getAncestors().find((e) = > ta(e)
        )
        }
        ...
        function fa(e, t, o) {
            ...
            r.breakContainer(wc.createBefore(i)), r.breakContainer(wc.createAfter(i));
            const a = i.parent, s = a.previousSibling, l = vc.createOn(a), d = r.remove(l);
            s && s.nextSibling && Sa(r, s, s.nextSibling);
            const c = o.mapper.toModelElement(i);
            Ra(c.getAttribute('indent') + 1, t.position, l.start, i, o);
            for (const n of vc.createIn(d).getItems())o.mapper.unbindViewElement(n);
            e.stop()
        }
        ...
        function ha(e, t, o) {
            ...
            i.breakContainer(wc.createBefore(n)), i.breakContainer(wc.createAfter(n));
            let r = n.parent;
            const a = 'numbered' == t.attributeNewValue ? 'ol' : 'ul';
            r = i.rename(r, a), Sa(i, r, r.nextSibling), Sa(i, r.previousSibling, r);
        ...
        function ba(e, t, o) {
            if (o.consumable.consume(t.item, 'attribute:indent')) {
                ...
                n.breakContainer(wc.createBefore(e)), n.breakContainer(wc.createAfter(e));
                const i = e.parent, r = i.previousSibling, a = vc.createOn(i);
                n.remove(a), r && r.nextSibling && Sa(n, r, r.nextSibling), Ra(t.attributeOldValue + 1, t.range.start, a.start, e, o), Oa(t.item, e, o);
        ...
        function ka(e, t, o) {
            if ('listItem' != t.item.name) {
                ...
                for (; ('ul' == e.parent.name || 'ol' == e.parent.name) && (e = n.breakContainer(e), 'li' == e.parent.name);) {
                    const t = e, o = wc.createAt(e.parent, 'end');
                    if (!t.isEqual(o)) {
                        const e = n.remove(new vc(t, o));
                        r.push(e)
                    }
                    e = wc.createAfter(e.parent)
                }
                if (0 < r.length) {
                    for (let t = 0; t < r.length; t++) {
                        const o = e.nodeBefore, i = n.insert(e, r[t]);
                        if (e = i.end, 0 < t) {
                            const t = Sa(n, o, o.nextSibling);
                            t && t.parent == o && e.offset--
                        }
                    }
                    Sa(n, e.nodeBefore, e.nodeAfter)
                }
            }
        }
        ...
        function wa(e, t, o) {
            if (o.consumable.consume(t.viewItem, {name: !0})) {
                ...
                let s = Wu.createAfter(i);
                for (const e of t.viewItem.getChildren())'ul' == e.name || 'ol' == e.name ? s = o.convertItem(e, s).modelCursor : o.convertItem(e, Wu.createAt(i, 'end'));
                n.indent--, t.modelRange = new Uu(t.modelCursor, s), t.modelCursor = a.cursorParent ? Wu.createAt(a.cursorParent) : t.modelRange.end
            }
        }
        ...
        function xa(e, t) {
            if (!t.isPhantom) {
                ...
                if (e && e.is('listItem')) {
                    ...
                    i = new _c({startPosition: wc.createAt(o, 0)});
        ...
        function Ca(e, t) {
            ...
            if ('ul' == n.name || 'ol' == n.name) {
                if (!o.isAtEnd) {
                    ...
                    t.modelPosition = Wu.createBefore(e)
                } else {
                    const e = i.toModelElement(o.nodeBefore), n = i.getModelLength(o.nodeBefore);
                    t.modelPosition = Wu.createBefore(e).getShiftedBy(n)
                }
                e.stop()
                ...
                t.modelPosition = Wu.createBefore(r).getShiftedBy(a), e.stop()
            }
        }
        ...
        function Pa(e, t) {
            const o = t.mapper, n = t.writer, i = 'numbered' == e.getAttribute('type') ? 'ol' : 'ul', r = ma(n),
                a = n.createContainerElement(i, null);
            return n.insert(wc.createAt(a), r), o.bindElements(e, r), r
        }

        function Ea(e, t) {
            const o = !!t.sameIndent, n = !!t.smallerIndent, i = e instanceof zu ? e.getAttribute('indent') : t.indent;
            for (let r = e instanceof zu ? e.previousSibling : e.nodeBefore; r && 'listItem' == r.name;) {
        ...
        function Sa(e, t, o) {
            return t && o && ('ul' == t.name || 'ol' == t.name) && t.name == o.name ? e.mergeContainers(wc.createAfter(t)) : null
        }

        function Oa(e, t, o) {
            const n = t.parent, i = o.mapper, r = o.writer;
            let a = i.toViewPosition(Wu.createBefore(e));
            const s = Ea(e, {sameIndent: !0, smallerIndent: !0}), l = e.previousSibling;
            if (s && s.getAttribute('indent') == e.getAttribute('indent')) {
                const e = i.toViewElement(s);
                a = r.breakContainer(wc.createAfter(e))
            } else a = l && 'listItem' == l.name ? i.toViewPosition(Wu.createAt(l, 'end')) : i.toViewPosition(Wu.createBefore(e));
            if (a = Ia(a), r.insert(a, n), l && 'listItem' == l.name) {
                const e = i.toViewElement(l),
                    o = new _c({boundaries: new vc(wc.createAt(e, 0), a), ignoreElementEnd: !0});
                for (const e of o)if (e.item.is('li')) {
                    const n = r.breakContainer(wc.createBefore(e.item)), i = e.item.parent, a = wc.createAt(t, 'end');
                    Sa(r, a.nodeBefore, a.nodeAfter), r.move(vc.createOn(i), a), o.position = n
                }
            } else {
                ...
                if (o && (o.is('ul') || o.is('ol'))) {
                    ...
                    n && (r.breakContainer(wc.createAfter(n)), r.move(vc.createOn(n.parent), wc.createAt(t, 'end')))
                }
            }
            Sa(r, n, n.nextSibling), Sa(r, n.previousSibling, n)
        }

        function Ra(e, t, o, n, i) {
            const r = Ea(t, {sameIndent: !0, smallerIndent: !0, indent: e}), a = i.mapper, s = i.writer,
            ...
            if (!r) d = o; else if (l == e) {
                ...
                const e = Wu.createAt(r, 'end');
                d = a.toViewPosition(e)
            }
            d = Ia(d);
            for (const r of[...n.getChildren()]
        )
            (r.is('ul') || r.is('ol')) && (d = s.move(vc.createOn(r), d).end, Sa(s, r, r.nextSibling), Sa(s, r.previousSibling, r))
        }
        ...
        function Va(e) {
            let t = 1;
            for (const o of e.getChildren())if ('ul' == o.name || 'ol' == o.name)for (const e of o.getChildren())t += Va(e);
            return t
        }

        var Fa = Number.POSITIVE_INFINITY, Na = Math.max, Ma = Math.min, Da = Math.floor;
        Object.defineProperty(t, '__esModule', {value: !0});
        var Ba = Object.getPrototypeOf, La = function (e) {
                return Ba(Object(e))
            }, za = function (e) {
                var t = !1;
            ...
            }, qa = Object.prototype, Wa = Function.prototype.toString, Ua = qa.hasOwnProperty, Ha = Wa.call(Object),
            Ka = qa.toString, Ga = function (e) {
                if (!ja(e) || Ka.call(e) != '[object Object]' || za(e))return !1;
                var t = La(e);
                if (null === t)return !0;
                var o = Ua.call(t, 'constructor') && t.constructor;
                return 'function' == typeof o && o instanceof o && Wa.call(o) == Ha
            };
        class $a {
            constructor(e, t) {
            ...
            _setToTarget(e, t, o, n = !1) {
                if (Ga(t))return void this._setObjectToTarget(e, t, n);
                const i = t.split('.');
                t = i.pop();
                for (const r of i)Ga(e[r]) || (e[r] = {}), e = e[r];
                return Ga(o) ? (Ga(e[t]) || (e[t] = {}), e = e[t], void this._setObjectToTarget(e, o, n)) : void(n && 'undefined' != typeof e[t] || (e[t] = o))
            }
            ...
            _setObjectToTarget(e, t, o) {
                Object.keys(t).forEach((n) = > {this._setToTarget(e, n, t[n], o)
            })
            }
        }
        const Ja = 'https://docs.ckeditor.com/ckeditor5/latest/framework/guides/support/error-codes.html';
        ...
        class Xa {
            constructor(e, t) {
                this.source = e, this.name = t, this.path = [], this.stop = Ya(), this.off = Ya()
            }
        }
        const Za = {
            get(e){
        ...
        var es = Za;
        const ts = Symbol('listeningTo'), os = Symbol('emitterId'), ns = {
            on(e, t, o={}){
            ...
            ,
                ...
                const m = u(e, t), p = es.get(n.priority), g = {callback: o, priority: p};
                for (const r of m) {
                    let e = !1;
        ...
        {
            const o = e instanceof Xa ? e : new Xa(this, e), n = o.name;
            let r = m(this, n);
        ...
        {
            return {to: (t, o) = > {this._delegations || (this._delegations = new Map);
            for (const n of e) {
        ...
        ;
        var is = ns, rs = function (e, t) {
            return e === t || e !== e && t !== t
        }, as = function (e, t) {
            for (var o = e.length; o--;)if (rs(e[o][0], t))return o;
            return -1
        }, ss = Array.prototype, ls = ss.splice;
        h.prototype.clear = function () {
            this.__data__ = []
        }, h.prototype['delete'] = function (e) {
            var t = this.__data__, o = as(t, e);
            if (0 > o)return !1;
            var n = t.length - 1;
            return o == n ? t.pop() : ls.call(t, o, 1), !0
        }, h.prototype.get = function (e) {
            var t = this.__data__, o = as(t, e);
            return 0 > o ? void 0 : t[o][1]
        }, h.prototype.has = function (e) {
            return -1 < as(this.__data__, e)
        }, h.prototype.set = function (e, t) {
            var o = this.__data__, n = as(o, e);
            return 0 > n ? o.push([e, t]) : o[n][1] = t, this
        };
        var ds = h, cs = function (e) {
                var t = typeof e;
                return !!e && ('object' == t || 'function' == t)
            }, us = Object.prototype, ms = us.toString, ps = function (e) {
                var t = cs(e) ? ms.call(e) : '';
                return t == '[object Function]' || t == '[object GeneratorFunction]'
            }, gs = Function.prototype.toString, fs = function (e) {
                if (null != e) {
                    try {
                        return gs.call(e)
                    } catch (t) {
                ...
                return ''
            }, hs = /[\\^$.*+?()[\]{}|]/g, bs = /^\[object .+?Constructor\]$/, ks = Object.prototype,
            _s = Function.prototype.toString, ws = ks.hasOwnProperty,
            vs = RegExp('^' + _s.call(ws).replace(hs, '\\$&').replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$'),
            ys = function (e) {
                if (!cs(e))return !1;
                var t = ps(e) || za(e) ? vs : bs;
                return t.test(fs(e))
            }, xs = function (e, t) {
                var o = e[t];
                return ys(o) ? o : void 0
            }, Cs = xs(Object, 'create'), As = Cs, Ts = Object.prototype, Ps = Ts.hasOwnProperty, Es = Object.prototype,
        ...
        b.prototype.clear = function () {
            ...
            var t = this.__data__;
            return As ? t[e] !== void 0 : Ss.call(t, e)
        }, b.prototype.set = function (e, t) {
            var o = this.__data__;
            return o[e] = As && void 0 === t ? '__lodash_hash_undefined__' : t, this
        };
        var Os = b, Rs = o(1), Is = xs(Rs.a, 'Map'), Vs = Is, Fs = function (e) {
            var t = typeof e;
            return 'string' == t || 'number' == t || 'symbol' == t || 'boolean' == t ? '__proto__' !== e : null === e
        }, Ns = function (e, t) {
            var o = e.__data__;
            return Fs(t) ? o['string' == typeof t ? 'string' : 'hash'] : o.map
        };
        k.prototype.clear = function () {
            this.__data__ = {hash: new Os, map: new (Vs || ds), string: new Os}
        ...
        _.prototype.clear = function () {
            ...
            var o = this.__data__;
            return o instanceof ds && o.__data__.length == 200 && (o = this.__data__ = new Ms(o.__data__)), o.set(e, t), this
        };
        var Ds = _, Bs = function (e, t) {
                for (var o = -1, n = e.length; ++o < n && !(!1 === t(e[o], o, e)););
                return e
            }, Ls = Object.prototype, zs = Ls.hasOwnProperty, js = w, qs = function (e, t, o, n) {
                o || (o = {});
                ...
                return o
            }, Ws = Object.prototype, Us = Ws.hasOwnProperty, Hs = v, Ks = Object.keys, Gs = function (e) {
                return Ks(Object(e))
            }, $s = function (e, t) {
            ...
            }, Qs = Js('length'), Ys = function (e) {
                return 'number' == typeof e && -1 < e && 0 == e % 1 && e <= 9007199254740991
            }, Xs = function (e) {
                return null != e && Ys(Qs(e)) && !ps(e)
            }, Zs = function (e) {
                return ja(e) && Xs(e)
            }, el = Object.prototype, tl = el.hasOwnProperty, ol = el.toString, nl = el.propertyIsEnumerable,
            il = function (e) {
                return Zs(e) && tl.call(e, 'callee') && (!nl.call(e, 'callee') || ol.call(e) == '[object Arguments]')
            }, rl = Array.isArray, al = rl, sl = Object.prototype, ll = sl.toString, dl = function (e) {
                return 'string' == typeof e || !al(e) && ja(e) && ll.call(e) == '[object String]'
            }, cl = function (e) {
                var t = e ? e.length : void 0;
                return Ys(t) && (al(e) || dl(e) || il(e)) ? $s(t, String) : null
            }, ul = /^(?:0|[1-9]\d*)$/, ml = function (e, t) {
                return t = null == t ? 9007199254740991 : t, !!t && ('number' == typeof e || ul.test(e)) && -1 < e && 0 == e % 1 && e < t
            }, pl = Object.prototype, gl = function (e) {
                var t = e && e.constructor, o = 'function' == typeof t && t.prototype || pl;
                return e === o
            }, fl = function (e) {
                var t = gl(e);
                if (!(t || Xs(e)))return Gs(e);
                var o = cl(e), n = o || [], i = n.length;
                for (var r in e)!Hs(e, r) || !!o && ('length' == r || ml(r, i)) || t && 'constructor' == r || n.push(r);
                return n
            }, hl = function (e, t) {
                return e && qs(t, fl(t), e)
            }, bl = function (e, t) {
                if (t)return e.slice();
        ...
        var wl = y, vl = function (e, t) {
                ...
                var n = t(e);
                return al(e) ? n : yl(n, o(e))
            }, Cl = function (e) {
                return xl(e, fl, wl)
            }, Al = xs(Rs.a, 'DataView'), Tl = Al, Pl = xs(Rs.a, 'Promise'), El = Pl, Sl = xs(Rs.a, 'Set'), Ol = Sl,
            Rl = xs(Rs.a, 'WeakMap'), Il = Rl, Vl = '[object Map]', Fl = '[object Promise]', Nl = '[object Set]',
            Ml = '[object WeakMap]', Dl = '[object DataView]', Bl = Object.prototype, Ll = Bl.toString, zl = fs(Tl),
            jl = fs(Vs), ql = fs(El), Wl = fs(Ol), Ul = fs(Il);
        (Tl && x(new Tl(new ArrayBuffer(1))) != Dl || Vs && x(new Vs) != Vl || El && x(El.resolve()) != Fl || Ol && x(new Ol) != Nl || Il && x(new Il) != Ml) && (x = function (e) {
            var t = Ll.call(e), o = t == '[object Object]' ? e.constructor : void 0, n = o ? fs(o) : void 0;
            if (n)switch (n) {
                case zl:
                    return Dl;
                case jl:
        ...
        var Hl = x, Kl = Object.prototype, Gl = Kl.hasOwnProperty, $l = function (e) {
                var t = e.length, o = e.constructor(t);
                return t && 'string' == typeof e[0] && Gl.call(e, 'index') && (o.index = e.index, o.input = e.input), o
            }, Jl = Rs.a.Uint8Array, Ql = Jl, Yl = function (e) {
                var t = new e.constructor(e.byteLength);
                return new Ql(t).set(new Ql(e)), t
            }, Xl = function (e, t) {
                var o = t ? Yl(e.buffer) : e.buffer;
                ...
                var n = t ? o(td(e), !0) : td(e);
                return ed(n, Zl, new e.constructor)
            }, nd = /\w*$/, id = function (e) {
                var t = new e.constructor(e.source, nd.exec(e));
                ...
                var n = t ? o(ad(e), !0) : ad(e);
                return ed(n, rd, new e.constructor)
            }, ld = Rs.a.Symbol, dd = ld, cd = dd ? dd.prototype : void 0, ud = cd ? cd.valueOf : void 0,
            md = function (e) {
                ...
                var i = e.constructor;
                return t === '[object ArrayBuffer]' ? Yl(e) : t === '[object Boolean]' || t === '[object Date]' ? new i(+e) : t === '[object DataView]' ? Xl(e, n) : t === '[object Float32Array]' || t === '[object Float64Array]' || t === '[object Int8Array]' || t === '[object Int16Array]' || t === '[object Int32Array]' || t === '[object Uint8Array]' || t === '[object Uint8ClampedArray]' || t === '[object Uint16Array]' || t === '[object Uint32Array]' ? pd(e, n) : t === '[object Map]' ? od(e, n, o) : t === '[object Number]' || t === '[object String]' ? new i(e) : t === '[object RegExp]' ? id(e) : t === '[object Set]' ? sd(e, n, o) : t === '[object Symbol]' ? md(e) : void 0
            }, fd = Object.create, hd = function (e) {
                return cs(e) ? fd(e) : {}
            }, bd = function (e) {
                return 'function' != typeof e.constructor || gl(e) ? {} : hd(La(e))
            }, kd = o(9), _d = '[object Arguments]', wd = '[object Function]', vd = '[object GeneratorFunction]',
            yd = '[object Object]', xd = {};
        xd[_d] = xd['[object Array]'] = xd['[object ArrayBuffer]'] = xd['[object DataView]'] = xd['[object Boolean]'] = xd['[object Date]'] = xd['[object Float32Array]'] = xd['[object Float64Array]'] = xd['[object Int8Array]'] = xd['[object Int16Array]'] = xd['[object Int32Array]'] = xd['[object Map]'] = xd['[object Number]'] = xd[yd] = xd['[object RegExp]'] = xd['[object Set]'] = xd['[object String]'] = xd['[object Symbol]'] = xd['[object Uint8Array]'] = xd['[object Uint8ClampedArray]'] = xd['[object Uint16Array]'] = xd['[object Uint32Array]'] = !0, xd['[object Error]'] = xd[wd] = xd['[object WeakMap]'] = !1;
        var Cd = C, Ad = function (e) {
            return Cd(e, !1, !0)
        };
        class Td {
            constructor() {
            ...
            get index() {
                ...
                if (-1 == (e = this.parent.getChildIndex(this)))throw new Qa('view-node-not-found-in-parent: The node\'s parent does not contain this node.');
                return e
            }
            ...
            get document() {
                return this.parent instanceof Td ? this.parent.document : null
            }
        ...
        class Pd extends Td {
            ...
            isSimilar(e) {
                return !!(e instanceof Pd) && (this === e || this.data === e.data)
            }

            _clone() {
                return new Pd(this.data)
            }
        }
        class Ed {
            constructor(e, t, o) {
                if (this.textNode = e, 0 > t || t > e.data.length)throw new Qa('view-textproxy-wrong-offsetintext: Given offsetInText value is incorrect.');
                if (0 > o || t + o > e.data.length)throw new Qa('view-textproxy-wrong-length: Given length value is incorrect.');
        ...
        *
        ...
        getIdentity()
        {
            ...
            sort().join(';'), o = Array.from(this._attrs).map((e) = > `${e[0]}="${e[1]}"`
        ).
            sort().join(' ');
        ...
        _setStyle(e, t)
        {
            if (this._fireChange('attributes', this), Ga(e)) {
        ...
        var Id = B, Vd = function (e, t, o) {
                var n = o.length;
                return 0 === n ? e.call(t) : 1 === n ? e.call(t, o[0]) : 2 === n ? e.call(t, o[0], o[1]) : 3 === n ? e.call(t, o[0], o[1], o[2]) : e.apply(t, o)
            }, Fd = Object.prototype, Nd = Fd.toString, Md = function (e) {
                return 'symbol' == typeof e || ja(e) && Nd.call(e) == '[object Symbol]'
            }, Dd = 0 / 0, Bd = /^\s+|\s+$/g, Ld = /^[-+]0x[0-9a-f]+$/i, zd = /^0b[01]+$/i, jd = /^0o[0-7]+$/i,
            qd = parseInt, Wd = function (e) {
                if ('number' == typeof e)return e;
                if (Md(e))return Dd;
                if (cs(e)) {
                    var t = ps(e.valueOf) ? e.valueOf() : e;
                    e = cs(t) ? t + '' : t
                }
                if ('string' != typeof e)return 0 === e ? e : +e;
                e = e.replace(Bd, '');
                var o = zd.test(e);
                return o || jd.test(e) ? qd(e.slice(2), o ? 2 : 8) : Ld.test(e) ? Dd : +e
            }, Ud = 1 / 0, Hd = function (e) {
                if (!e)return 0 === e ? e : 0;
                if (e = Wd(e), e === Ud || e === -Ud) {
                    var t = 0 > e ? -1 : 1;
            ...
            }, Gd = Na, $d = function (e, t) {
                if ('function' != typeof e)throw new TypeError('Expected a function');
                return t = Gd(void 0 === t ? e.length - 1 : Kd(t), 0), function () {
                    for (var o = arguments, n = -1, i = Gd(o.length - t, 0), r = Array(i); ++n < i;)r[n] = o[t + n];
                    switch (t) {
                        case 0:
                    ...
                    var a = Array(t + 1);
                    for (n = -1; ++n < t;)a[n] = o[n];
                    return a[t] = r, Vd(e, this, a)
                }
            }, Jd = Rs.a.Reflect, Qd = Jd, Yd = function (e) {
                for (var t = [], o; !(o = e.next()).done;)t.push(o.value);
                return t
            }, Xd = Object.prototype, Zd = Qd ? Qd.enumerate : void 0, ec = Xd.propertyIsEnumerable;
        Zd && !ec.call({valueOf: 1}, 'valueOf') && (L = function (e) {
            return Yd(Zd(e))
        });
        var tc = L, oc = Object.prototype, nc = oc.hasOwnProperty, ic = function (e) {
                for (var t = -1, o = gl(e), n = tc(e), i = n.length, r = cl(e), a = r || [], s = a.length; ++t < i;) {
                    var l = n[t];
                    !!r && ('length' == l || ml(l, s)) || 'constructor' == l && (o || !nc.call(e, l)) || a.push(l)
                }
                return a
            }, rc = Object.prototype, ac = rc.propertyIsEnumerable, sc = !ac.call({valueOf: 1}, 'valueOf'),
            lc = function (e) {
                return $d(function (t, o) {
                    var n = -1, i = o.length, r = 1 < i ? o[i - 1] : void 0, a = 2 < i ? o[2] : void 0;
                    for (r = 3 < e.length && 'function' == typeof r ? (i--, r) : void 0, a && Id(o[0], o[1], a) && (r = 3 > i ? void 0 : r, i = 1), t = Object(t); ++n < i;) {
                        var s = o[n];
                        s && e(t, s, n, r)
                    }
                    return t
                ...
                if (sc || gl(t) || Xs(t))return void qs(t, ic(t), e);
                for (var o in t)js(e, o, t[o])
            }), dc = lc;
        const cc = Symbol('observableProperties'), uc = Symbol('boundObservables'), mc = Symbol('boundProperties'),
            pc = {
                set(e, t){
                    if (cs(e))return void Object.keys(e).forEach((t) = > {this.set(t, e[t])
                },
                    this
                )
                    ;
                    z(this);
                    const o = this[cc];
                    if (e in this && !o.has(e))throw new Qa('observable-set-cannot-override: Cannot override an existing property.');
        ...
        {
            if (!e.length || !U(e))throw new Qa('observable-bind-wrong-properties: All properties must be strings.');
            if (new Set(e).size !== e.length)throw new Qa('observable-bind-duplicate-properties: Properties must be unique.');
            z(this);
            const t = this[mc];
            e.forEach((e) = > {if(t.has(e)
        )
            throw new Qa('observable-bind-rebind: Cannot bind the same property more that once.')
        })
            ;
            const o = new Map;
            return e.forEach((e) = > {const n = {property: e, to: []};
            t.set(e, n), o.set(e, n)
        }),
            {
                to:j, toMany
        ...
        {
            if (!(cc in this))return;
            const t = this[mc], o = this[uc];
            if (e.length) {
                if (!U(e))throw new Qa('observable-unbind-wrong-properties: Properties must be strings.');
                e.forEach((e) = > {const n = t.get(e);
                if (!n)return;
                let i, r, a, s;
                n.to.forEach((e) = > {
                    i=e[0], r=e[1], a=o.get(i), s=a[r],
                    s.delete(n), s.size || delete a[r], Object.keys(a).length || (o.delete(i), this.stopListening(i, 'change'))
            }),
                t.delete(e)
            })
            } else o.forEach((e, t) = > {this.stopListening(t, 'change')
        }),
            o.clear(), t.clear()
        }
        ,
        ...
        {
            const t = this[e];
            if (!t)throw new Qa('observablemixin-cannot-decorate-undefined: Cannot decorate an undefined method.', {
                object: this,
                methodName: e
            });
            this.on(e, (e, o) = > {e.return = t.apply(this, o)
        }),
            this[e] = function (...t
        )
            {
        ...
        class hc extends Rd {
            ...
            get document() {
                return this.getCustomProperty(fc)
            }

            set _document(e) {
                if (this.getCustomProperty(fc))throw new Qa('view-editableelement-document-already-set: View document is already set.');
                this._setCustomProperty(fc, e), this.bind('isReadOnly').to(e), this.bind('isFocused').to(e, 'isFocused', (t) = > t && e.selection.editableElement == this
            ),
                this.listenTo(e.selection, 'change', () = > {this.isFocused = e.isFocused && e.selection.editableElement == this
            })
            }
        }
        f(hc, gc);
        const bc = Symbol('rootName');
        class kc extends hc {
            constructor(e) {
            ...
            get rootName() {
                return this.getCustomProperty(bc)
            }

            set rootName(e) {
                this._setCustomProperty(bc, e)
            }
        ...
        class _c {
            constructor(e = {}) {
                if (!e.boundaries && !e.startPosition)throw new Qa('view-tree-walker-no-start-position: Neither boundaries nor starting position have been defined.');
                if (e.direction && 'forward' != e.direction && 'backward' != e.direction)throw new Qa('view-tree-walker-unknown-direction: Only `backward` and `forward` direction allowed.', {direction: e.direction});
                this.boundaries = e.boundaries || null, this.position = e.startPosition ? wc.createFromPosition(e.startPosition) : wc.createFromPosition(e.boundaries['backward' == e.direction ? 'end' : 'start']), this.direction = e.direction || 'forward', this.singleCharacters = !!e.singleCharacters, this.shallow = !!e.shallow, this.ignoreElementEnd = !!e.ignoreElementEnd, this._boundaryStartParent = this.boundaries ? this.boundaries.start.parent : null, this._boundaryEndParent = this.boundaries ? this.boundaries.end.parent : null
            }
            ...
            _next() {
                let e = wc.createFromPosition(this.position);
                ...
                let n;
                if (o instanceof Pd) {
                    if (e.isAtEnd)return this.position = wc.createAfter(o), this._next();
                    n = o.data[e.offset]
                } else n = o.getChild(e.offset);
                if (n instanceof Od)return this.shallow ? e.offset++ : e = new wc(n, 0), this.position = e, this._formatReturnValue('elementStart', n, t, e, 1);
                if (!(n instanceof Pd)) {
                    if ('string' == typeof n) {
                        let n;
                        ...
                        const i = new Ed(o, e.offset, n);
                        return e.offset += n, this.position = e, this._formatReturnValue('text', i, t, e, n)
                    }
                    return e = wc.createAfter(o), this.position = e, this.ignoreElementEnd ? this._next() : this._formatReturnValue('elementEnd', o, t, e)
                }
                if (this.singleCharacters)return e = new wc(n, 0), this.position = e, this._next(); else {
                    let o = n.data.length, i;
                    return n == this._boundaryEndParent ? (o = this.boundaries.end.offset, i = new Ed(n, 0, o), e = wc.createAfter(i)) : (i = new Ed(n, 0, n.data.length), e.offset++), this.position = e, this._formatReturnValue('text', i, t, e, o)
                }
            }
            ...
            _previous() {
                ...
                let n;
                if (o instanceof Pd) {
                    if (e.isAtStart)return this.position = wc.createBefore(o), this._previous();
                    n = o.data[e.offset - 1]
                } else n = o.getChild(e.offset - 1);
                if (n instanceof Od)return this.shallow ? (e.offset--, this.position = e, this._formatReturnValue('elementStart', n, t, e, 1)) : (e = new wc(n, n.childCount), this.position = e, this.ignoreElementEnd ? this._previous() : this._formatReturnValue('elementEnd', n, t, e));
                if (!(n instanceof Pd)) {
                    if ('string' == typeof n) {
                        let n;
        ...
        class wc {
            ...
            get editableElement() {
                let e = this.parent;
                for (; !(e instanceof hc);)if (e.parent) e = e.parent; else return null;
                return e
            }

            getShiftedBy(e) {
                const t = wc.createFromPosition(this), o = t.offset + e;
            ...
            static createAt(e, t) {
                if (e instanceof wc)return this.createFromPosition(e); else {
                    const o = e;
            ...
            static createAfter(e) {
                if (e.is('textProxy'))return new wc(e.textNode, e.offsetInText + e.data.length);
                if (!e.parent)throw new Qa('view-position-after-root: You can not make position after root.', {root: e});
                return new wc(e.parent, e.index + 1)
            }

            static createBefore(e) {
                if (e.is('textProxy'))return new wc(e.textNode, e.offsetInText);
                if (!e.parent)throw new Qa('view-position-before-root: You can not make position before root.', {root: e});
                return new wc(e.parent, e.index)
            }
        ...
        class vc {
            constructor(e, t = null) {
                this.start = wc.createFromPosition(e), this.end = t ? wc.createFromPosition(t) : wc.createFromPosition(e)
            }

            *[Symbol.iterator]() {
                yield * new _c({boundaries: this, ignoreElementEnd: !0})
            }
            ...
            getEnlarged() {
                ...
                return e.parent.is('text') && e.isAtStart && (e = wc.createBefore(e.parent)), t.parent.is('text') && t.isAtEnd && (t = wc.createAfter(t.parent)), new vc(e, t)
            }

            getTrimmed() {
                let e = this.start.getLastMatchingPosition(Q);
                if (e.isAfter(this.end) || e.isEqual(this.end))return new vc(e, e);
                let t = this.end.getLastMatchingPosition(Q, {direction: 'backward'});
                const o = e.nodeAfter, n = t.nodeBefore;
                return o && o.is('text') && (e = new wc(o, 0)), n && n.is('text') && (t = new wc(n, n.data.length)), new vc(e, t)
            }
            ...
            getDifference(e) {
                const t = [];
                return this.isIntersecting(e) ? (this.containsPosition(e.start) && t.push(new vc(this.start, e.start)), this.containsPosition(e.end) && t.push(new vc(e.end, this.end))) : t.push(vc.createFromRange(this)), t
            }

            getIntersection(e) {
                if (this.isIntersecting(e)) {
                    let t = this.start, o = this.end;
                    return this.containsPosition(e.start) && (t = e.start), this.containsPosition(e.end) && (o = e.end), new vc(t, o)
                }
                return null
            }

            getWalker(e = {}) {
                return e.boundaries = this, new _c(e)
            }
            ...
            *getPositions(e = {}) {
            ...
            static createFromParentsAndOffsets(e, t, o, n) {
                return new this(new wc(e, t), new wc(o, n))
            }
            ...
            static createOn(e) {
                ...
                return this.createFromPositionAndShift(wc.createBefore(e), t)
            }

            static createCollapsedAt(e, t) {
                const o = wc.createAt(e, t), n = wc.createFromPosition(o);
                return new vc(o, n)
            }
        }
        class yc {
            ...
            get anchor() {
                ...
                return wc.createFromPosition(t)
            }
            ...
            *getRanges() {
                for (const e of this._ranges)yield vc.createFromRange(e)
            }

            getFirstRange() {
                let e = null;
                for (const t of this._ranges)(!e || t.start.isBefore(e.start)) && (e = t);
                return e ? vc.createFromRange(e) : null
            }
            ...
            getFirstPosition() {
                ...
                return e ? wc.createFromPosition(e.start) : null
            }

            getLastPosition() {
                const e = this.getLastRange();
                return e ? wc.createFromPosition(e.end) : null
            }
            ...
            getSelectedElement() {
                ...
                return t instanceof Od && t == o ? t : null
            }

            setTo(e, t, o) {
                if (null === e) this._setRanges([]), this._setFakeOptions(t); else if (e instanceof yc || e instanceof xc) this._setRanges(e.getRanges(), e.isBackward), this._setFakeOptions({
                    fake: e.isFake,
                    label: e.fakeSelectionLabel
                }); else if (e instanceof vc) this._setRanges([e], t && t.backward), this._setFakeOptions(t); else if (e instanceof wc) this._setRanges([new vc(e)]), this._setFakeOptions(t); else if (e instanceof Td) {
                    const n = !!o && !!o.backward;
                    let i;
                    if (t === void 0)throw new Qa('view-selection-setTo-required-second-parameter: selection.setTo requires the second parameter when the first parameter is a node.'); else i = 'in' == t ? vc.createIn(e) : 'on' == t ? vc.createOn(e) : vc.createCollapsedAt(e, t);
                    this._setRanges([i], n), this._setFakeOptions(o)
                } else if (P(e)) this._setRanges(e, t && t.backward), this._setFakeOptions(t); else throw new Qa('view-selection-setTo-not-selectable: Cannot set selection to given place.');
                this.fire('change')
            }

            setFocus(e, t) {
                if (null === this.anchor)throw new Qa('view-selection-setFocus-no-ranges: Cannot set selection focus if there are no ranges in selection.');
                const o = wc.createAt(e, t);
                if ('same' != o.compareWith(this.focus)) {
                    const e = this.anchor;
                    this._ranges.pop(), 'before' == o.compareWith(e) ? this._addRange(new vc(o, e), !0) : this._addRange(new vc(e, o)), this.fire('change')
                }
            }
            ...
            _addRange(e, t = !1) {
                if (!(e instanceof vc))throw new Qa('view-selection-invalid-range: Invalid Range.');
                this._pushRange(e), this._lastRangeBackward = !!t
            }

            _pushRange(e) {
                for (const t of this._ranges)if (e.isIntersecting(t))throw new Qa('view-selection-range-intersects: Trying to add a range that intersects with another range from selection.', {
                    addedRange: e,
                    intersectingRange: t
                });
                this._ranges.push(vc.createFromRange(e))
            }
        }
        f(yc, is);
        class xc {
            constructor(e = null, t, o) {
                this._selection = new yc, this._selection.delegate('change').to(this), this._selection.setTo(e, t, o)
            }
        ...
        class Cc {
            ...
            add(e, t) {
                ...
                if (n in e) {
                    if (o = e[n], 'string' != typeof o)throw new Qa('collection-add-invalid-id');
                    if (this.get(o))throw new Qa('collection-add-item-already-exists')
                } else e[n] = o = i();
                if (void 0 === t) t = this._items.length; else if (t > this._items.length || 0 > t)throw new Qa('collection-add-item-invalid-index');
                return this._items.splice(t, 0, e), this._itemMap.set(o, e), this.fire('add', e, t), this
            }

            get(e) {
                let t;
                if ('string' == typeof e) t = this._itemMap.get(e); else if ('number' == typeof e) t = this._items[e]; else throw new Qa('collection-get-invalid-arg: Index or id must be given.');
                return t || null
            }
            ...
            remove(e) {
                ...
                if ('string' == typeof e ? (n = e, i = this._itemMap.get(n), t = !i, i && (o = this._items.indexOf(i))) : 'number' == typeof e ? (o = e, i = this._items[o], t = !i, i && (n = i[r])) : (i = e, n = i[r], o = this._items.indexOf(i), t = -1 == o || !this._itemMap.get(n)), t)throw new Qa('collection-remove-404: Item not found.');
            ...
            bindTo(e) {
                if (this._bindToCollection)throw new Qa('collection-bind-to-rebind: The collection cannot be bound more than once.');
            ...
            >
                ...
                this.listenTo(t, 'add', o), this.listenTo(t, 'remove', (e, t, o) = > {const n = this._bindToExternalToInternalMap.get(t);
        ...
        class Ac {
            constructor() {
                this.selection = new xc, this.roots = new Cc({idProperty: 'rootName'}), this.set('isReadOnly', !1), this.set('isFocused', !1), this.set('isComposing', !1), this._postFixers = new Set
            }
        ...
        class Pc extends Od {
            constructor(e, t, o) {
                super(e, t, o), this.getFillerOffset = X, this._priority = Tc, this._id = null, this._clonesGroup = null
            }
            ...
            getElementsWithSameId() {
                if (null === this.id)throw new Qa('attribute-element-get-elements-with-same-id-no-id: Cannot get elements with the same id for an attribute element without id.');
        ...
        class Ec extends Od {
            ...
            _insertChild(e, t) {
                if (t && (t instanceof Td || 0 < Array.from(t).length))throw new Qa('view-emptyelement-cannot-add: Cannot add child nodes to EmptyElement instance.')
            }
        }
        const Sc = navigator.userAgent.toLowerCase(), Oc = {
            isMac: function (e) {
                return -1 < e.indexOf('macintosh')
            }(Sc)
        };
        var Rc = Oc;
        const Ic = {"⌘": 'ctrl', "⇧": 'shift', "⌥": 'alt'}, Vc = {ctrl: '\u2318', shift: '\u21E7', alt: '\u2325'},
            Fc = function () {
                const e = {
                    arrowleft: 37,
                    arrowup: 38,
        ...
        class Nc extends Od {
            ...
            _insertChild(e, t) {
                if (t && (t instanceof Td || 0 < Array.from(t).length))throw new Qa('view-uielement-cannot-add: Cannot add child nodes to UIElement instance.')
            }
        ...
        class Dc {
            ...
            setStyle(e, t, o) {
                Ga(e) && o === void 0 && (o = t), o._setStyle(e, t)
            }
            ...
            breakAttributes(e) {
                return e instanceof wc ? this._breakAttributes(e) : this._breakAttributesRange(e)
            }

            breakContainer(e) {
                const t = e.parent;
                if (!t.is('containerElement'))throw new Qa('view-writer-break-non-container-element: Trying to break an element which is not a container element.');
                if (!t.parent)throw new Qa('view-writer-break-root: Trying to break root element.');
                if (e.isAtStart)return wc.createBefore(t);
                if (!e.isAtEnd) {
                    const o = t._clone(!1);
                    this.insert(wc.createAfter(t), o);
                    const n = new vc(e, wc.createAt(t, 'end')), i = new wc(o, 0);
                    this.move(n, i)
                }
                return wc.createAfter(t)
            }
            ...
            mergeAttributes(e) {
                ...
                if (o.is('attributeElement') && 0 === o.childCount) {
                    ...
                    return o._remove(), this._removeFromClonedElementsGroup(o), this.mergeAttributes(new wc(e, t))
                }
                ...
                if (n.is('attributeElement') && i.is('attributeElement') && n.isSimilar(i)) {
                    ...
                    return n._appendChild(i.getChildren()), i._remove(), this._removeFromClonedElementsGroup(i), this.mergeAttributes(new wc(n, e))
                }
                return e
            }
            ...
            mergeContainers(e) {
                ...
                if (!t || !o || !t.is('containerElement') || !o.is('containerElement'))throw new Qa('view-writer-merge-containers-invalid-position: Element before and after given position cannot be merged.');
                const n = t.getChild(t.childCount - 1),
                    i = n instanceof Pd ? wc.createAt(n, 'end') : wc.createAt(t, 'end');
                return this.move(vc.createIn(o), wc.createAt(t, 'end')), this.remove(vc.createOn(o)), i
            }
            ...
            insert(e, t) {
                ...
                [t], he(t);
                const o = ce(e);
                if (!o)throw new Qa('view-writer-invalid-position-container');
            ...
            remove(e) {
                if (ke(e), e.isCollapsed)return new Mc;
                ...
                return e.start = a, e.end = wc.createFromPosition(a), new Mc(r)
            }
            ...
            clear(e, t) {
                ...
                for (const n of o) {
                    const o = n.item;
                    let i;
                    if (o.is('element') && t.isSimilar(o)) i = vc.createOn(o); else if (!n.nextPosition.isAfter(e.start) && o.is('textProxy')) {
            ...
            wrap(e, t) {
                if (!(t instanceof Pc))throw new Qa('view-writer-wrap-invalid-attribute');
                if (ke(e), !e.isCollapsed)return this._wrapRange(e, t); else {
                    let o = e.start;
                    o.parent.is('element') && !de(o.parent) && (o = o.getLastMatchingPosition((e) = > e.item.is('uiElement'))
                ),
                    o = this._wrapPosition(o, t);
                    const n = this.document.selection;
                    return n.isCollapsed && n.getFirstPosition().isEqual(e.start) && this.setSelection(o), new vc(o)
                }
            }

            unwrap(e, t) {
                if (!(t instanceof Pc))throw new Qa('view-writer-unwrap-invalid-attribute');
                if (ke(e), e.isCollapsed)return e;
                const {start: o, end: n} = this._breakAttributesRange(e, !0);
                if (n.isEqual(o.getShiftedBy(1))) {
                    const e = o.nodeAfter;
                    if (!t.isSimilar(e) && e instanceof Pc && this._unwrapAttributeElement(t, e)) {
            ...
            rename(e, t) {
                const o = new Rd(t, e.getAttributes());
                return this.insert(wc.createAfter(e), o), this.move(vc.createIn(e), wc.createAt(o)), this.remove(vc.createOn(e)), o
            }
            ...
            _wrapChildren(e, t, o, n) {
                ...
                for (; r < o;) {
                    ...
                    if (o || s || l || a && ue(n, t)) {
                        const o = n._clone();
                        t._remove(), o._appendChild(t), e._insertChild(r, o), this._addToClonedElementsGroup(o), i.push(new wc(e, r))
                ...
                return vc.createFromParentsAndOffsets(e, t, e, o)
            }
            ...
            _unwrapChildren(e, t, o, n) {
                ...
                for (; r < o;) {
                    ...
                    if (t.isSimilar(n)) {
                        ...
                        t._remove(), e._insertChild(r, n), this._removeFromClonedElementsGroup(t), i.push(new wc(e, r), new wc(e, r + a)), r += a, o += a - 1
            ...
            _wrapRange(e, t) {
                if (fe(e) && this._wrapAttributeElement(t, e.start.parent)) {
                    const t = e.start.parent, o = this.mergeAttributes(wc.createAfter(t)),
                        n = this.mergeAttributes(wc.createBefore(t));
                    return new vc(n, o)
                }
                const {start: o, end: n} = this._breakAttributesRange(e, !0);
                if (n.isEqual(o.getShiftedBy(1))) {
                    const e = o.nodeAfter;
                    if (e instanceof Pc && this._wrapAttributeElement(t, e)) {
                        const e = this.mergeAttributes(o);
                        e.isEqual(o) || n.offset--;
                        const t = this.mergeAttributes(n);
                        return new vc(e, t)
            ...
            _wrapPosition(e, t) {
                if (t.isSimilar(e.parent))return me(wc.createFromPosition(e));
                e.parent.is('text') && (e = pe(e));
                const o = this.createAttributeElement();
                o._priority = Fa, o.isSimilar = () =
            >
                !1, e.parent._insertChild(e.offset, o);
                const n = new vc(e, e.getShiftedBy(1));
                this.wrap(n, t);
                const i = new wc(o.parent, o.index);
                o._remove();
                const r = i.nodeBefore, a = i.nodeAfter;
                return r instanceof Pd && a instanceof Pd ? ge(r, a) : me(i)
            }
            ...
            _breakAttributesRange(e, t = !1) {
                ...
                return i.offset += i.parent.childCount - r, new vc(a, i)
            }

            _breakAttributes(e, t = !1) {
                const o = e.offset, n = e.parent;
                if (e.parent.is('emptyElement'))throw new Qa('view-writer-cannot-break-empty-element');
                if (e.parent.is('uiElement'))throw new Qa('view-writer-cannot-break-ui-element');
                if (!t && n.is('text') && be(n.parent))return wc.createFromPosition(e);
                if (be(n))return wc.createFromPosition(e);
                if (n.is('text'))return this._breakAttributes(pe(e), t);
                const i = n.childCount;
                if (o == i) {
                    const e = new wc(n.parent, n.index + 1);
                    return this._breakAttributes(e, t)
                }
                if (0 === o) {
                    const e = new wc(n.parent, n.index);
                    return this._breakAttributes(e, t)
                } else {
        ...
        zc = (e) =
        >
        e.createTextNode('\xA0'), jc = 7;
        let qc = '';
        for (let n = 0; n < jc; n++)qc += '\u200B';
        ...
        class Uc {
            ...
            markToSync(e, t) {
                if ('text' === e) this.domConverter.mapViewToDom(t.parent) && this.markedTexts.add(t); else {
                    ...
                    if ('attributes' === e) this.markedAttributes.add(t); else if ('children' === e) this.markedChildren.add(t); else throw new Qa('view-renderer-unknown-type: Unknown type passed to Renderer.markToSync.')
                }
            }
            ...
            _addInlineFiller(e, t, o) {
                ...
                if (Se(i))return i.data = qc + i.data, i; else {
                    const i = e.createTextNode(qc);
            ...
            _getInlineFillerPosition() {
                ...
                return e.parent.is('text') ? wc.createBefore(this.selection.getFirstPosition().parent) : e
            }
            ...
            _removeInlineFiller() {
                ...
                if (!we(e))throw new Qa('view-renderer-filler-was-lost: The inline filler node was lost.');
                ve(e) ? e.parentNode.removeChild(e) : e.data = e.data.substr(jc), this._inlineFiller = null
            }
            ...
            _needsInlineFillerAtSelection() {
                ...
                return !(n instanceof Pd || i instanceof Pd)
            }
            ...
            _updateText(e, t) {
                ...
                a && a.parent == e.parent && a.offset == e.index && (r = qc + r), i != r && (o.data = r)
            }
        ...
        class Kc {
            constructor(e = {}) {
                this.blockFiller = e.blockFiller || Lc, this.preElements = ['pre'], this.blockElements = ['p', 'div', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6'], this._domToViewMapping = new WeakMap, this._viewToDomMapping = new WeakMap, this._fakeSelectionMapping = new WeakMap
            }

            bindFakeSelection(e, t) {
                this._fakeSelectionMapping.set(e, new yc(t))
            }
            ...
            *viewChildrenToDom(e, t, o = {}) {
            ...
            viewPositionToDom(e) {
                ...
                if (t.is('text')) {
                    ...
                    if (!o)return null;
                    let n = e.offset;
                    return we(o) && (n += jc), {parent: o, offset: n}
                } else {
                    let o, n, i;
                    if (0 === e.offset) {
                    ...
                    if (Se(i) && we(i))return {parent: i, offset: jc};
                    const r = n ? Re(n) + 1 : 0;
            ...
            *domChildrenToView(e, t = {}) {
            ...
            findCorrespondingViewText(e) {
                ...
                if (o) {
                    ...
                    if (e) {
                        ...
                        return t instanceof Pd ? e.nextSibling : null
                    }
                } else {
                    const t = this.mapDomToView(e.parentNode);
                    if (t) {
                        const e = t.getChild(0);
                        return e instanceof Pd ? e : null
                    }
                }
                return null
            }
            ...
            focus(e) {
                ...
                if (t && t.ownerDocument.activeElement !== t) {
                    const {scrollX: e, scrollY: o} = Hc.window, n = [];
                    Ne(t, (e) = > {const{scrollLeft: t, scrollTop: o} = e;
                    n.push([t, o])
                }),
                    t.focus(), Ne(t, (e) = > {const[t, o] = n.shift();
                    e.scrollLeft = t, e.scrollTop = o
                }),
                    Hc.window.scrollTo(e, o)
                }
            }
            ...
            _getTouchingViewTextNode(e, t) {
                const o = new _c({
                    startPosition: t ? wc.createAfter(e) : wc.createBefore(e),
        ...
        const Gc = dc({}, is, {listenTo(e,...t)
        {
            if (Me(e) || De(e)) {
                const o = this._getProxyEmitter(e) || new Jc(e);
                o.attach(...t
            ),
                e = o
            }
            is.listenTo.call(this, e,...t
        )
        }
        ,
        stopListening(e, t, o)
        {
            ...
            is.stopListening.call(this, e, t, o), e instanceof Jc && e.detach(t)
        }
        ,
        _getProxyEmitter(e)
        {
        ...
        var Yc = Le, Xc = function (e, t) {
            ...
            return r['delete'](e), u
        }, eu = dd ? dd.prototype : void 0, tu = eu ? eu.valueOf : void 0, ou = function (e, t, o, n, i, r, a) {
            switch (o) {
                case'[object DataView]':
                    if (e.byteLength != t.byteLength || e.byteOffset != t.byteOffset)return !1;
                    e = e.buffer, t = t.buffer;
                case'[object ArrayBuffer]':
                    return !!(e.byteLength == t.byteLength && n(new Ql(e), new Ql(t)));
                case'[object Boolean]':
                case'[object Date]':
                    return +e == +t;
                case'[object Error]':
                ...
                case'[object Set]':
                    var l = r & 2;
                    if (s || (s = ad), e.size != t.size && !l)return !1;
                    var d = a.get(e);
                    return d ? d == t : (r |= 1, a.set(e, t), Zc(s(e), s(t), n, i, r, a));
                case'[object Symbol]':
                    if (tu)return tu.call(e) == tu.call(t);
            }
            return !1
        }, nu = 2, iu = {};
        iu['[object Float32Array]'] = iu['[object Float64Array]'] = iu['[object Int8Array]'] = iu['[object Int16Array]'] = iu['[object Int32Array]'] = iu['[object Uint8Array]'] = iu['[object Uint8ClampedArray]'] = iu['[object Uint16Array]'] = iu['[object Uint32Array]'] = !0, iu['[object Arguments]'] = iu['[object Array]'] = iu['[object ArrayBuffer]'] = iu['[object Boolean]'] = iu['[object DataView]'] = iu['[object Date]'] = iu['[object Error]'] = iu['[object Function]'] = iu['[object Map]'] = iu['[object Number]'] = iu['[object Object]'] = iu['[object RegExp]'] = iu['[object Set]'] = iu['[object String]'] = iu['[object WeakMap]'] = !1;
        var ru = Object.prototype, au = ru.toString, su = function (e) {
                return ja(e) && Ys(e.length) && !!iu[au.call(e)]
            }, lu = '[object Arguments]', du = '[object Array]', cu = '[object Object]', uu = Object.prototype,
            mu = uu.hasOwnProperty, pu = function (e, t, o, n, i, r) {
                var a = al(e), s = al(t), l = du, d = du;
                a || (l = Hl(e), l = l == lu ? cu : l), s || (d = Hl(t), d = d == lu ? cu : d);
                var c = l == cu && !za(e), u = d == cu && !za(t), m = l == d;
                if (m && !c)return r || (r = new Ds), a || su(e) ? Zc(e, t, o, n, i, r) : ou(e, t, l, o, n, i, r);
                if (!(i & 2)) {
                    var p = c && mu.call(e, '__wrapped__'), g = u && mu.call(t, '__wrapped__');
                    if (p || g) {
                        var f = p ? e.value() : e, h = g ? t.value() : t;
                        return r || (r = new Ds), o(f, h, n, i, r)
                    }
                }
                return !!m && (r || (r = new Ds), ze(e, t, o, n, i, r))
            }, gu = je, fu = function (e, t, o) {
                o = 'function' == typeof o ? o : void 0;
                var n = o ? o(e, t) : void 0;
                return n === void 0 ? gu(e, t, o) : !!n
            };
        class hu extends Qc {
            constructor(e) {
            ...
            _onMutations(e) {
                ...
                for (const n of i) {
                    ...
                    fu(i, a, t) || (this.renderer.markToSync('children', n), r.push({
                        type: 'children',
                        oldChildren: i,
                        newChildren: a,
                        node: n
        ...
        class bu {
            constructor(e, t, o) {
                this.view = e, this.document = e.document, this.domEvent = t, this.domTarget = t.target, dc(this, o)
            }
        ...
        class ku extends Qc {
            ...
            fire(e, t, o) {
                this.isEnabled && this.document.fire(e, new bu(this.view, t, o))
            }
        }
        class _u extends ku {
            constructor(e) {
        ...
        var wu = Date.now, vu = wu, yu = 'Expected a function', xu = Na, Cu = Ma, Au = qe;
        class Tu extends Qc {
            constructor(e) {
                super(e), this._fireSelectionChangeDoneDebounced = Au((e) = > this.document.fire('selectionChangeDone', e), 200
            )
            }

            observe() {
                const e = this.document;
                e.on('keydown', (t, o) = > {const n = e.selection;
            ...
            _handleSelectionMove(e) {
                const t = this.document.selection, o = new yc(t.getRanges(), {backward: t.isBackward, fake: !1});
                (e == Fc.arrowleft || e == Fc.arrowup) && o.setTo(o.getFirstPosition()), (e == Fc.arrowright || e == Fc.arrowdown) && o.setTo(o.getLastPosition());
        ...
        class Su extends Qc {
            constructor(e) {
                super(e), this.mutationObserver = e.getObserver(hu), this.selection = this.document.selection, this.domConverter = e.domConverter, this._documents = new WeakSet, this._fireSelectionChangeDoneDebounced = Au((e) = > this.document.fire('selectionChangeDone', e), 200
            ),
            ...
            _handleSelectionChange(e) {
                if (this.isEnabled && (this.document.isFocused || this.document.isReadOnly)) {
                    ...
                    if (!(this.selection.isEqual(o) && this.domConverter.isDomSelectionCorrect(t))) {
                        if (60 < ++this._loopbackCounter)return void Eu.warn('selectionchange-infinite-loop: Selection change observer detected an infinite rendering loop.');
        ...
        class Ou extends ku {
            constructor(e) {
                ...
                t.on('focus', () = > {t.isFocused = !0, this._renderTimeoutId = setTimeout(() = > e.render(), 50
            )
            }),
                t.on('blur', (o, n) = > {const i = t.selection.editableElement;
        ...
        class Ru extends ku {
            constructor(e) {
                ...
                const t = this.document;
                t.on('compositionstart', () = > {t.isComposing = !0
            }),
                t.on('compositionend', () = > {t.isComposing = !1
            })
            }
        ...
        var Iu = function (e) {
            return !!e && 1 === e.nodeType && ja(e) && !Ga(e)
        };
        class Vu {
            constructor(e) {
                const t = Ue(e);
                if (Object.defineProperty(this, '_source', {
                    ...
                    o.ownerDocument && o.ownerDocument.body.contains(o) || Eu.warn('rect-source-not-in-dom: The source of this rect does not belong to any rendered DOM tree.', {source: e}), t ? Ke(this, Vu.getDomRangeRects(e)[0]) : Ke(this, e.getBoundingClientRect())
                } else if (De(e)) {
            ...
            getIntersection(e) {
                const t = {
                    top: Na(this.top, e.top),
                    right: Ma(this.right, e.right),
                    bottom: Ma(this.bottom, e.bottom),
                    left: Na(this.left, e.left)
                };
                return t.width = t.right - t.left, t.height = t.bottom - t.top, 0 > t.width || 0 > t.height ? null : new Vu(t)
            }
            ...
            getVisible() {
                ...
                if (!Ge(e))for (let o = e.parentNode || e.commonAncestorContainer; o && !Ge(o);) {
                    const e = new Vu(o), n = t.getIntersection(e);
            ...
            isEqual(e) {
                for (const t of Fu)if (this[t] !== e[t])return !1;
                return !0
            }
            ...
            static getDomRangeRects(e) {
                ...
                if (o.length)for (const e of o)t.push(new Vu(e)); else {
                    let o = e.startContainer;
                    Se(o) && (o = o.parentNode);
                    const n = new Vu(o.getBoundingClientRect());
                    n.right = n.left, n.width = 0, t.push(n)
                }
                return t
            }
        }
        const Fu = ['top', 'right', 'bottom', 'left', 'width', 'height'];
        Object.assign({}, {
        ...
        class Nu {
            constructor() {
                this.document = new Ac, this.domConverter = new Kc, this._renderer = new Uc(this.domConverter, this.document.selection), this._renderer.bind('isFocused').to(this.document), this.domRoots = new Map, this._observers = new Map, this._ongoingChange = !1, this._renderingInProgress = !1, this._postFixersInProgress = !1, this._writer = new Dc(this.document), this.addObserver(hu), this.addObserver(Su), this.addObserver(Ou), this.addObserver(_u), this.addObserver(Tu), this.addObserver(Ru), Ce(this), re(this), this.on('render', () = > {this._render()
            })
            }

            attachDomRoot(e, t = 'main') {
                const o = this.document.getRoot(t);
                o._name = e.tagName.toLowerCase(), this.domRoots.set(t, e), this.domConverter.bindElements(e, o), this._renderer.markToSync('children', o), this._renderer.domDocuments.add(e.ownerDocument), o.on('change:children', (e, t) = > this._renderer.markToSync('children', t)
            ),
            ...
            focus() {
                if (!this.document.isFocused) {
                    ...
                    e ? (this.domConverter.focus(e), this.render()) : Eu.warn('view-focus-no-selection: There is no selection in any editable to focus.')
                }
            }

            change(e) {
                if (this._renderingInProgress || this._postFixersInProgress)throw new Qa('cannot-change-view-tree: Attempting to make changes to the view when it is in incorrect state: rendering or post fixers are in progress. This may cause some unexpected behaviour and inconsistency between the DOM and the view.');
        ...
        class Mu {
            ...
            get index() {
                let e;
                if (!this.parent)return null;
                if (null === (e = this.parent.getChildIndex(this)))throw new Qa('model-node-not-found-in-parent: The node\'s parent does not contain this node.');
                return e
            }
            ...
            get startOffset() {
                let e;
                if (!this.parent)return null;
                if (null === (e = this.parent.getChildStartOffset(this)))throw new Qa('model-node-not-found-in-parent: The node\'s parent does not contain this node.');
                return e
            }
        ...
        class Du extends Mu {
            ...
            _clone() {
                return new Du(this.data, this.getAttributes())
            }

            static fromJSON(e) {
                return new Du(e.data, e.attributes)
            }
        }
        class Bu {
            constructor(e, t, o) {
                if (this.textNode = e, 0 > t || t > e.offsetSize)throw new Qa('model-textproxy-wrong-offsetintext: Given offsetInText value is incorrect.');
                if (0 > o || t + o > e.offsetSize)throw new Qa('model-textproxy-wrong-length: Given length value is incorrect.');
                this.data = e.data.substring(t, t + o), this.offsetInText = t
            }
        ...
        class Lu {
            ...
            indexToOffset(e) {
                ...
                if (!t)throw new Qa('model-nodelist-index-out-of-bounds: Given index cannot be found in the node list.');
            ...
            offsetToIndex(e) {
                ...
                if (t != e)throw new Qa('model-nodelist-offset-out-of-bounds: Given offset cannot be found in the node list.');
                return this.length
            }

            _insertNodes(e, t) {
                for (const o of t)if (!(o instanceof Mu))throw new Qa('model-nodelist-insertNodes-not-node: Trying to insert an object which is not a Node instance.');
        ...
        class zu extends Mu {
            constructor(e, t, o) {
                super(t), this.name = e, this._children = new Lu, o && this._insertChild(0, o)
            }
            ...
            _clone(e = !1) {
                const t = e ? Array.from(this._children).map((e) = > e._clone(!0)
            ):
                null;
                return new zu(this.name, this.getAttributes(), t)
            }
            ...
            static fromJSON(e) {
                ...
                if (e.children) {
                    t = [];
                    for (const o of e.children)o.name ? t.push(zu.fromJSON(o)) : t.push(Du.fromJSON(o))
                }
                return new zu(e.name, e.attributes, t)
            }
        }
        class ju {
            constructor(e = {}) {
                if (!e.boundaries && !e.startPosition)throw new Qa('model-tree-walker-no-start-position: Neither boundaries nor starting position have been defined.');
                const t = e.direction || 'forward';
                if ('forward' != t && 'backward' != t)throw new Qa('model-tree-walker-unknown-direction: Only `backward` and `forward` direction allowed.', {direction: t});
                this.direction = t, this.boundaries = e.boundaries || null, this.position = e.startPosition ? Wu.createFromPosition(e.startPosition) : Wu.createFromPosition(this.boundaries['backward' == this.direction ? 'end' : 'start']), this.singleCharacters = !!e.singleCharacters, this.shallow = !!e.shallow, this.ignoreElementEnd = !!e.ignoreElementEnd, this._boundaryStartParent = this.boundaries ? this.boundaries.start.parent : null, this._boundaryEndParent = this.boundaries ? this.boundaries.end.parent : null, this._visitedParent = this.position.parent
            }
            ...
            _next() {
                const e = this.position, t = Wu.createFromPosition(this.position), o = this._visitedParent;
                ...
                if (n instanceof zu)return this.shallow ? t.offset++ : (t.path.push(0), this._visitedParent = n), this.position = t, st('elementStart', n, e, t, 1);
                if (n instanceof Du) {
                    let i;
                    ...
                    const r = t.offset - n.startOffset, a = new Bu(n, r, i);
            ...
            _previous() {
                ...
                if (n instanceof zu)return t.offset--, this.shallow ? (this.position = t, st('elementStart', n, e, t, 1)) : (t.path.push(n.maxOffset), this.position = t, this._visitedParent = n, this.ignoreElementEnd ? this._previous() : st('elementEnd', n, e, t));
                if (n instanceof Du) {
                    let i;
                    if (this.singleCharacters) i = 1; else {
                        let e = n.startOffset;
                    ...
                    const r = t.offset - n.startOffset, a = new Bu(n, r - i, i);
                    return t.offset -= i, this.position = t, st('text', a, e, t, i)
                }
        ...
        class Wu {
            constructor(e, t) {
                if (!e.is('element') && !e.is('documentFragment'))throw new Qa('model-position-root-invalid: Position root invalid.');
                if (!(t instanceof Array) || 0 === t.length)throw new Qa('model-position-path-incorrect: Position path must be an array with at least one item.', {path: t});
            ...
            get textNode() {
                ...
                return e instanceof Du && e.startOffset < this.offset ? e : null
            }
            ...
            getCommonPath(e) {
                ...
                const t = A(this.path, e.path), o = 'string' == typeof t ? Ma(this.path.length, e.path.length) : t;
            ...
            getShiftedBy(e) {
                const t = Wu.createFromPosition(this), o = t.offset + e;
                return t.offset = 0 > o ? 0 : o, t
            }
            ...
            isTouching(e) {
                ...
                switch (n) {
                    case'same':
                        return !0;
                    case'before':
                        t = Wu.createFromPosition(this), o = Wu.createFromPosition(e);
                        break;
                    case'after':
                        t = Wu.createFromPosition(e), o = Wu.createFromPosition(this);
                        break;
                    default:
                        return !1;
                }
            ...
            _getTransformedByDeletion(e, t) {
                const o = Wu.createFromPosition(this);
            ...
            _getTransformedByInsertion(e, t, o) {
                const n = Wu.createFromPosition(this);
            ...
            _getCombined(e, t) {
                const o = e.path.length - 1, n = Wu.createFromPosition(t);
                return n.offset = n.offset + this.path[o] - e.offset, n.path = n.path.concat(this.path.slice(o + 1)), n
            }

            static createAt(e, t) {
                if (e instanceof Wu)return this.createFromPosition(e); else {
                    const o = e;
            ...
            static createAfter(e) {
                if (!e.parent)throw new Qa('model-position-after-root: You cannot make a position after root.', {root: e});
                return this.createFromParentAndOffset(e.parent, e.endOffset)
            }

            static createBefore(e) {
                if (!e.parent)throw new Qa('model-position-before-root: You cannot make a position before root.', {root: e});
                return this.createFromParentAndOffset(e.parent, e.startOffset)
            }

            static createFromParentAndOffset(e, t) {
                if (!e.is('element') && !e.is('documentFragment'))throw new Qa('model-position-parent-incorrect: Position parent have to be a element or document fragment.');
                const o = e.getPath();
            ...
            static fromJSON(e, t) {
                if ('$graveyard' === e.root)return new Wu(t.graveyard, e.path);
                if (!t.getRoot(e.root))throw new Qa('model-position-fromjson-no-root: Cannot create position for document. Root with specified name does not exist.', {rootName: e.root});
                return new Wu(t.getRoot(e.root), e.path)
            }
        }
        class Uu {
            constructor(e, t = null) {
                this.start = Wu.createFromPosition(e), this.end = t ? Wu.createFromPosition(t) : Wu.createFromPosition(e)
            }

            *[Symbol.iterator]() {
                yield * new ju({boundaries: this, ignoreElementEnd: !0})
            }
            ...
            getDifference(e) {
                const t = [];
                return this.isIntersecting(e) ? (this.containsPosition(e.start) && t.push(new Uu(this.start, e.start)), this.containsPosition(e.end) && t.push(new Uu(e.end, this.end))) : t.push(Uu.createFromRange(this)), t
            }

            getIntersection(e) {
                if (this.isIntersecting(e)) {
                    let t = this.start, o = this.end;
                    return this.containsPosition(e.start) && (t = e.start), this.containsPosition(e.end) && (o = e.end), new Uu(t, o)
                }
                return null
            }

            getMinimalFlatRanges() {
                const e = [], t = this.start.getCommonPath(this.end).length, o = Wu.createFromPosition(this.start);
                for (let n = o.parent; o.path.length > t + 1;) {
                    const t = n.maxOffset - o.offset;
                    0 != t && e.push(new Uu(o, o.getShiftedBy(t))), o.path = o.path.slice(0, -1), o.offset++, n = n.parent
                }
                for (; o.path.length <= this.end.path.length;) {
                    const t = this.end.path[o.path.length - 1], n = t - o.offset;
                    0 != n && e.push(new Uu(o, o.getShiftedBy(n))), o.offset = t, o.path.push(0)
                }
                return e
            }

            getWalker(e = {}) {
                return e.boundaries = this, new ju(e)
            }
            ...
            *getPositions(e = {}) {
            ...
            getTransformedByDelta(e) {
                const t = [Uu.createFromRange(this)], o = new Set(['insert', 'move', 'remove', 'reinsert']);
                for (const n of e.operations)if (o.has(n.type))for (let o = 0; o < t.length; o++) {
                    let i;
                    i = 'insert' == n.type ? t[o]._getTransformedByDocumentChange(n.type, e.type, n.position, n.nodes.maxOffset) : t[o]._getTransformedByDocumentChange(n.type, e.type, n.targetPosition, n.howMany, n.sourcePosition), t.splice(o, 1,...i
                ),
                    o += i.length - 1
                }
                return t
            ...
            getTransformedByDeltas(e) {
                const t = [Uu.createFromRange(this)];
            ...
            _getTransformedByDocumentChange(e, t, o, n, i) {
                if ('insert' == e)return this._getTransformedByInsertion(o, n, !1, !1); else {
                    const e = Uu.createFromPositionAndShift(i, n);
                    if ('merge' == t && this.isCollapsed && (this.start.isEqual(e.start) || this.start.isEqual(e.end))) {
                        const t = this.start.offset - e.start.offset;
                        return [new Uu(o.getShiftedBy(t))]
                    }
                    if ('split' == t && this.isCollapsed && this.end.isEqual(e.end))return [new Uu(o.getShiftedBy(n))];
            ...
            _getTransformedByInsertion(e, t, o = !1, n = !1) {
                if (o && this.containsPosition(e))return [new Uu(this.start, e), new Uu(e._getTransformedByInsertion(e, t, !0), this.end._getTransformedByInsertion(e, t, this.isCollapsed))]; else {
                    const o = Uu.createFromRange(this), i = !!o.isCollapsed || n;
            ...
            _getTransformedByMove(e, t, o) {
                ...
                let n;
                const i = new Uu(e, e.getShiftedBy(o)), r = this.getDifference(i);
                let a = null;
                const s = this.getIntersection(i);
                1 == r.length ? a = new Uu(r[0].start._getTransformedByDeletion(e, o), r[0].end._getTransformedByDeletion(e, o)) : 2 == r.length && (a = new Uu(this.start, this.end._getTransformedByDeletion(e, o)));
                const l = t._getTransformedByDeletion(e, o);
                return n = a ? a._getTransformedByInsertion(l, o, null !== s) : [], s && n.push(new Uu(s.start._getCombined(i.start, l), s.end._getCombined(i.start, l))), n
            }
            ...
            static createFromParentsAndOffsets(e, t, o, n) {
                return new this(Wu.createFromParentAndOffset(e, t), Wu.createFromParentAndOffset(o, n))
            }
            ...
            static createOn(e) {
                return this.createFromPositionAndShift(Wu.createBefore(e), e.offsetSize)
            }

            static createCollapsedAt(e, t) {
                const o = Wu.createAt(e, t), n = Wu.createFromPosition(o);
                return new Uu(o, n)
            }

            static createFromRanges(e) {
                if (0 === e.length)throw new Qa('range-create-from-ranges-empty-array: At least one range has to be passed.'); else if (1 == e.length)return this.createFromRange(e[0]);
                const t = e[0];
                e.sort((e, t) = > e.start.isAfter(t.start) ? 1 : -1
            )
                ;
                const o = e.indexOf(t), n = new this(t.start, t.end);
                for (let t = o - 1; 0 <= t && e[t].end.isEqual(n.start); t++)n.start = Wu.createFromPosition(e[t].start);
                for (let t = o + 1; t < e.length && e[t].start.isEqual(n.end); t++)n.end = Wu.createFromPosition(e[t].end);
                return n
            }

            static fromJSON(e, t) {
                return new this(Wu.fromJSON(e.start, t), Wu.fromJSON(e.end, t))
            }
        }
        class Hu {
            constructor() {
                this._modelToViewMapping = new WeakMap, this._viewToModelMapping = new WeakMap, this._viewToModelLengthCallbacks = new Map, this._markerNameToElements = new Map, this.on('modelToViewPosition', (e, t) = > {if(
                !t.viewPosition
            )
                {
                ...
                t.modelPosition = Wu.createFromParentAndOffset(n, i)
            },
                {
                    priority:'low'
                }
            ...
            toModelRange(e) {
                return new Uu(this.toModelPosition(e.start), this.toModelPosition(e.end))
            }

            toViewRange(e) {
                return new vc(this.toViewPosition(e.start), this.toViewPosition(e.end))
            }
            ...
            _findPositionIn(e, t) {
                let o = 0, n = 0, i = 0, r;
                if (e.is('text'))return new wc(e, t);
                for (; n < t;)r = e.getChild(i), o = this.getModelLength(r), n += o, i++;
                return n == t ? this._moveViewPositionToTextNode(new wc(e, i)) : this._findPositionIn(r, t - (n - o))
            }

            _moveViewPositionToTextNode(e) {
                const t = e.nodeBefore, o = e.nodeAfter;
                if (t instanceof Pd)return new wc(t, t.data.length);
                return o instanceof Pd ? new wc(o, 0) : e
            }
        }
        f(Hu, is);
        class Ku {
            ...
            add(e, t) {
                t = lt(t), e instanceof Bu && (e = this._getSymbolForTextProxy(e)), this._consumable.has(e) || this._consumable.set(e, new Map), this._consumable.get(e).set(t, !0)
            }

            consume(e, t) {
                return t = lt(t), e instanceof Bu && (e = this._getSymbolForTextProxy(e)), !!this.test(e, t) && (this._consumable.get(e).set(t, !1), !0)
            }

            test(e, t) {
                t = lt(t), e instanceof Bu && (e = this._getSymbolForTextProxy(e));
        ...
        class Gu {
            constructor(e = {}) {
                this.conversionApi = dc({dispatcher: this}, e)
            }

            convertChanges(e, t) {
                for (const o of e.getMarkersToRemove())this.convertMarkerRemove(o.name, o.range, t);
                for (const o of e.getChanges())'insert' == o.type ? this.convertInsert(Uu.createFromPositionAndShift(o.position, o.length), t) : 'remove' == o.type ? this.convertRemove(o.position, o.length, o.name, t) : this.convertAttribute(o.range, o.attributeKey, o.attributeOldValue, o.attributeNewValue, t);
            ...
            convertInsert(e, t) {
                ...
                for (const o of e) {
                    const e = o.item, t = Uu.createFromPositionAndShift(o.previousPosition, o.length),
                        n = {item: e, range: t};
            ...
            convertAttribute(e, t, o, n, i) {
                ...
                for (const r of e) {
                    const e = r.item, i = Uu.createFromPositionAndShift(r.previousPosition, r.length);
            ...
            convertMarkerAdd(e, t, o) {
                if (t.root.document && '$graveyard' != t.root.rootName) {
                    ...
                    for (const o of t.getItems()) {
                        ...
                        const i = {item: o, range: Uu.createOn(o), markerName: e, markerRange: t};
        ...
        class $u {
            ...
            *getRanges() {
                for (const e of this._ranges)yield Uu.createFromRange(e)
            }

            getFirstRange() {
                let e = null;
                for (const t of this._ranges)(!e || t.start.isBefore(e.start)) && (e = t);
                return e ? Uu.createFromRange(e) : null
            }
            ...
            getFirstPosition() {
                const e = this.getFirstRange();
                return e ? Wu.createFromPosition(e.start) : null
            }

            getLastPosition() {
                const e = this.getLastRange();
                return e ? Wu.createFromPosition(e.end) : null
            }

            setTo(e, t, o) {
                if (null === e) this._setRanges([]); else if (e instanceof $u) this._setRanges(e.getRanges(), e.isBackward); else if (e && 'function' == typeof e.getRanges) this._setRanges(e.getRanges(), e.isBackward); else if (e instanceof Uu) this._setRanges([e], !!t && !!t.backward); else if (e instanceof Wu) this._setRanges([new Uu(e)]); else if (e instanceof Mu) {
                    const n = !!o && !!o.backward;
                    let i;
                    if ('in' == t) i = Uu.createIn(e); else if ('on' == t) i = Uu.createOn(e); else if (t !== void 0) i = Uu.createCollapsedAt(e, t); else throw new Qa('model-selection-setTo-required-second-parameter: selection.setTo requires the second parameter when the first parameter is a node.');
                    this._setRanges([i], n)
                } else if (P(e)) this._setRanges(e, t && !!t.backward); else throw new Qa('model-selection-setTo-not-selectable: Cannot set selection to given place.')
            }
            ...
            _setRanges(e, t = !1) {
                ...
                throw new Qa('model-selection-added-not-range: Trying to add an object that is not an instance of Range.');
            ...
            setFocus(e, t) {
                if (null === this.anchor)throw new Qa('model-selection-setFocus-no-ranges: Cannot set selection focus if there are no ranges in selection.');
                const o = Wu.createAt(e, t);
                if ('same' != o.compareWith(this.focus)) {
                    const e = this.anchor;
                    this._ranges.length && this._popRange(), 'before' == o.compareWith(e) ? (this._pushRange(new Uu(o, e)), this._lastRangeBackward = !0) : (this._pushRange(new Uu(e, o)), this._lastRangeBackward = !1), this.fire('change:range', {directChange: !0})
                }
            }
            ...
            getSelectedElement() {
                if (1 !== this.rangeCount)return null;
                const e = this.getFirstRange(), t = e.start.nodeAfter, o = e.end.nodeBefore;
                return t instanceof zu && t == o ? t : null
            }
            ...
            *getSelectedBlocks() {
                ...
                for (const t of this.getRanges()) {
                    ...
                    const n = ut(t.end, e);
                    n && !t.end.isTouching(Wu.createAt(n)) && (yield n)
                }
            }

            containsEntireContent(e = this.anchor.root) {
                const t = Wu.createAt(e), o = Wu.createAt(e, 'end');
                return t.isTouching(this.getFirstPosition()) && o.isTouching(this.getLastPosition())
            }

            _pushRange(e) {
                this._checkRange(e), this._ranges.push(Uu.createFromRange(e))
            }

            _checkRange(e) {
                for (let t = 0; t < this._ranges.length; t++)if (e.isIntersecting(this._ranges[t]))throw new Qa('model-selection-range-intersects: Trying to add a range that intersects with another range from selection.', {
                    addedRange: e,
        ...
        class Yu {
            constructor(e) {
                this._selection = new Xu(e), this._selection.delegate('change:range').to(this), this._selection.delegate('change:attribute').to(this)
            }
        ...
        class Xu extends $u {
            constructor(e) {
                ...
                if (!this._document._validateSelectionRange(e))throw new Qa('document-selection-wrong-position: Range from document selection starts or ends at incorrect position.', {range: e})
            }),
                this.listenTo(this._document, 'change', (e, t) = > {this._updateAttributes(!1), ft(this._model, t)
            }),
                this.listenTo(this._model, 'applyOperation', () = > {for(;
                this._fixGraveyardRangesData.length;
            )
                {
            ...
            *getRanges() {
            ...
            restoreGravity(e) {
                if (!this._overriddenGravityRegister.has(e))throw new Qa('document-selection-gravity-wrong-restore: Attempting to restore the selection gravity for an unknown UID.', {uid: e});
            ...
            _prepareRange(e) {
                if (this._checkRange(e), e.root == this._document.graveyard)return void Eu.warn('model-selection-range-in-graveyard: Trying to add a Range that is in the graveyard root. Range rejected.');
                const t = Ju.createFromRange(e);
                return t.on('change:range', (e, o, n) = > {this._hasChangedRange = !0, t.root == this._document.graveyard && this._fixGraveyardRangesData.push({
                    liveRange: t,
            ...
            *_getStoredAttributes() {
                ...
                if (this.isCollapsed && e.isEmpty)for (const t of e.getAttributeKeys())if (t.startsWith(Qu)) {
                    const o = t.substr(Qu.length);
            ...
            _fixGraveyardSelection(e, t) {
                const o = Wu.createFromPosition(t), n = this._model.schema.getNearestSelectionRange(o),
        ...
        class em {
            constructor(e) {
                this.model = e, this.view = new Nu, this.mapper = new Hu, this.downcastDispatcher = new Gu({mapper: this.mapper});
                const t = this.model.document, o = t.selection, n = this.model.markers;
                this.listenTo(t, 'change', () = > {this.view.change((e) = > {this.downcastDispatcher.convertChanges(t.differ, e), this.downcastDispatcher.convertSelection(o, n, e)
            })
            },
                {
                    priority:'low'
                ...
                this.listenTo(this.view.document, 'selectionChange', Et(this.model, this.mapper)), this.downcastDispatcher.on('insert:$text', Ct(), {priority: 'lowest'}), this.downcastDispatcher.on('remove', At(), {priority: 'low'}), this.downcastDispatcher.on('selection', Rt(), {priority: 'low'}), this.downcastDispatcher.on('selection', St(), {priority: 'low'}), this.downcastDispatcher.on('selection', Ot(), {priority: 'low'}), this.view.document.roots.bindTo(this.model.document.roots).using((e) = > {
                    if(
                    '$graveyard' == e.rootName
            )
                return null;
                const t = new kc(e.name);
        ...
        class tm {
            ...
            *[Symbol.iterator]() {
            ...
            load(e, t = []) {
                function o(e) {
                    return u.includes(e) || a.get(e) || l.has(e) ? void 0 : n(e).catch((t) = > {
                            throw Eu.error('plugincollection-load: It was not possible to load the plugin.', {plugin: e}),
                            t
                        }
                )
                }
                ...
                function n(e) {
                    return new Promise((n) = > {l.add(e), e.requires && e.requires.forEach((n) = > {const r = i(n);
                    if (t.includes(r))throw new Qa('plugincollection-required: Cannot load a plugin because one of its dependencies is listed inthe `removePlugins` option.', {
                        plugin: r,
                        requiredBy: e
                    });
                    o(r)
                ...
                if (m) {
                    ...
                    return Eu.error(e, {plugins: m}), Promise.reject(new Qa(e, {plugins: m}))
                }
            ...
            _add(e, t) {
                ...
                o && (this._plugins.has(o) ? Eu.warn('plugincollection-plugin-name-conflict: Two plugins with the same name were loaded.', {
                    pluginName: o,
        ...
        *
        ...
        class nm {
            ...
            _t(e, t) {
                ...
                return t && (o = o.replace(/%(\d+)/g, (e, o) = > o < t.length ? t[o] : e)
            ),
                o
            }
        }
        class im {
            ...
            add(e, t) {
                let o;
                return e.is('text') || e.is('documentFragment') ? void this._consumables.set(e, !0) : void(this._consumables.has(e) ? o = this._consumables.get(e) : (o = new rm, this._consumables.set(e, o)), o.add(t))
            }
            ...
            static createFrom(e, t) {
                if (t || (t = new im), e.is('text'))return t.add(e), t;
                e.is('element') && t.add(e, im.consumablesFromElement(e)), e.is('documentFragment') && t.add(e);
                for (const o of e.getChildren())t = im.createFrom(o, t);
                return t
            }
        }
        class rm {
            ...
            _add(e, t) {
                const o = al(t) ? t : [t], n = this._consumables[e];
                for (const i of o) {
                    if ('attributes' === e && ('class' === i || 'style' === i))throw new Qa('viewconsumable-invalid-attribute: Classes and styles should be handled separately.');
                    n.set(i, !0)
                }
            }
        ...
        class am {
            constructor() {
                this._sourceDefinitions = {}, this.decorate('checkChild'), this.decorate('checkAttribute'), this.on('checkAttribute', (e, t) = > {t[0] = new sm(t[0])}, {priority: 'highest'}
            ),
            ...
            register(e, t) {
                if (this._sourceDefinitions[e])throw new Qa('schema-cannot-register-item-twice: A single item cannot be registered twice in the schema.', {itemName: e});
                this._sourceDefinitions[e] = [Object.assign({}, t)], this._clearCache()
            }

            extend(e, t) {
                if (!this._sourceDefinitions[e])throw new Qa('schema-cannot-extend-missing-item: Cannot extend an item which was not registered yet.', {itemName: e});
            ...
            checkMerge(e, t = null) {
                if (e instanceof Wu) {
                    const t = e.nodeBefore, o = e.nodeAfter;
                    if (!(t instanceof zu))throw new Qa('schema-check-merge-no-element-before: The node before the merge position must be an element.');
                    if (!(o instanceof zu))throw new Qa('schema-check-merge-no-element-after: The node after the merge position must be an element.');
            ...
            addAttributeCheck(e) {
                this.on('checkAttribute', (t, [o, n]) = > {const i = e(o, n);
                'boolean' == typeof i && (t.stop(), t.return = i)
            },
                {
                    priority:'high'
            ...
            getLimitElement(e) {
                let t = Array.from(e.getRanges()).reduce((e, t) = > {const o = t.getCommonAncestor();
            ...
            checkAttributeInSelection(e, t) {
                if (e.isCollapsed)return this.checkAttribute([...e.getFirstPosition().getAncestors(), '$text'
            ],
                t
            )
                ;
            ...
            getValidRanges(e, t) {
                ...
                for (const n of e) {
                    ...
                    const r = n.end;
                    for (const r of n.getWalker())this.checkAttribute(r.item, t) || (!i.isEqual(e) && o.push(new Uu(i, e)), i = r.nextPosition), e = r.nextPosition;
                    i && !i.isEqual(r) && o.push(new Uu(i, r))
                }
                return o
            }

            getNearestSelectionRange(e, t = 'both') {
                if (this.checkChild(e, '$text'))return new Uu(e);
                let o, n;
                ('both' == t || 'backward' == t) && (o = new ju({
                    startPosition: e,
                    direction: 'backward'
                })), ('both' == t || 'forward' == t) && (n = new ju({startPosition: e}));
                for (const i of $t(o, n)) {
                    const e = i.walker == o ? 'elementEnd' : 'elementStart', t = i.value;
                    if (t.type == e && this.isObject(t.item))return Uu.createOn(t.item);
                    if (this.checkChild(t.nextPosition, '$text'))return new Uu(t.nextPosition)
                }
                return null
            }
        ...
        class sm {
            constructor(e) {
                return e instanceof sm ? e : void('string' == typeof e ? e = [e] : !Array.isArray(e) && (e = e.getAncestors({includeSelf: !0})), e[0] && 'string' != typeof e[0] && e[0].is('documentFragment') && e.shift(), this._items = e.map(Gt))
            }
        ...
        class lm {
            ...
            convert(e, t, o = ['$root']) {
                this.fire('viewCleanup', e), this._modelCursor = Qt(o, t), this.conversionApi.writer = t, this.conversionApi.consumable = im.createFrom(e), this.conversionApi.store = {};
            ...
            _convertItem(e, t) {
                ...
                if (e.is('element') ? this.fire('element:' + e.name, o, this.conversionApi) : e.is('text') ? this.fire('text', o, this.conversionApi) : this.fire('documentFragment', o, this.conversionApi), o.modelRange && !(o.modelRange instanceof Uu))throw new Qa('view-conversion-dispatcher-incorrect-result: Incorrect conversion result was dropped.');
            ...
            _convertChildren(e, t) {
                ...
                for (const i of Array.from(e.getChildren())) {
                    ...
                    e.modelRange instanceof Uu && (o.end = e.modelRange.end, n = e.modelCursor)
                }
        ...
        class dm {
            constructor(e, t) {
                this.model = e, this.processor = t, this.mapper = new Hu, this.downcastDispatcher = new Gu({mapper: this.mapper}), this.downcastDispatcher.on('insert:$text', Ct(), {priority: 'lowest'}), this.upcastDispatcher = new lm({schema: e.schema}), this.upcastDispatcher.on('text', co(), {priority: 'lowest'}), this.upcastDispatcher.on('element', lo(), {priority: 'lowest'}), this.upcastDispatcher.on('documentFragment', lo(), {priority: 'lowest'}), this.decorate('init')
            }
            ...
            toView(e) {
                const t = Uu.createIn(e), o = new Mc, n = new Dc(new Ac());
            ...
            init(e, t = 'main') {
                if (this.model.document.version)throw new Qa('datacontroller-init-document-not-empty: Trying to set initial data to not empty document.');
                const o = this.model.document.getRoot(t);
                return this.model.enqueueChange('transparent', (t) = > {t.insert(this.parse(e, o), o)
            }),
                Promise.resolve()
            }
            ...
            set(e, t = 'main') {
                const o = this.model.document.getRoot(t);
                this.model.enqueueChange('transparent', (t) = > {t.setSelection(null), t.removeSelectionAttribute(this.model.document.selection.getAttributeKeys()), t.remove(Uu.createIn(o)), t.insert(this.parse(e, o), o)
            })
            }
        ...
        class cm {
            ...
            register(e, t) {
                if (this._dispatchersGroups.has(e))throw new Qa('conversion-register-group-exists: Trying to register a group name that was already registered.');
            ...
            _getDispatchers(e) {
                ...
                if (!t)throw new Qa('conversion-for-unknown-group: Trying to add a converter to an unknown dispatchers group.');
                return t
            }
        }
        class um {
        ...
        class mm {
            constructor(e) {
                this.markers = new Map, this._children = new Lu, e && this._insertChild(0, e)
            }
            ...
            static fromJSON(e) {
                const t = [];
                for (const o of e)o.name ? t.push(zu.fromJSON(o)) : t.push(Du.fromJSON(o));
                return new mm(t)
            }
        ...
        class gm extends um {
            constructor(e, t, o, n, i) {
                super(i), this.range = Uu.createFromRange(e), this.key = t, this.oldValue = o === void 0 ? null : o, this.newValue = n === void 0 ? null : n
            }
            ...
            _validate() {
                for (const e of this.range.getItems()) {
                    if (null !== this.oldValue && !pm(e.getAttribute(this.key), this.oldValue))throw new Qa('attribute-operation-wrong-old-value: Changed node has different attribute value than operation\'s old attribute value.', {
                        item: e,
                        key: this.key,
                        value: this.oldValue
                    });
                    if (null === this.oldValue && null !== this.newValue && e.hasAttribute(this.key))throw new Qa('attribute-operation-attribute-exists: The attribute with given key already exists.', {
                        node: e,
                        key: this.key
                    })
                }
            ...
            _execute() {
                pm(this.oldValue, this.newValue) || _o(this.range, this.key, this.newValue)
            }
            ...
            static fromJSON(e, t) {
                return new gm(Uu.fromJSON(e.range, t), e.key, e.oldValue, e.newValue, e.baseVersion)
            }
        }
        class fm extends um {
            constructor(e, t, o, n) {
                super(n), this.sourcePosition = Wu.createFromPosition(e), this.howMany = t, this.targetPosition = Wu.createFromPosition(o), this.isSticky = !1
            }
            ...
            _validate() {
                ...
                if (!e || !t)throw new Qa('move-operation-position-invalid: Source position or target position is invalid.'); else if (o + this.howMany > e.maxOffset)throw new Qa('move-operation-nodes-do-not-exist: The nodes which should be moved do not exist.'); else if (e === t && o < n && n < o + this.howMany)throw new Qa('move-operation-range-into-itself: Trying to move a range of nodes to the inside of that range.'); else if (this.sourcePosition.root == this.targetPosition.root && 'prefix' == A(this.sourcePosition.getParentPath(), this.targetPosition.getParentPath())) {
                    const e = this.sourcePosition.path.length - 1;
                    if (this.targetPosition.path[e] >= o && this.targetPosition.path[e] < o + this.howMany)throw new Qa('move-operation-node-into-itself: Trying to move a range of nodes into one of nodes from that range.')
                }
            }

            _execute() {
                ko(Uu.createFromPositionAndShift(this.sourcePosition, this.howMany), this.targetPosition)
            }
            ...
            static fromJSON(e, t) {
                const o = Wu.fromJSON(e.sourcePosition, t), n = Wu.fromJSON(e.targetPosition, t),
        ...
        class hm extends fm {
            ...
            _validate() {
                if (super._validate(), !this.sourcePosition.root.document)throw new Qa('reinsert-operation-on-detached-item: Cannot reinsert detached item.');
                if (!this.targetPosition.root.document)throw new Qa('reinsert-operation-to-detached-parent: Cannot reinsert item to detached parent.')
            }
        ...
        class bm extends fm {
            ...
            getReversed() {
                const e = this.sourcePosition._getTransformedByInsertion(this.targetPosition, this.howMany);
                return new hm(this.getMovedRangeStart(), this.howMany, e, this.baseVersion + 1)
            }

            _validate() {
                if (super._validate(), !this.sourcePosition.root.document)throw new Qa('remove-operation-on-detached-item: Cannot remove detached item.')
            }
        ...
        class km extends um {
            constructor(e, t, o) {
                super(o), this.position = Wu.createFromPosition(e), this.nodes = new Lu(wo(t))
            }
            ...
            clone() {
                const e = new Lu([...this.nodes
            ].
                map((e) = > e._clone(!0)
            ))
                ;
                return new km(this.position, e, this.baseVersion)
            }

            getReversed() {
                const e = this.position.root.document.graveyard, t = new Wu(e, [0]);
                return new bm(this.position, this.nodes.maxOffset, t, this.baseVersion + 1)
            }

            _validate() {
                const e = this.position.parent;
                if (!e || e.maxOffset < this.position.offset)throw new Qa('insert-operation-position-invalid: Insertion position is invalid.')
            }
            ...
            static fromJSON(e, t) {
                const o = [];
                for (const n of e.nodes)n.name ? o.push(zu.fromJSON(n)) : o.push(Du.fromJSON(n));
                return new km(Wu.fromJSON(e.position, t), o, e.baseVersion)
            }
        }
        class _m extends um {
            constructor(e, t, o, n, i) {
                super(i), this.name = e, this.oldRange = t ? Uu.createFromRange(t) : null, this.newRange = o ? Uu.createFromRange(o) : null, this._markers = n
            }
            ...
            clone() {
                return new _m(this.name, this.oldRange, this.newRange, this._markers, this.baseVersion)
            }

            getReversed() {
                return new _m(this.name, this.newRange, this.oldRange, this._markers, this.baseVersion + 1)
            }
            ...
            static fromJSON(e, t) {
                return new _m(e.name, e.oldRange ? Uu.fromJSON(e.oldRange, t) : null, e.newRange ? Uu.fromJSON(e.newRange, t) : null, t.model.markers, e.baseVersion)
            }
        }
        class wm extends um {
            get type() {
            ...
            clone() {
                return new wm(this.baseVersion)
            }

            getReversed() {
                return new wm(this.baseVersion + 1)
            }
        ...
        class vm extends um {
            ...
            clone() {
                return new vm(Wu.createFromPosition(this.position), this.oldName, this.newName, this.baseVersion)
            }

            getReversed() {
                return new vm(Wu.createFromPosition(this.position), this.newName, this.oldName, this.baseVersion + 1)
            }

            _validate() {
                const e = this.position.nodeAfter;
                if (!(e instanceof zu))throw new Qa('rename-operation-wrong-position: Given position is invalid or node after it is not an instance of Element.'); else if (e.name !== this.oldName)throw new Qa('rename-operation-wrong-name: Element to change has different name than operation\'s old name.')
            }
            ...
            static fromJSON(e, t) {
                return new vm(Wu.fromJSON(e.position, t), e.oldName, e.newName, e.baseVersion)
            }
        }
        class ym extends um {
            constructor(e, t, o, n, i) {
            ...
            clone() {
                return new ym(this.root, this.key, this.oldValue, this.newValue, this.baseVersion)
            }

            getReversed() {
                return new ym(this.root, this.key, this.newValue, this.oldValue, this.baseVersion + 1)
            }

            _validate() {
                if (this.root != this.root.root || this.root.is('documentFragment'))throw new Qa('rootattribute-operation-not-a-root: The element to change is not a root element.', {
                    root: this.root,
                    key: this.key
                });
                if (null !== this.oldValue && this.root.getAttribute(this.key) !== this.oldValue)throw new Qa('rootattribute-operation-wrong-old-value: Changed node has different attribute value than operation\'s old attribute value.', {
                    root: this.root,
                    key: this.key
                });
                if (null === this.oldValue && null !== this.newValue && this.root.hasAttribute(this.key))throw new Qa('rootattribute-operation-attribute-exists: The attribute with given key already exists.', {
                    root: this.root,
                    key: this.key
                })
            }
            ...
            static fromJSON(e, t) {
                if (!t.getRoot(e.root))throw new Qa('rootattribute-operation-fromjson-no-root: Cannot create RootAttributeOperation. Root with specified name does not exist.', {rootName: e});
                return new ym(t.getRoot(e.root), e.key, e.oldValue, e.newValue, e.baseVersion)
            }
        }
        const xm = {};
        xm[gm.className] = gm, xm[km.className] = km, xm[_m.className] = _m, xm[fm.className] = fm, xm[wm.className] = wm, xm[um.className] = um, xm[hm.className] = hm, xm[bm.className] = bm, xm[vm.className] = vm, xm[ym.className] = ym;
        class Cm {
            static fromJSON(e, t) {
                return xm[e.__className].fromJSON(e, t)
            }
        }
        const Am = new Map;
        class Tm {
            static fromJSON(e, t) {
                if (!Am.has(e.__className))throw new Qa('delta-fromjson-no-deserializer: This delta has no defined deserializer', {name: e.__className});
                const o = Am.get(e.__className), n = new o;
                for (const o of e.operations)n.addOperation(Cm.fromJSON(o, t));
                for (const o in e)'__className' != o && void 0 === n[o] && (n[o] = e[o]);
                return n
            }

            static register(e) {
                Am.set(e.className, e)
            }
        }
        class Pm {
            constructor() {
        ...
        class Em extends Pm {
            ...
            get range() {
                ...
                let e = null, t = null;
                for (const o of this.operations)o instanceof wm || ((null === e || e.isAfter(o.range.start)) && (e = o.range.start), (null === t || t.isBefore(o.range.end)) && (t = o.range.end));
                return e && t ? (this._range = new Uu(e, t), this._range) : null
            }
        ...
        class Sm extends Pm {
            ...
            get _moveOperation() {
                return this.operations[1] && this.operations[1] instanceof fm ? this.operations[1] : null
            }
        ...
        class Fm extends Pm {
            ...
            get range() {
                ...
                return e ? Uu.createFromPositionAndShift(e.sourcePosition, e.howMany) : null
            }
        ...
        Tm.register(Dm);
        var Bm = function (e, t, o={isStrong: !1}) {
            let n, i;
            e instanceof km ? n = Lm.InsertOperation : e instanceof gm ? n = Lm.AttributeOperation : e instanceof ym ? n = Lm.RootAttributeOperation : e instanceof vm ? n = Lm.RenameOperation : e instanceof _m ? n = Lm.MarkerOperation : e instanceof fm ? n = Lm.MoveOperation : i = Co, n && (t instanceof km ? i = n.InsertOperation : t instanceof gm ? i = n.AttributeOperation : t instanceof ym ? i = n.RootAttributeOperation : t instanceof vm ? i = n.RenameOperation : t instanceof _m ? i = n.MarkerOperation : t instanceof fm ? i = n.MoveOperation : i = Co);
            const r = i(e, t, o);
        ...
        const Lm = {
            InsertOperation: {
                ...
                InsertOperation(e, t){
                    ...
                    return o.reverse().map((t) = > new gm(t, e.key, e.oldValue, e.newValue, e.baseVersion)
                )
                }, AttributeOperation(e, t, o){
                    if (e.key === t.key) {
                        const n = e.range.getDifference(t.range).map((t) = > new gm(t, e.key, e.oldValue, e.newValue, e.baseVersion)
                    ),
                        i = e.range.getIntersection(t.range);
                        return i && (o.isStrong ? n.push(new gm(i, t.key, t.newValue, e.newValue, e.baseVersion)) : 0 === n.length && n.push(new wm(0))), n
                    }
                    return [e.clone()]
                }, RootAttributeOperation: Co, RenameOperation: Co, MarkerOperation: Co, MoveOperation(e, t){
                    const o = Uu.createFromPositionAndShift(t.sourcePosition, t.howMany);
                    let n = [];
                    const i = Po(e.range.getDifference(o)), r = e.range.getIntersection(o);
                    return null !== i && (i.start = i.start._getTransformedByDeletion(t.sourcePosition, t.howMany), i.end = i.end._getTransformedByDeletion(t.sourcePosition, t.howMany), n = i._getTransformedByInsertion(t.getMovedRangeStart(), t.howMany, !0, !1).reverse()), null !== r && (r.start = r.start._getCombined(t.sourcePosition, t.getMovedRangeStart()), r.end = r.end._getCombined(t.sourcePosition, t.getMovedRangeStart()), n.push(r)), n.map((t) = > new gm(t, e.key, e.oldValue, e.newValue, e.baseVersion)
                )
                }
            }, RootAttributeOperation: {
                InsertOperation: Co, AttributeOperation: Co, RootAttributeOperation(e, t, o){
                    return e.root !== t.root || e.key !== t.key || (e.newValue === t.newValue || o.isStrong) && e.newValue !== t.newValue ? [e.clone()] : [new wm(e.baseVersion)]
                ...
                InsertOperation(e, t){
                    ...
                    const n = e.clone();
                    if (e.position.isEqual(t.position))if (o.isStrong) n.oldName = t.newName; else return [new wm(e.baseVersion)];
                    return [n]
                ...
                InsertOperation(e, t){
                    ...
                    const n = e.clone();
                    if (e.name == t.name)if (o.isStrong) n.oldRange = t.newRange; else return [new wm(e.baseVersion)];
                    return [n]
                }, MoveOperation(e, t){
                    const o = e.clone();
                    if (o.oldRange) {
                        const e = o.oldRange._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany);
                        o.oldRange = Uu.createFromRanges(e)
                    }
                    if (o.newRange) {
                        const e = o.newRange._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany);
                        o.newRange = Uu.createFromRanges(e)
                    }
                    return [o]
                }
            }, MoveOperation: {
                InsertOperation(e, t, o){
                    let n = Uu.createFromPositionAndShift(e.sourcePosition, e.howMany);
                ...
                MarkerOperation: Co,
                MoveOperation(e, t, o){
                    const n = Uu.createFromPositionAndShift(e.sourcePosition, e.howMany),
                        i = Uu.createFromPositionAndShift(t.sourcePosition, t.howMany);
                    let r = o.isStrong;
                    ...
                    o.forceWeakRemove || (e instanceof bm && !(t instanceof bm) ? r = !0 : !(e instanceof bm) && t instanceof bm && (r = !1));
                    ...
                    return null !== g && r && !d && (g.start = g.start._getCombined(t.sourcePosition, t.getMovedRangeStart()), g.end = g.end._getCombined(t.sourcePosition, t.getMovedRangeStart()), 0 === m.length ? m.push(g) : 1 == m.length ? i.start.isBefore(n.start) || i.start.isEqual(n.start) ? m.unshift(g) : m.push(g) : m.splice(1, 0, g)), 0 === m.length ? [new wm(e.baseVersion)] : Eo(m, l, e)
                }
            }
        };
        var ot = function (e, t, o) {
            ...
            return r
        }, zm = Math.ceil, jm = function (e) {
            return al(e) || il(e)
        }, qm = Oo, Wm = function (e, t, o) {
            ...
            if (t !== t)return Wm(e, o);
            for (var n = o - 1, i = e.length; ++n < i;)if (e[n] === t)return n;
            return -1
        }, Hm = function (e, t) {
            return !!e.length && -1 < Um(e, t, 0)
        }, Km = function (e, t, o) {
            ...
            var i = -1, r = Hm, a = !0, s = e.length, l = [], d = t.length;
            if (!s)return l;
            o && (t = Gm(t, $m(o))), n ? (r = Km, a = !1) : t.length >= 200 && (r = Jm, a = !1, t = new Yc(t));
            outer:for (; ++i < s;) {
                var c = e[i], u = o ? o(c) : c;
            ...
            return Zs(e) ? Qm(e, qm(t, 1, Zs, !0)) : []
        }), Xm = 1, Zm = 2, ep = function (e) {
            return e === e && !cs(e)
        }, tp = function (e, t) {
            ...
            return function (t) {
                var o = Hl(t);
                return o == '[object Map]' ? td(t) : o == '[object Set]' ? op(t) : tp(t, e(t))
            }
        }(fl), ip = function (e) {
            for (var t = np(e), o = t.length; o--;)t[o][2] = ep(t[o][1]);
            return t
        }, rp = function (e, t) {
            return function (o) {
            ...
            var t = ip(e);
            return 1 == t.length && t[0][2] ? rp(t[0][0], t[0][1]) : function (o) {
                return o === e || Ro(o, e, t)
            }
        }, sp = 'Expected a function';
        Io.Cache = Ms;
        var lp = dd ? dd.prototype : void 0, dp = lp ? lp.toString : void 0, cp = function (e) {
                if ('string' == typeof e)return e;
                if (Md(e))return dp ? dp.call(e) : '';
                var t = e + '';
            ...
            gp = Io(function (e) {
                var t = [];
                return up(e).replace(mp, function (e, o, n, i) {
                    t.push(n ? i.replace(pp, '$1') : o || e)
                }), t
            }), fp = function (e) {
                return al(e) ? e : gp(e)
            }, hp = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, bp = /^\w*$/, kp = Vo, _p = function (e) {
                if ('string' == typeof e || Md(e))return e;
                var t = e + '';
                return '0' == t && 1 / e == -(1 / 0) ? '-0' : t
            }, wp = function (e, t) {
                t = kp(t, e) ? [t] : fp(t);
                for (var o = 0, n = t.length; null != e && o < n;)e = e[_p(t[o++])];
                return o && o == n ? e : void 0
            }, vp = function (e, t, o) {
                var n = null == e ? void 0 : wp(e, t);
                return n === void 0 ? o : n
            }, yp = function (e, t, o) {
                t = kp(t, e) ? [t] : fp(t);
                ...
                if (r)return r;
                var i = e ? e.length : 0;
                return !!i && Ys(i) && ml(a, i) && (al(e) || dl(e) || il(e))
            }, xp = function (e, t) {
                return null != e && yp(e, t, Fo)
            }, Cp = function (e, t) {
                return kp(e) && ep(t) ? rp(_p(e), t) : function (o) {
                    var n = vp(o, e);
                    return n === void 0 && n === t ? xp(o, e) : gu(t, n, void 0, 1 | 2)
                }
            }, Ap = function (e) {
                return e
            }, Tp = function (e) {
                ...
                return kp(e) ? Js(_p(e)) : Tp(e)
            }, Ep = function (e) {
                return 'function' == typeof e ? e : null == e ? Ap : 'object' == typeof e ? al(e) ? Cp(e[0], e[1]) : ap(e) : Pp(e)
            }, Sp = $d(function (e, t) {
                var o = qu(t);
                return Zs(o) && (o = void 0), Zs(e) ? Qm(e, qm(t, 1, Zs, !0), Ep(o)) : []
            }), Op = $d(function (e, t) {
                var o = qu(t);
                return Zs(o) && (o = void 0), Zs(e) ? Qm(e, qm(t, 1, Zs, !0), void 0, o) : []
            }), Rp = function (e, t, o) {
                var n = e ? e.length : 0;
                return n ? (t = o || void 0 === t ? 1 : Kd(t), ot(e, 0 > t ? 0 : t, n)) : []
            }, Ip = function (e, t, o) {
                var n = e ? e.length : 0;
                return n ? (t = o || void 0 === t ? 1 : Kd(t), t = n - t, ot(e, 0, 0 > t ? 0 : t)) : []
            }, Vp = function (e, t, o, n) {
                ...
                return e ? Fp(Kd(e), 0, 4294967295) : 0
            }, Mp = function (e, t, o, n) {
                var i = e.length;
                for (o = Kd(o), 0 > o && (o = -o > i ? 0 : i + o), n = void 0 === n || n > i ? i : Kd(n), 0 > n && (n += i), n = o > n ? 0 : Np(n); o < n;)e[o++] = t;
                return e
            }, Dp = function (e, t, o) {
                ...
                for (var n = o ? Km : Hm, i = e[0].length, r = e.length, a = r, s = Array(r), l = Infinity, d = []; a--;) {
                    var c = e[a];
                    a && t && (c = Gm(c, $m(t))), l = Ma(c.length, l), s[a] = !o && (t || 120 <= i && 120 <= c.length) ? new Yc(a && c) : void 0
                }
                c = e[0];
                var u = -1, m = s[0];
                outer:for (; ++u < i && d.length < l;) {
                    var p = c[u], g = t ? t(p) : p;
                    if (p = o || 0 !== p ? p : 0, m ? !Jm(m, g) : !n(d, g, o)) {
                        for (a = r; --a;) {
                            var f = s[a];
                            if (f ? !Jm(f, g) : !n(e[a], g, o))continue outer
                        }
                        m && m.push(g), d.push(p)
                    }
                }
                ...
                var t = Gm(e, zp);
                return t.length && t[0] === e[0] ? Lp(t) : []
            }), qp = $d(function (e) {
                var t = qu(e), o = Gm(e, zp);
                return t === qu(o) ? t = void 0 : o.pop(), o.length && o[0] === e[0] ? Lp(o, Ep(t)) : []
            }), Wp = $d(function (e) {
                var t = qu(e), o = Gm(e, zp);
                return t === qu(o) ? t = void 0 : o.pop(), o.length && o[0] === e[0] ? Lp(o, void 0, t) : []
            }), Up = Array.prototype, Hp = Up.join, Kp = function (e, t) {
                var o = e.length;
                if (o)return t += 0 > t ? o : 0, ml(t, o) ? e[t] : void 0
            }, Gp = function (e, t, o, n) {
                for (var i = o - 1, r = e.length; ++i < r;)if (n(e[i], t))return i;
                return -1
            }, $p = Array.prototype, Jp = $p.splice, Qp = function (e, t, o, n) {
                var i = n ? Gp : Um, r = -1, a = t.length, s = e;
                for (o && (s = Gm(e, $m(o))); ++r < a;)for (var l = 0, d = t[r], c = o ? o(d) : d; -1 < (l = i(s, c, l, n));)s !== e && Jp.call(s, l, 1), Jp.call(e, l, 1);
                return e
            }, Yp = function (e, t) {
                return e && e.length && t && t.length ? Qp(e, t) : e
            }, Xp = $d(Yp), Zp = function (e, t) {
                for (var o = -1, n = t.length, i = Array(n); ++o < n;)i[o] = null == e ? void 0 : vp(e, t[o]);
                return i
            }, eg = function (e, t) {
                return 1 == t.length ? e : wp(e, ot(t, 0, -1))
            }, tg = Array.prototype, og = tg.splice, ng = function (e, t) {
                for (var o = e ? t.length : 0, n = o - 1; o--;) {
                    var i = t[o];
                    if (o == n || i !== r) {
                        var r = i;
                        if (ml(i)) og.call(e, i, 1); else if (!kp(i, e)) {
                            var a = fp(i), s = eg(e, a);
                            null != s && delete s[_p(qu(a))]
                        } else delete e[_p(i)]
                    }
                }
                return e
                ...
                if (e !== t) {
                    var o = e !== void 0, n = null === e, i = e === e, r = Md(e), a = t !== void 0, s = null === t,
                        l = t === t, d = Md(t);
                ...
                t = qm(t, 1);
                var o = e ? e.length : 0, n = Zp(e, t);
                return ng(e, Gm(t, function (e) {
                    return ml(e, o) ? +e : e
                }).sort(ig)), n
            }), ag = Array.prototype, sg = ag.reverse, lg = function (e, t, o, n) {
                t = o(t);
                for (var i = 0, r = e ? e.length : 0, a = t !== t, s = null === t, l = Md(t), d = void 0 === t; i < r;) {
                    var c = Da((i + r) / 2), u = o(e[c]), m = u !== void 0, p = null === u, g = u === u, f = Md(u);
                    if (a)var h = n || g; else h = d ? g && (n || m) : s ? g && m && (n || !p) : l ? g && m && !p && (n || !f) : !(p || f) && (n ? u <= t : u < t);
                    h ? i = c + 1 : r = c
                }
                return Ma(r, 4294967295 - 1)
            }, dg = function (e, t, o) {
                var n = 0, i = e ? e.length : n;
                if ('number' == typeof t && t === t && i <= 4294967295 >>> 1) {
                    for (; n < i;) {
                        var r = n + i >>> 1, a = e[r];
                        null !== a && !Md(a) && (o ? a <= t : a < t) ? n = r + 1 : i = r
                    }
                    return i
                }
                return lg(e, t, Ap, o)
                ...
                return r
            }, ug = Ol && 1 / ad(new Ol([, -0]))[1] == 1 / 0 ? function (e) {
                return new Ol(e)
            } : function () {
            }, mg = function (e, t, o) {
                var n = -1, i = Hm, r = e.length, a = !0, s = [], l = s;
                if (o) a = !1, i = Km; else if (r >= 200) {
                    var d = t ? null : ug(e);
                    if (d)return ad(d);
                    a = !1, i = Jm, l = new Yc
                } else l = t ? [] : s;
                ...
                return mg(qm(e, 1, Zs, !0))
            }), gg = $d(function (e) {
                var t = qu(e);
                return Zs(t) && (t = void 0), mg(qm(e, 1, Zs, !0), Ep(t))
            }), fg = $d(function (e) {
                var t = qu(e);
                return Zs(t) && (t = void 0), mg(qm(e, 1, Zs, !0), void 0, t)
            }), hg = function (e, t) {
                for (var o = -1, n = e.length, i = 0, r = []; ++o < n;) {
                    var a = e[o];
                    t(a, o, e) && (r[i++] = a)
                ...
                var t = 0;
                return e = hg(e, function (e) {
                    if (Zs(e))return t = Na(e.length, t), !0
                }), $s(t, function (t) {
                    return Gm(e, Js(t))
                })
            }, kg = function (e, t) {
                if (!(e && e.length))return [];
                var o = bg(e);
                return null == t ? o : Gm(o, function (e) {
                    return Vd(t, void 0, e)
                })
            }, _g = $d(function (e, t) {
                return Zs(e) ? Qm(e, t) : []
            }), wg = function (e, t, o) {
                for (var n = -1, i = e.length; ++n < i;)var r = r ? yl(Qm(r, e[n], t, o), Qm(e[n], r, t, o)) : e[n];
                return r && r.length ? mg(r, t, o) : []
            }, vg = $d(function (e) {
                return wg(hg(e, Zs))
            }), yg = $d(function (e) {
                var t = qu(e);
                return Zs(t) && (t = void 0), wg(hg(e, Zs), Ep(t))
            }), xg = $d(function (e) {
                var t = qu(e);
                return Zs(t) && (t = void 0), wg(hg(e, Zs), void 0, t)
            }), Cg = $d(bg), Ag = function (e, t, o) {
                ...
                for (var i = -1, r = t.length, a = e; null != a && ++i < r;) {
                    ...
                    if (cs(a)) {
                        ...
                        if (i != r - 1) {
                            var d = a[s];
                            l = n ? n(d, s, a) : void 0, l === void 0 && (l = null == d ? ml(t[i + 1]) ? [] : {} : d)
                        }
                        js(a, s, l)
                    }
                    a = a[s]
                ...
                return o = 'function' == typeof o ? (e.pop(), o) : void 0, kg(e, o)
            }), Eg = {
                chunk: function (e, t, o) {
                    t = (o ? Id(e, t, o) : void 0 === t) ? 1 : Na(Kd(t), 0);
                    var n = e ? e.length : 0;
                    if (!n || 1 > t)return [];
                    for (var i = 0, r = 0, a = Array(zm(n / t)); i < n;)a[r++] = ot(e, i, i += t);
                    return a
                },
                compact: function (e) {
                ...
                concat: function () {
                    ...
                    return e ? yl(al(o) ? kl(o) : [o], qm(t, 1)) : []
                },
                difference: Ym,
                differenceBy: Sp,
                differenceWith: Op,
                ...
                dropRightWhile: function (e, t) {
                    return e && e.length ? Vp(e, Ep(t, 3), !0, !0) : []
                },
                dropWhile: function (e, t) {
                    return e && e.length ? Vp(e, Ep(t, 3), !0) : []
                },
                fill: function (e, t, o, n) {
                    var i = e ? e.length : 0;
                    return i ? (o && 'number' != typeof o && Id(e, t, o) && (o = 0, n = i), Mp(e, t, o, n)) : []
                },
                findIndex: function (e, t) {
                    return e && e.length ? Dp(e, Ep(t, 3)) : -1
                },
                findLastIndex: function (e, t) {
                    return e && e.length ? Dp(e, Ep(t, 3), !0) : -1
                },
                first: Bp,
                flatten: function (e) {
                    var t = e ? e.length : 0;
                ...
                flattenDepth: function (e, t) {
                    var o = e ? e.length : 0;
                    return o ? (t = void 0 === t ? 1 : Kd(t), qm(e, t)) : []
                },
                ...
                indexOf: function (e, t, o) {
                    var n = e ? e.length : 0;
                    return n ? (o = Kd(o), 0 > o && (o = Na(n + o, 0)), Um(e, t, o)) : -1
                },
                initial: function (e) {
                    return Ip(e, 1)
                },
                ...
                lastIndexOf: function (e, t, o) {
                    ...
                    if (!n)return -1;
                    var i = n;
                    if (void 0 !== o && (i = Kd(o), i = (0 > i ? Na(n + i, 0) : Ma(i, n - 1)) + 1), t !== t)return Wm(e, i, !0);
                    for (; i--;)if (e[i] === t)return i;
                    return -1
                },
                nth: function (e, t) {
                    return e && e.length ? Kp(e, Kd(t)) : void 0
                },
                pull: Xp,
                pullAll: Yp,
                pullAllBy: function (e, t, o) {
                    return e && e.length && t && t.length ? Qp(e, t, Ep(o)) : e
                },
                pullAllWith: function (e, t, o) {
                    return e && e.length && t && t.length ? Qp(e, t, void 0, o) : e
                },
                pullAt: rg,
                remove: function (e, t) {
                    var o = [];
                ...
                reverse: function (e) {
                    return e ? sg.call(e) : e
                },
                slice: function (e, t, o) {
                    var n = e ? e.length : 0;
                    return n ? (o && 'number' != typeof o && Id(e, t, o) ? (t = 0, o = n) : (t = null == t ? 0 : Kd(t), o = void 0 === o ? n : Kd(o)), ot(e, t, o)) : []
                },
                ...
                sortedUniq: function (e) {
                    return e && e.length ? cg(e) : []
                },
                sortedUniqBy: function (e, t) {
                    return e && e.length ? cg(e, Ep(t)) : []
                },
                tail: function (e) {
                    return Rp(e, 1)
                },
                take: function (e, t, o) {
                    return e && e.length ? (t = o || void 0 === t ? 1 : Kd(t), ot(e, 0, 0 > t ? 0 : t)) : []
                },
                takeRight: function (e, t, o) {
                    var n = e ? e.length : 0;
                    return n ? (t = o || void 0 === t ? 1 : Kd(t), t = n - t, ot(e, 0 > t ? 0 : t, n)) : []
                },
                takeRightWhile: function (e, t) {
                    return e && e.length ? Vp(e, Ep(t, 3), !1, !0) : []
                },
                takeWhile: function (e, t) {
                    return e && e.length ? Vp(e, Ep(t, 3)) : []
                },
                union: pg,
                unionBy: gg,
                unionWith: fg,
                uniq: function (e) {
                    return e && e.length ? mg(e) : []
                },
                uniqBy: function (e, t) {
                    return e && e.length ? mg(e, Ep(t)) : []
                },
                uniqWith: function (e, t) {
                    return e && e.length ? mg(e, void 0, t) : []
                },
                unzip: bg,
                unzipWith: kg,
                without: _g,
        ...
        const Sg = new Map, Og = {
            transform(e, t, o){
                const n = Og.getTransformationCase(e, t) || Og.defaultTransform, i = n(e, t, Object.assign({}, o)),
                    r = Eg.last(t.operations).baseVersion;
                return No(r, i)
                ...
                let n = Sg.get(e);
                n || (n = new Map, Sg.set(e, n)), n.set(t, o)
            }, getTransformationCase(e, t){
                let o = Sg.get(e.constructor);
                if (!o || !o.get(t.constructor)) {
                    const n = Sg.keys();
                    for (const i of n)if (e instanceof i && Sg.get(i).get(t.constructor)) {
                        o = Sg.get(i);
                        break
                    }
                }
        ...
        Tm.register(Ig);
        const Vg = Rg.addTransformationCase, Fg = Rg.defaultTransform;
        Vg(Em, Dm, (e, t, o) = > {const n = Fg(e, t, o);
        ...
        return Fg(e, t, o);
        const n = o.undoMode, i = new Wu(t.position.root, t.position.path.slice(0, -1)), r = Fg(e, t, o);
        if (n || !(t._cloneOperation instanceof km))return r;
        for (const n of e.operations)if (n.range.containsPosition(i) || n.range.start.isEqual(i)) {
            const e = new Em, o = i.getShiftedBy(1), a = Wu.createFromPosition(o);
            a.path.push(0);
            const s = t._cloneOperation.nodes.getNode(0).getAttribute(n.key);
            e.addOperation(new gm(new Uu(o, a), n.key, s === void 0 ? null : s, n.newValue, 0)), r.push(e);
            break
        }
        return r
    }),
        ...
        return Fg(e, t, o);
        const n = o.undoMode;
        return !n && e.position.isEqual(t.position) ? [t.getReversed(), e.clone()] : Fg(e, t, o)
    }),
        Vg(Ig, Sm, Ko), Vg(Ig, Om, Ko), Vg(Ig, Fm, Ko), Vg(Ig, Nm, Ko), Vg(Ig, Rm, Ko), Vg(Ig, Vm, Ko), Vg(Rm, Om, (e, t, o) = > {const n = o.undoMode;
        if (n || !t.position)return Fg(e, t, o);
        ...
        return i && r ? [t.getReversed(), e.clone()] : Fg(e, t, o)
    }),
        Vg(Om, Mm, (e, t, o) = > {if(
        !e.position
        )
        return Fg(e, t, o);
        const n = o.undoMode;
        return !n && e.position.isEqual(t.position) ? [$o()] : Fg(e, t, o)
    }),
        Vg(Om, Rm, (e, t, o) = > {const n = o.undoMode;
        if (n || !e.position)return Fg(e, t, o);
        ...
        return i && r ? [$o()] : Fg(e, t, o)
    }),
        Vg(Sm, Sm, (e, t, o) = > {const n = o.undoMode;
        if (n)return Fg(e, t, o);
        if (!e.position || !t.position)return Fg(e, t, o);
        ...
        if (e.position.root == t.position.root && 'same' == A(i, r))if (e = e.clone(), e.position.offset < t.position.offset || e.position.offset == t.position.offset && o.isStrong) {
            e._cloneOperation instanceof hm && t._cloneOperation instanceof hm && e._cloneOperation.sourcePosition.offset > t._cloneOperation.sourcePosition.offset && e._cloneOperation.sourcePosition.offset--;
            const o = Uu.createFromPositionAndShift(e.position, e._moveOperation.howMany),
                n = Uu.createFromPositionAndShift(t.position, t._moveOperation.howMany), i = o.getDifference(n);
            let r = 0;
            for (const e of i)r += e.end.offset - e.start.offset;
            return 0 == r ? (e.operations.pop(), e.addOperation(new wm(e.operations[0].baseVersion + 1))) : e.operations[1].howMany = r, [e]
        } else {
            const n = Object.assign({}, o);
            return n.isStrong = !0, n.insertBefore = !0, Fg(e, t, n)
        }
        return Fg(e, t, o)
    }),
        Vg(Sm, Nm, (e, t, o) = > e.position ? e.position.root == t.position.root && 'same' === A(t.position.path, e.position.getParentPath()) ? [$o()] : Fg(e, t, o) : Fg(e, t, o)
        ),
        Vg(Sm, Fm, (e, t, o) = > {if(
        !e.position
        )
        ...
        return Fg(e, t, o);
        e = e.clone();
        const n = o.undoMode, i = new Wu(e.position.root, e.position.path.slice(0, -1));
        if (n || !(e._cloneOperation instanceof km))return [e];
        ...
        Vg(Nm, Sm, (e, t, o) = > t.position ? e.position.root == t.position.root && 'same' === A(e.position.path, t.position.getParentPath()) ? [t.getReversed(), e.clone()] : Fg(e, t, o) : Fg(e, t, o)
        ),
        Vg(Dm, Em, (e, t) = > {const o = [e.clone()];
        ...
        Vg(Vm, Sm, (e, t, o) = > {const n = o.undoMode, i=Fg(e, t, o);
        if (n || !(t._cloneOperation instanceof km))return i;
        ...
        return a.isEqual(i) && (r.howMany += 1), Fg(e, t, o)
    })
        ;
        class Ng {
        ...
        class Dg extends um {
            constructor(e, t) {
                super(null), this.sourcePosition = Wu.createFromPosition(e), this.howMany = t
            }
            ...
            _validate() {
                if (this.sourcePosition.root.document)throw new Qa('detach-operation-on-document-node: Cannot detach document node.')
            }

            _execute() {
                bo(Uu.createFromPositionAndShift(this.sourcePosition, this.howMany))
            }
        ...
        class Lg {
            ...
            insert(e, t, o) {
                ...
                const n = Wu.createAt(t, o), i = e instanceof Du && !e.parent ? new Dm : new Mm;
                if (e.parent) {
                    if (Zo(e.root, n.root))return void this.move(Uu.createOn(e), n);
                ...
                const r = n.root.document ? n.root.document.version : null, a = new km(n, e, r);
                if (this.batch.addDelta(i), i.addOperation(a), this.model.applyOperation(a), e instanceof mm)for (const [t, o]of e.markers) {
                    const e = Wu.createAt(o.root), i = new Uu(o.start._getCombined(e, n), o.end._getCombined(e, n));
                    this.addMarker(t, {range: i, usingOperation: !0})
                }
            }

            insertText(e, t, o, n) {
                t instanceof mm || t instanceof zu || t instanceof Wu ? this.insert(this.createText(e), t, o) : this.insert(this.createText(e, t), o, n)
            }

            insertElement(e, t, o, n) {
                t instanceof mm || t instanceof zu || t instanceof Wu ? this.insert(this.createElement(e), t, o) : this.insert(this.createElement(e, t), o, n)
            }
            ...
            appendText(e, t, o) {
                t instanceof mm || t instanceof zu ? this.insert(this.createText(e), t, 'end') : this.insert(this.createText(e, t), o, 'end')
            }

            appendElement(e, t, o) {
                t instanceof mm || t instanceof zu ? this.insert(this.createElement(e), t, 'end') : this.insert(this.createElement(e, t), o, 'end')
            }

            setAttribute(e, t, o) {
                this._assertWriterUsedCorrectly(), o instanceof Uu ? Jo(this, e, t, o) : Qo(this, e, t, o)
            }
            ...
            removeAttribute(e, t) {
                this._assertWriterUsedCorrectly(), t instanceof Uu ? Jo(this, e, null, t) : Qo(this, e, null, t)
            }
            ...
            >
                ...
                ;
                if (!(e instanceof Uu)) t(e); else for (const o of e.getItems())t(o)
            }

            move(e, t, o) {
                if (this._assertWriterUsedCorrectly(), !(e instanceof Uu))throw new Qa('writer-move-invalid-range: Invalid range to move.');
                if (!e.isFlat)throw new Qa('writer-move-range-not-flat: Range to move is not flat.');
                const n = Wu.createAt(t, o);
                if (!Zo(e.root, n.root))throw new Qa('writer-move-different-document: Range is going to be moved between different documents.');
                const i = new Rm;
                this.batch.addDelta(i);
                const r = e.root.document ? e.root.document.version : null,
                    a = new fm(e.start, e.end.offset - e.start.offset, n, r);
            ...
            merge(e) {
                ...
                if (!(o instanceof zu))throw new Qa('writer-merge-no-element-before: Node before merge position must be an element.');
                if (!(n instanceof zu))throw new Qa('writer-merge-no-element-after: Node after merge position must be an element.');
                const i = Wu.createFromParentAndOffset(n, 0), r = Wu.createFromParentAndOffset(o, o.maxOffset),
                    a = e.root.document ? e.root.document.version : null, s = new fm(i, n.maxOffset, r, a);
                s.isSticky = !0, t.addOperation(s), this.model.applyOperation(s), Xo(e, 1, t, this.model)
            }

            rename(e, t) {
                if (this._assertWriterUsedCorrectly(), !(e instanceof zu))throw new Qa('writer-rename-not-element-instance: Trying to rename an object which is not an instance of Element.');
                const o = new Vm;
                this.batch.addDelta(o);
                const n = e.root.document ? e.root.document.version : null,
                    i = new vm(Wu.createBefore(e), e.name, t, n);
            ...
            split(e, t) {
                this._assertWriterUsedCorrectly();
                let o = e.parent;
                if (!o.parent)throw new Qa('writer-split-element-no-parent: Element with no parent can not be split.');
                if (t || (t = o.parent), !e.parent.getAncestors({includeSelf: !0}).includes(t))throw new Qa('writer-split-invalid-limit-element: Limit element is not a position ancestor.');
                let n, i;
                do {
                    const t = new Sm;
                    this.batch.addDelta(t);
                    const r = new zu(o.name, o.getAttributes()), a = o.root.document ? o.root.document.version : null,
                        s = new km(Wu.createAfter(o), r, a);
                    t.addOperation(s), this.model.applyOperation(s);
                    const l = null === a ? null : a + 1,
                        d = new fm(e, o.maxOffset - e.offset, Wu.createFromParentAndOffset(r, 0), l);
                    d.isSticky = !0, t.addOperation(d), this.model.applyOperation(d), n || i || (n = o, i = r), e = Wu.createBefore(r), o = e.parent
                } while (o !== t);
                return {position: e, range: new Uu(Wu.createAt(n, 'end'), Wu.createAt(i))}
            }

            wrap(e, t) {
                if (this._assertWriterUsedCorrectly(), !e.isFlat)throw new Qa('writer-wrap-range-not-flat: Range to wrap is not flat.');
                const o = t instanceof zu ? t : new zu(t);
                if (0 < o.childCount)throw new Qa('writer-wrap-element-not-empty: Element to wrap with is not empty.');
                if (null !== o.parent)throw new Qa('writer-wrap-element-attached: Element to wrap with is already attached to tree model.');
                const n = new Fm;
                this.batch.addDelta(n);
                const i = e.root.document ? e.root.document.version : null, r = new km(e.end, o, i);
                n.addOperation(r), this.model.applyOperation(r);
                const a = null === i ? null : i + 1, s = Wu.createFromParentAndOffset(o, 0),
                    l = new fm(e.start, e.end.offset - e.start.offset, s, a);
                n.addOperation(l), this.model.applyOperation(l)
            }

            unwrap(e) {
                if (this._assertWriterUsedCorrectly(), null === e.parent)throw new Qa('writer-unwrap-element-no-parent: Trying to unwrap an element which has no parent.');
                const t = new Nm;
                this.batch.addDelta(t);
                const o = Wu.createFromParentAndOffset(e, 0), n = o.root.document ? o.root.document.version : null,
                    i = new fm(o, e.maxOffset, Wu.createBefore(e), n);
                i.isSticky = !0, t.addOperation(i), this.model.applyOperation(i), Xo(Wu.createBefore(e), 1, t, this.model)
            }

            addMarker(e, t) {
                if (this._assertWriterUsedCorrectly(), !t || 'boolean' != typeof t.usingOperation)throw new Qa('writer-addMarker-no-usingOperations: The options.usingOperations parameter is required when adding a new marker.');
                const o = t.usingOperation, n = t.range;
                if (this.model.markers.has(e))throw new Qa('writer-addMarker-marker-exists: Marker with provided name already exists.');
                if (!n)throw new Qa('writer-addMarker-no-range: Range parameter is required when adding a new marker.');
            ...
            updateMarker(e, t) {
                ...
                if (!n)throw new Qa('writer-updateMarker-marker-not-exists: Marker with provided name does not exists.');
                const i = t && t.range, r = !!t && 'boolean' == typeof t.usingOperation;
                if (!r && !i)throw new Qa('writer-updateMarker-wrong-options: One of options is required - provide range or usingOperations.');
            ...
            removeMarker(e) {
                ...
                if (!this.model.markers.has(t))throw new Qa('writer-removeMarker-no-marker: Trying to remove marker which does not exist.');
            ...
            _setSelectionAttribute(e, t) {
                ...
                if (o.isCollapsed && o.anchor.parent.isEmpty) {
                    const n = Yu._getStoreAttributeKey(e);
            ...
            _removeSelectionAttribute(e) {
                ...
                if (t.isCollapsed && t.anchor.parent.isEmpty) {
                    const o = Yu._getStoreAttributeKey(e);
            ...
            _assertWriterUsedCorrectly() {
                if (this.model._currentWriter !== this)throw new Qa('writer-incorrect-use: Trying to use a writer outside the change() block.')
            }
        }
        class zg {
            constructor(e) {
            ...
            bufferOperation(e) {
                switch (e.type) {
                    ...
                    case'rename': {
                        ...
                        const t = Uu.createFromPositionAndShift(e.position, 1);
            ...
            getChanges(e = {includeChangesInGraveyard: !1}) {
                ...
                for (const o of this._changesInElement.keys()) {
                    ...
                    for (const e of a)if ('i' === e) t.push(this._getInsertDiff(o, s, r[s].name)), s++; else if ('r' === e) t.push(this._getRemoveDiff(o, s, n[i].name)), i++; else if ('a' === e) {
                        ...
                        let l;
                        if ('$text' == r[s].name) l = Uu.createFromParentsAndOffsets(o, s, o, s + 1); else {
                            const e = o.offsetToIndex(s);
                            l = Uu.createFromParentsAndOffsets(o, s, o.getChild(e), 0)
                        }
                        t.push(...this._getAttributesDiff(l, a, e)
                    ),
                        s++, i++
                    } else s++, i++
                }
            ...
            _getInsertDiff(e, t, o) {
                return {
                    type: 'insert',
                    position: Wu.createFromParentAndOffset(e, t),
                    name: o,
                    length: 1,
            ...
            _removeAllNestedChanges(e, t, o) {
                const n = Uu.createFromParentsAndOffsets(e, t, e, t + o);
            ...
            *getDeltas(e = 0, t = Fa) {
            ...
            _getIndex(e) {
                ...
                if (t === void 0) {
                    ...
                    if (0 > e || e >= o)return -1;
                    throw new Qa('model-history-wrong-version: Given base version points to the middle of a delta.')
                }
                return t
            }
        }
        ...
        class Wg {
            constructor(e) {
                this.model = e, this.version = 0, this.history = new jg(this), this.selection = new Yu(this), this.roots = new Cc({idProperty: 'rootName'}), this.differ = new zg(e.markers), this._postFixers = new Set, this.createRoot('$root', qg), this.listenTo(e, 'applyOperation', (e, t) = > {const o = t[0];
                if (o.isDocumentOperation && o.baseVersion !== this.version)throw new Qa('model-document-applyOperation-wrong-version: Only operations with matching versions can be applied.', {operation: o})
            },
                {
                    priority:'highest'
                }
            ),
                this.listenTo(e, 'applyOperation', (e, t) = > {const o = t[0];
                ...
                ;
                let t = !1;
                this.listenTo(this.selection, 'change', () = > {t=!0}
            ),
                this.listenTo(e, '_change', (e, o) = > {(!this.differ.isEmpty || t) && (this._callPostFixers(o), this.fire('change', o.batch), this.differ.reset(), t = !1)
            }),
            ...
            get graveyard() {
                return this.getRoot(qg)
            }

            createRoot(e = '$root', t = 'main') {
                if (this.roots.get(t))throw new Qa('model-document-createRoot-name-exists: Root with specified name already exists.', {name: t});
                const o = new Bg(this, e, t);
            ...
            getRootNames() {
                return Array.from(this.roots, (e) = > e.rootName
            ).
                filter((e) = > e != qg
            )
            }
            ...
            _getDefaultRange() {
                const e = this._getDefaultRoot(), t = this.model.schema, o = new Wu(e, [0]),
        ...
        class Ug {
            ...
            _set(e, t, o = !1) {
                const n = e instanceof Hg ? e.name : e, i = this._markers.get(n);
                if (i) {
                    const e = i.getRange();
                    let r = !1;
                    return e.isEqual(t) || (i._attachLiveRange(Ju.createFromRange(t)), r = !0), o != i.managedUsingOperations && (i._managedUsingOperations = o, r = !0), r && this.fire('update:' + n, i, e, t), i
                }
                const r = Ju.createFromRange(t), a = new Hg(n, r, o);
                return this._markers.set(n, a), this.fire('update:' + n, a, null, t), a
            }

            _remove(e) {
                const t = e instanceof Hg ? e.name : e, o = this._markers.get(t);
        ...
        class Hg {
            ...
            get managedUsingOperations() {
                if (!this._liveRange)throw new Qa('marker-destroyed: Cannot use a destroyed marker instance.');
                return this._managedUsingOperations
            }

            getStart() {
                if (!this._liveRange)throw new Qa('marker-destroyed: Cannot use a destroyed marker instance.');
                return Wu.createFromPosition(this._liveRange.start)
            }

            getEnd() {
                if (!this._liveRange)throw new Qa('marker-destroyed: Cannot use a destroyed marker instance.');
                return Wu.createFromPosition(this._liveRange.end)
            }

            getRange() {
                if (!this._liveRange)throw new Qa('marker-destroyed: Cannot use a destroyed marker instance.');
                return Uu.createFromRange(this._liveRange)
            }
        ...
        class Kg extends Wu {
            constructor(e, t, o) {
                if (super(e, t), !this.root.is('rootElement'))throw new Qa('model-liveposition-root-not-rootelement: LivePosition\'s root has to be an instance of RootElement.');
        ...
        class Gg {
            ...
            getSelectionRange() {
                return this.nodeToSelect ? Uu.createOn(this.nodeToSelect) : this.model.schema.getNearestSelectionRange(this.position)
            }
            ...
            _insert(e) {
                if (!this.schema.checkChild(this.position, e))return void Eu.error('insertcontent-wrong-position: The node cannot be inserted on the given position.', {
                    node: e,
                    position: this.position
                });
                const t = Kg.createFromPosition(this.position);
                this.writer.insert(e, this.position), this.position = Wu.createFromPosition(t), t.detach(), this.nodeToSelect = this.schema.isObject(e) && !this.schema.checkChild(this.position, '$text') ? e : null, this._filterAttributesOf.push(e)
            }

            _mergeSiblingsOf(e, t) {
                if (e instanceof zu) {
                    const o = this._canMergeLeft(e, t), n = this._canMergeRight(e, t), i = Kg.createBefore(e),
                        r = Kg.createAfter(e);
                    if (o) {
                        const e = Kg.createFromPosition(this.position);
                        this.writer.merge(i), this.position = Wu.createFromPosition(e), e.detach()
                    }
                    if (n) {
                        this.position.isEqual(r) || Eu.error('insertcontent-wrong-position-on-merge: The insertion position should equal the merge position'), this.position = Wu.createAt(r.nodeBefore, 'end');
                        const e = new Kg(this.position.root, this.position.path, 'sticksToPrevious');
                        this.writer.merge(r), this.position = Wu.createFromPosition(e), e.detach()
                    }
            ...
            _canMergeLeft(e, t) {
                const o = e.previousSibling;
                return t.isFirst && o instanceof zu && this.canMergeWith.has(o) && this.model.schema.checkMerge(o, e)
            }

            _canMergeRight(e, t) {
                const o = e.nextSibling;
                return t.isLast && o instanceof zu && this.canMergeWith.has(o) && this.model.schema.checkMerge(e, o)
            }
            ...
            _checkAndSplitToAllowedPosition(e) {
                ...
                for (; t != this.position.parent;) {
                    ...
                    if (this.position.isAtStart) {
                        const e = this.position.parent;
                        this.position = Wu.createBefore(e), e.isEmpty && this.writer.remove(e)
                    } else if (this.position.isAtEnd) this.position = Wu.createAfter(this.position.parent); else {
                        const e = Wu.createAfter(this.position.parent);
        ...
        class Jg {
            constructor() {
                this.markers = new Ug, this.document = new Wg(this), this.schema = new am, this._pendingChanges = [], this._currentWriter = null, ['insertContent', 'deleteContent', 'modifySelection', 'getSelectedContent', 'applyOperation'].forEach((e) = > this.decorate(e)
            ),
                this.on('applyOperation', (e, t) = > {const o = t[0];
                o._validate()
            },
                {
                    priority:'highest'
                ...
                this.schema.register('$root', {isLimit: !0}), this.schema.register('$block', {
                    allowIn: '$root',
                    isBlock: !0
            ...
            enqueueChange(e, t) {
                'string' == typeof e ? e = new Ng(e) : 'function' == typeof e && (t = e, e = new Ng), this._pendingChanges.push({
                    batch: e,
                    callback: t
            ...
            transformDeltas(e, t, o = !1) {
                return Rg.transformDeltaSets(e, t, o ? this.document : null)
            }
            ...
            hasContent(e) {
                if (e instanceof zu && (e = Uu.createIn(e)), e.isCollapsed)return !1;
            ...
            _runPendingChanges() {
                ...
                for (; this._pendingChanges.length;) {
                    ...
                    this._currentWriter = new Lg(this, t);
        ...
        class Qg {
            constructor() {
                this._listener = Object.create($c)
            }

            listenTo(e) {
                this._listener.listenTo(e, 'keydown', (e, t) = > {this._listener.fire('_keydown:' + te(t), t)
            })
            }

            set(e, t, o = {}) {
                const n = oe(e), i = o.priority;
                this._listener.listenTo(this._listener, '_keydown:' + n, (e, o) = > {t(o,() =
            >
                {
        ...
        class Xg {
            constructor(e) {
                ...
                this.config = new $a(e, this.constructor.build && this.constructor.build.config), this.config.define('plugins', t), this.plugins = new tm(this, t), this.commands = new om, this.locale = new nm(this.config.get('language')), this.t = this.locale.t, this.set('isReadOnly', !1), this.model = new Jg, this.data = new dm(this.model), this.editing = new em(this.model), this.editing.view.document.bind('isReadOnly').to(this), this.conversion = new cm, this.conversion.register('downcast', [this.editing.downcastDispatcher, this.data.downcastDispatcher]), this.conversion.register('editingDowncast', [this.editing.downcastDispatcher]), this.conversion.register('dataDowncast', [this.data.downcastDispatcher]), this.conversion.register('upcast', [this.data.upcastDispatcher]), this.keystrokes = new Yg(this), this.keystrokes.listenTo(this.editing.view.document)
            }
            ...
            destroy() {
                return this.fire('destroy'), this.stopListening(), this.commands.destroy(), this.plugins.destroy().then(() = > {this.model.destroy(), this.data.destroy(), this.editing.destroy(), this.keystrokes.destroy()
            })
            }
        ...
        create(e)
        {
            return new Promise((t) = > {const o = new this(e);
            t(o.initPlugins().then(() = > {o.fire('dataReady'), o.fire('ready')
        }).
            then(() = > o
        ))
        })
        ...
        class of {
            constructor() {
                this._domParser = new DOMParser, this._domConverter = new Kc({blockFiller: zc}), this._htmlWriter = new tf
            }
        ...
        class nf {
            ...
            *names() {
            ...
            add(e, t) {
                if (this.has(e))throw new Qa('componentfactory-item-exists: The item already exists in the component factory.', {name: e});
                this._components.set(Rn(e), {callback: t, originalName: e})
            }

            create(e) {
                if (!this.has(e))throw new Qa('componentfactory-item-missing: The required component is not registered in the factory.', {name: e});
        ...
        class rf {
            ...
            add(e) {
                if (this._elements.has(e))throw new Qa('focusTracker-add-element-already-exist');
        ...
        class af {
            constructor(e, t) {
                this.editor = e, this.view = t, this.componentFactory = new nf(e), this.focusTracker = new rf, this._toolbarConfig = Vn(e.config.get('toolbar'))
            }

            init() {
                const e = this.editor, t = this.view;
                t.render(), t.panel.bind('isVisible').to(this.focusTracker, 'isFocused'), this._toolbarConfig.viewportTopOffset && (t.viewportTopOffset = this._toolbarConfig.viewportTopOffset), t.listenTo(e.editing.view, 'render', () = > {t.panel.isVisible && t.panel.pin({
                    target: t.editableElement,
                    positions: t.panelPositions
                })
            })
                ;
                const o = e.editing.view.document.getRoot();
                t.editable.bind('isReadOnly').to(o), t.editable.bind('isFocused').to(this.focusTracker), e.editing.view.attachDomRoot(t.editableElement), t.editable.name = o.rootName, this.focusTracker.add(t.editableElement), t.toolbar.fillFromConfig(this._toolbarConfig.items, this.componentFactory), In({
        ...
        class sf extends Cc {
            constructor(e) {
                super({idProperty: 'viewUid'}), this.on('add', (e, t, o) = > {t.isRendered || t.render(), t.element && this._parentElement && this._parentElement.insertBefore(t.element, this._parentElement.children[o])
            }),
        ...
        this.on('remove', (o, n) = > {for(const i of e
        )
        n.stopDelegating(i, t)
    })
    }
    }
    }
        ...
        class df {
            ...
            revert(e) {
                if (!this._revertData)throw new Qa('ui-template-revert-not-applied: Attempting to revert a template which has not been applied yet.');
            ...
            *getViews() {
            ...
            static bind(e, t) {
                return {
                    to(o, n){
                        return new uf({eventNameOrFunction: o, attribute: o, observable: e, emitter: t, callback: n})
                    }, if(o, n, i){
                        return new mf({observable: e, emitter: t, attribute: o, valueIfTrue: n, callback: i})
                    }
                }
            }

            static extend(e, t) {
                e._isRendered && Eu.warn('template-extend-render: Attempting to extend a template which has already been rendered.'), Qn(e, qn(jn(t)))
            }

            _renderNode(e) {
                let t;
                if (t = e.node ? this.tag && this.text : this.tag ? this.text : !this.text, t)throw new Qa('ui-template-wrong-syntax: Node definition must have either "tag" or "text" when rendering a new Node.');
            ...
            _renderAttributes(e) {
                ...
                if (this.attributes) {
                    ...
                    for (t in this.attributes)if (n = r.getAttribute(t), o = this.attributes[t], a && (a.attributes[t] = n), i = cs(o[0]) && o[0].ns ? o[0].ns : null, Nn(o)) {
                        const s = i ? o[0].value : o;
                        a && oi(t) && s.unshift(n), this._bindToObservable({schema: s, updater: Ln(r, t, i), data: e})
                    } else'style' == t && 'string' != typeof o[0] ? this._renderStyleAttribute(o[0], e) : (a && n && oi(t) && o.unshift(n), o = o.map((e) = > e ? e.value || e : e).reduce((e, t) = > e.concat(t), []
                ).
                    reduce($n, ''), Yn(o) || r.setAttributeNS(i, t, o)
                )
                }
            }
            ...
            _setUpListeners(e) {
                if (this.eventListeners)for (const t in this.eventListeners) {
                    const o = this.eventListeners[t].map((o) = > {const[n, i] = t.split('@');
            ...
            _bindToObservable({schema: e, updater: t, data: o}) {
                ...
                Dn(e, t, o);
                const i = e.filter((e) = > !Yn(e)
            ).
                filter((e) = > e.observable
            ).
                map((n) = > n.activateAttributeListener(e, t, o)
            )
                ;
                n && n.bindings.push(i)
            }
        ...
        var pf = o(11), gf = o.n(pf);
        class ff {
            constructor(e) {
                this.element = null, this.isRendered = !1, this.locale = e, this.t = e && e.t, this._viewCollections = new Cc, this._unboundChildren = this.createCollection(), this._viewCollections.on('add', (t, o) = > {o.locale = e
            }),
                this.decorate('render')
            }

            get bindTemplate() {
                return this._bindTemplate ? this._bindTemplate : this._bindTemplate = df.bind(this, this)
            }
            ...
            setTemplate(e) {
                this.template = new df(e)
            }

            extendTemplate(e) {
                df.extend(this.template, e)
            }

            render() {
                if (this.isRendered)throw new Qa('ui-view-render-already-rendered: This View has already been rendered.');
        ...
        class kf extends ff {
            ...
            _renderBodyCollection() {
                const e = this._bodyCollectionContainer = new df({
                    tag: 'div',
        ...
        class _f extends ff {
            constructor(e, t) {
                ...
                t && (this.element = this.editableElement = t), this.setTemplate({
                    tag: 'div',
                    attributes: {class: ['ck', 'ck-content', 'ck-editor__editable', 'ck-rounded-corners', o.to('isFocused', (e) = > e ? 'ck-focused' : 'ck-blurred')
            ],
        ...
        class wf extends _f {
            constructor(e, o) {
                ...
                this.extendTemplate({
                    attributes: {
                        role: 'textbox',
                        "aria-label": n.to('name', (e) = > i('ae', [e])), class
            :
        ...
        var vf = o(16), yf = o.n(vf);
        const xf = function (e) {
            return (t) =
            >
            t + e
        }('px'), Cf = Hc.document.body;
        class Af extends ff {
            constructor(e) {
                super(e);
                ...
                this.set('top', 0), this.set('left', 0), this.set('position', 'arrow_nw'), this.set('isVisible', !1), this.set('withArrow', !0), this.set('className'), this.content = this.createCollection(), this.setTemplate({
                    tag: 'div',
                    attributes: {class: ['ck', 'ck-balloon-panel', t.to('position', (e) = > `ck-balloon-panel_${e}`), t.if('isVisible', 'ck-balloon-panel_visible'), t.if('withArrow', 'ck-balloon-panel_with-arrow'), t.to('className')
            ],
                style:{
                    top:t.to('top', xf), left
                :
                    t.to('left', xf)
                }
            },
            ...
            attachTo(e) {
                this.show();
                const t = Af.defaultPositions, o = Object.assign({}, {
            ...
            _startPinning(e) {
                this.attachTo(e);
                const t = li(e.target), o = e.limiter ? li(e.limiter) : Cf;
                this.listenTo(Hc.document, 'scroll', (n, i) = > {
                    const r = i.target,
                    a=t && r.contains(t),
                    s=o && r.contains(o);
                ...
                this.listenTo(Hc.window, 'resize', () = > {this.attachTo(e)
            })
            }

            _stopPinning() {
                this.stopListening(Hc.document, 'scroll'), this.stopListening(Hc.window, 'resize')
            }
        }
        Af.arrowHorizontalOffset = 25, Af.arrowVerticalOffset = 10, Af.defaultPositions = {northArrowSouth: (e, t) = > ({
                top: di(e, t),
        ...
        ({
            top: di(e, t),
            left: e.left + e.width / 2 - t.width + Af.arrowHorizontalOffset,
            name: 'arrow_se'
        }), northArrowSouthWest
        :
        (e, t) =
        >
        ({top: di(e, t), left: e.left + e.width / 2 - Af.arrowHorizontalOffset, name: 'arrow_sw'}), northWestArrowSouth
        :
        (e, t) =
        >
        ({top: di(e, t), left: e.left - t.width / 2, name: 'arrow_s'}), northWestArrowSouthWest
        :
        (e, t) =
        >
        ({top: di(e, t), left: e.left - Af.arrowHorizontalOffset, name: 'arrow_sw'}), northWestArrowSouthEast
        :
        (e, t) =
        >
        ({top: di(e, t), left: e.left - t.width + Af.arrowHorizontalOffset, name: 'arrow_se'}), northEastArrowSouth
        :
        (e, t) =
        >
        ({top: di(e, t), left: e.right - t.width / 2, name: 'arrow_s'}), northEastArrowSouthEast
        :
        (e, t) =
        >
        ({top: di(e, t), left: e.right - t.width + Af.arrowHorizontalOffset, name: 'arrow_se'}), northEastArrowSouthWest
        :
        (e, t) =
        >
        ({top: di(e, t), left: e.right - Af.arrowHorizontalOffset, name: 'arrow_sw'}), southArrowNorth
        :
        (e, t) =
        >
        ({top: ci(e, t), left: e.left + e.width / 2 - t.width / 2, name: 'arrow_n'}), southArrowNorthEast
        :
        (e, t) =
        >
        ({
        ...
        (e, t) =
        >
        ({top: ci(e, t), left: e.left + e.width / 2 - Af.arrowHorizontalOffset, name: 'arrow_nw'}), southWestArrowNorth
        :
        (e, t) =
        >
        ({top: ci(e, t), left: e.left - t.width / 2, name: 'arrow_n'}), southWestArrowNorthWest
        :
        (e, t) =
        >
        ({top: ci(e, t), left: e.left - Af.arrowHorizontalOffset, name: 'arrow_nw'}), southWestArrowNorthEast
        :
        (e, t) =
        >
        ({top: ci(e, t), left: e.left - t.width + Af.arrowHorizontalOffset, name: 'arrow_ne'}), southEastArrowNorth
        :
        (e, t) =
        >
        ({top: ci(e, t), left: e.right - t.width / 2, name: 'arrow_n'}), southEastArrowNorthEast
        :
        (e, t) =
        >
        ({top: ci(e, t), left: e.right - t.width + Af.arrowHorizontalOffset, name: 'arrow_ne'}), southEastArrowNorthWest
        :
        (e, t) =
        >
        ({top: ci(e, t), left: e.right - Af.arrowHorizontalOffset, name: 'arrow_nw'})
    }
        ;
        class Tf {
            constructor(e) {
                if (Object.assign(this, e), e.actions && e.keystrokeHandler)for (const t in e.actions) {
                    let o = e.actions[t];
                    'string' == typeof o && (o = [o]);
                    for (const n of o)e.keystrokeHandler.set(n, (e, o) = > {this[t](), o()}
                )
                }
            }

            get first() {
                return this.focusables.find(ui) || null
            }

            get last() {
                return this.focusables.filter(ui).slice(-1)[0] || null
            }
            ...
            get current() {
                let e = null;
                return null === this.focusTracker.focusedElement ? null : (this.focusables.find((t, o) = > {const n = t.element === this.focusTracker.focusedElement;
                return n && (e = o), n
            }),
                e
            )
        ...
        var Ef = o(18), Sf = o.n(Ef);
        class Of extends ff {
            constructor(e) {
                super(e);
                const t = this.bindTemplate;
                this.items = this.createCollection(), this.focusTracker = new rf, this.keystrokes = new Qg, this.set('isVertical', !1), this.set('className'), this._focusCycler = new Tf({
            ...
            fillFromConfig(e, t) {
                e.map((e) = > {'|' == e ? this.items.add(new Pf) : t.has(e) ? this.items.add(t.create(e)) : Eu.warn('toolbarview-item-unavailable: The requested toolbar item is unavailable.', {name: e})
            })
            }
        }
        class Rf extends kf {
            constructor(e, t) {
                super(e), this.toolbar = new Of(e), this.set('viewportTopOffset', 0), this.toolbar.extendTemplate({attributes: {class: ['ck-toolbar_floating']}}), this.panel = new Af(e), this.panel.withArrow = !1, this.panelPositions = this._getPanelPositions(), this.panel.extendTemplate({attributes: {class: 'ck-toolbar-container'}}), this.editable = new wf(e, t), this.body.add(this.panel), this.registerChild(this.editable)
            }

            render() {
                super.render(), this.panel.content.add(this.toolbar)
            }
            ...
            _getPanelPositionTop(e, t) {
                let o;
                return o = e.top > t.height + this.viewportTopOffset ? e.top - t.height : e.bottom > t.height + this.viewportTopOffset + 50 ? this.viewportTopOffset : e.bottom, o
            }

            _getPanelPositions() {
                return [(e, t) = > ({
                    top: this._getPanelPositionTop(e, t),
                    left: e.left,
                    name: 'toolbar_west'
                }), (e, t) =
            >
                ({top: this._getPanelPositionTop(e, t), left: e.left + e.width - t.width, name: 'toolbar_east'})
            ]
            }
        }
        class If extends Xg {
            constructor(e, t) {
                super(t), this.element = e, this.data.processor = new of, this.model.document.createRoot(), this.ui = new af(this, new Rf(this.locale, e)), On(this)
            }

            destroy() {
                const e = this.getData();
                return this.ui.destroy(), super.destroy().then(() = > Sn(this.element, e)
            )
            }

            static create(e, t) {
                return new Promise((o) = > {const n = new this(e, t);
                o(n.initPlugins().then(() = > {n.ui.init(), n.fire('uiReady')
            }).
                then(() = > n.data.init(pi(e))
            ).
                then(() = > {n.fire('dataReady'), n.fire('ready')
            }).
                then(() = > n
            ))
            })
        ...
        class Ff {
            constructor(e) {
                this.files = gi(e), this._native = e
            }
        ...
        class Nf extends ku {
            ...
            onDomEvent(e) {
                const t = {dataTransfer: new Ff(e.clipboardData ? e.clipboardData : e.dataTransfer)};
                'drop' == e.type && (t.dropRange = fi(this.view, e)), this.fire(e.type, e, t)
            }
        }
        const Mf = ['figcaption', 'li'];
        class Df extends Vf {
            ...
            init() {
                ...
                this._htmlDataProcessor = new of, n.addObserver(Nf), this.listenTo(i, 'clipboardInput', (e, o) = > {if(t.isReadOnly
            )
                return;
                const i = o.dataTransfer;
                let r = '';
                i.getData('text/html') ? r = bi(i.getData('text/html')) : i.getData('text/plain') && (r = hi(i.getData('text/plain'))), r = this._htmlDataProcessor.toView(r), this.fire('inputTransformation', {content: r}), n.scrollToTheSelection()
            },
                {
                    priority:'low'
                }
                ...
                this.listenTo(i, 'copy', e, {priority: 'low'}), this.listenTo(i, 'cut', (o, n) = > {t.isReadOnly ? n.preventDefault() : e(o, n)
            },
                {
                    priority:'low'
                }
            ),
                this.listenTo(i, 'clipboardOutput', (e, n) = > {n.content.isEmpty || (n.dataTransfer.setData('text/html', this._htmlDataProcessor.toData(n.content)), n.dataTransfer.setData('text/plain', ki(n.content))), 'cut' == n.method && t.model.deleteContent(o.selection)
            },
                {
                    priority:'low'
                }
        ...
        class Bf {
            constructor(e) {
                ...
                this.editor = e, this.set('value', void 0), this.set('isEnabled', !1), this.decorate('execute'), this.listenTo(this.editor.model.document, 'change', () = > {this.refresh()
            }),
                ...
                this.listenTo(e, 'change:isReadOnly', (e, o, n) = > {n? (this.on('change:isEnabled', t, {priority: 'lowest'}), this.isEnabled = !1) : (this.off('change:isEnabled', t), this.refresh())}
            )
            }
        ...
        class Lf extends Bf {
            execute() {
                ...
                e.change((o) = > {_i(this.editor.model, o, t.selection, e.schema
            ),
        ...
        class zf extends Qc {
            constructor(e) {
                super(e);
                const t = this.document;
                t.on('keydown', (e, o) = > {if(this.isEnabled && o.keyCode == Fc.enter
            )
                {
                    let n;
                    t.once('enter', (e) = > n = e, {priority: 'highest'}
                ),
                    t.fire('enter', new bu(t, o.domEvent)), n && n.stop.called && e.stop()
                }
            })
            }
        ...
        class jf extends Vf {
            ...
            init() {
                ...
                t.addObserver(zf), e.commands.add('enter', new Lf(e)), this.listenTo(o, 'enter', (o, n) = > {e.execute('enter'), n.preventDefault(), t.scrollToTheSelection()
            },
                {
                    priority:'low'
                }
        ...
        class qf {
            ...
            get batch() {
                return this._batch || (this._batch = new Ng), this._batch
            }
        ...
        class Wf extends Bf {
            constructor(e, t) {
                super(e), this._buffer = new qf(e.model, t)
            }
            ...
            execute(e = {}) {
                ...
                t.enqueueChange(this._buffer.batch, (e) = > {const t = r.isCollapsed;
        ...
        class Uf extends Vf {
            ...
            init() {
                const e = this.editor, t = e.editing.view, o = new Wf(e, e.config.get('typing.undoStep') || 20);
                e.commands.add('input', o), this.listenTo(t.document, 'keydown', (e, t) = > {this._handleKeydown(t, o)
            },
                {
                    priority:'lowest'
                }
            ),
                this.listenTo(t.document, 'mutations', (e, t, o) = > {this._handleMutations(t, o)
            })
            }

            _handleKeydown(e, t) {
                const o = this.editor.model, n = o.document, i = t.buffer;
                !t.isEnabled || yi(e) || n.selection.isCollapsed || (i.lock(), o.enqueueChange(i.batch, () = > {this.editor.model.deleteContent(n.selection)
            }),
                i.unlock()
            )
            }
        ...
        class Hf {
            ...
            handle(e, t) {
                if (Ti(e)) this._handleContainerChildrenMutations(e, t); else for (const o of e)this._handleTextMutation(o, t), this._handleTextNodeInsertion(o)
            }

            _handleContainerChildrenMutations(e, t) {
                const o = Ai(e);
                if (!o)return;
                const n = this.editor.editing.view.domConverter, i = n.mapViewToDom(o), r = new Kc,
                ...
                join('').replace(/\u00A0/g, ' '), u = d.map((e) = > e.data
            ).
                join('');
                if (u === c)return;
                const m = Te(u, c), {firstChangeAt: p, insertions: g, deletions: f} = Ei(m);
                let h = null;
                t && (h = this.editing.mapper.toModelRange(t.getFirstRange()));
                const b = c.substr(p, g), k = Uu.createFromParentsAndOffsets(s, p, s, p + f);
            ...
            _handleTextMutation(e, t) {
                ...
                const o = e.newText.replace(/\u00A0/g, ' '), n = e.oldText.replace(/\u00A0/g, ' '),
                    i = Te(n, o), {firstChangeAt: r, insertions: a, deletions: s} = Ei(i);
                let l = null;
                t && (l = this.editing.mapper.toModelRange(t.getFirstRange()));
                const d = new wc(e.node, r), c = this.editing.mapper.toModelPosition(d),
                    u = Uu.createFromPositionAndShift(c, s), m = o.substr(r, a);
                this.editor.execute('input', {text: m, range: u, resultRange: l})
            }

            _handleTextNodeInsertion(e) {
                if ('children' == e.type) {
                    const t = Ci(e), o = new wc(e.node, t.index), n = this.editing.mapper.toModelPosition(o),
                        i = t.values[0].data;
                    this.editor.execute('input', {text: i.replace(/\u00A0/g, ' '), range: new Uu(n)})
                }
            }
        }
        const Kf = [te('arrowUp'), te('arrowRight'), te('arrowDown'), te('arrowLeft'), 9, 16, 17, 18, 20, 27, 33, 34, 35, 36, 229];
        for (let n = 112; 135 >= n; n++)Kf.push(n);
        class Gf extends Bf {
            constructor(e, t) {
                super(e), this.direction = t, this._buffer = new qf(e.model, e.config.get('typing.undoStep'))
            }

            execute(e = {}) {
                const t = this.editor.model, o = t.document;
                t.enqueueChange(this._buffer.batch, (n) = > {this._buffer.lock();
                const i = new $u(o.selection), r = i.isCollapsed;
                ...
                let a = 0;
                i.getFirstRange().getMinimalFlatRanges().forEach((e) = > {a += Y(e.getWalker({
                    singleCharacters: !0,
                    ignoreElementEnd: !0,
                    shallow: !0
                }))
            ...
            _replaceEntireContentWithParagraph(e) {
                const t = this.editor.model, o = t.document, n = o.selection, i = t.schema.getLimitElement(n),
                    r = new zu('paragraph');
                e.remove(Uu.createIn(i)), e.insert(r, i), e.setSelection(r, 0)
            }
        }
        class $f extends Qc {
            constructor(e) {
                ...
                const t = e.document;
                let o = 0;
                t.on('keyup', (e, t) = > {(t.keyCode == Fc.delete || t.keyCode == Fc.backspace) && (o = 0)
            }),
                t.on('keydown', (e, n) = > {const i = {};
                if (n.keyCode == Fc.delete) i.direction = 'forward', i.unit = 'character'; else if (n.keyCode == Fc.backspace) i.direction = 'backward', i.unit = 'codePoint'; else return;
                const r = Rc.isMac ? n.altKey : n.ctrlKey;
                i.unit = r ? 'word' : i.unit, i.sequence = ++o;
                let a;
                t.once('delete', (e) = > a = e, {priority: 'highest'}
            ),
                t.fire('delete', new bu(t, n.domEvent, i)), a && a.stop.called && e.stop()
            })
            }
        ...
        class Jf extends Vf {
            ...
            init() {
                const e = this.editor, t = e.editing.view, o = t.document;
                t.addObserver($f), e.commands.add('forwardDelete', new Gf(e, 'forward')), e.commands.add('delete', new Gf(e, 'backward')), this.listenTo(o, 'delete', (o, n) = > {e.execute('forward' == n.direction ? 'forwardDelete' : 'delete', {
                    unit: n.unit,
                    sequence: n.sequence
        ...
        class Yf extends Bf {
            ...
            _restoreSelection(e, t, o) {
                ...
                for (const n of e) {
                    const e = Si(n, o), t = e.find((e) = > e.start.root != i.graveyard
                )
                    ;
                    t && r.push(t)
                }
        ...
        class Xf extends Yf {
            execute(e = null) {
                ...
                this._stack.length - 1, o = this._stack.splice(t, 1)[0], n = new Ng;
                this.editor.model.enqueueChange(n, () = > {this._undo(o.batch, n);
        ...
        class Zf extends Yf {
            execute() {
                const e = this._stack.pop(), t = new Ng;
        ...
        class eh extends Vf {
            ...
            init() {
                const e = this.editor;
                this._undoCommand = new Xf(e), this._redoCommand = new Zf(e), e.commands.add('undo', this._undoCommand), e.commands.add('redo', this._redoCommand), this.listenTo(e.model, 'applyOperation', (e, t) = > {const o = t[0];
                ...
                this.listenTo(this._undoCommand, 'revert', (e, t, o) = > {this._redoCommand.addBatch(o)
            }),
                e.keystrokes.set('CTRL+Z', 'undo'), e.keystrokes.set('CTRL+Y', 'redo'), e.keystrokes.set('CTRL+SHIFT+Z', 'redo')
            }
        }
        var th = o(20), oh = o.n(th);
        class nh extends ff {
            constructor() {
                super();
            ...
            render() {
                super.render(), this._updateXMLContent(), this._colorFillPaths(), this.on('change:content', () = > {this._updateXMLContent(), this._colorFillPaths()
            }),
            ...
            _colorFillPaths() {
                this.fillColor && this.element.querySelectorAll('.ck-icon__fill').forEach((e) = > {e.style.fill = this.fillColor
            })
            }
        }
        var ih = o(22), rh = o.n(ih);
        class ah extends ff {
            constructor(e) {
        ...
        var ch = o(26), uh = o.n(ch), mh = o(27), ph = o.n(mh);
        class gh extends Vf {
            init() {
                const e = this.editor, o = e.t;
                this._addButton('undo', o('ag'), 'CTRL+Z', uh.a), this._addButton('redo', o('ah'), 'CTRL+Y', ph.a)
            }

            _addButton(e, t, o, n) {
                const i = this.editor;
                i.ui.componentFactory.add(e, (r) = > {const a = i.commands.get(e), s=new dh(r);
                return s.set({
                    label: t,
                    icon: n,
                    keystroke: o,
                    tooltip: !0
                }), s.bind('isEnabled').to(a, 'isEnabled'), this.listenTo(s, 'execute', () = > i.execute(e)
            ),
                s
            })
            }
        ...
        class bh {
            ...
            read(e) {
                ...
                return this.total = e.size, new Promise((o, n) = > {t.onload = () =
            >
                {
                    o(t.result)
                }
        ...
        class kh extends Vf {
            ...
            init() {
                this.loaders = new Cc, this.set('uploaded', 0), this.set('uploadTotal', null), this.bind('uploadedPercent').to(this, 'uploaded', this, 'uploadTotal', (e, t) = > t ? 100 * (e / t) : 0
            )
            }
            ...
            createLoader(e) {
                if (!this.createUploadAdapter)return Eu.error('filerepository-no-upload-adapter: Upload adapter is not defined.'), null;
                const t = new _h(e);
                return t._adapter = this.createUploadAdapter(t), this.loaders.add(t), t.on('change:uploaded', () = > {let e = 0;
            ...
            destroyLoader(e) {
                const t = e instanceof _h ? e : this.getLoader(e);
        ...
        class _h {
            constructor(e, t) {
                this.id = i(), this.file = e, this._adapter = t, this._reader = new bh, this.set('status', 'idle'), this.set('uploaded', 0), this.set('uploadTotal', null), this.bind('uploadedPercent').to(this, 'uploaded', this, 'uploadTotal', (e, t) = > t ? 100 * (e / t) : 0
            ),
                this.set('uploadResponse', null)
            }

            read() {
                if ('idle' != this.status)throw new Qa('filerepository-read-wrong-status: You cannot call read if the status is different than idle.');
            ...
            upload() {
                if ('idle' != this.status)throw new Qa('filerepository-upload-wrong-status: You cannot call upload if the status is different than idle.');
        ...
        f(_h, gc);
        const wh = 'ckCsrfToken', vh = 40, yh = 'abcdefghijklmnopqrstuvwxyz0123456789';
        class xh extends Vf {
            static get requires() {
                return [kh]
            }
            ...
            init() {
                ...
                e && (this.editor.plugins.get(kh).createUploadAdapter = (t) = > new Ch(t, e, this.editor.t)
            )
            }
        }
        class Ch {
            ...
            _initListeners(e, o) {
                ...
                n.addEventListener('error', () = > o(t)
            ),
                n.addEventListener('abort', () = > o()
            ),
                n.addEventListener('load', () = > {const i = n.response;
                return i && i.uploaded ? void e({default: i.url}) : o(i && i.error && i.error.message ? i.error.message : t)
            }),
                n.upload && n.upload.addEventListener('progress', (e) = > {e.lengthComputable && (i.uploadTotal = e.total, i.uploaded = e.loaded)
            })
            }

            _sendRequest() {
                const e = new FormData;
                e.append('upload', this.loader.file), e.append('ckCsrfToken', Ri()), this.xhr.send(e)
            }
        }
        class Ah {
            constructor(e, t, o) {
                ...
                e.model.document.on('change', (o, i) = > {if('transparent' == i.type
            )
                return;
                ...
                l && e.model.enqueueChange((e) = > {const t = Uu.createFromParentsAndOffsets(s.parent, 0, s.parent, l[0].length);
        ...
        class Th {
            constructor(e, t, o) {
                let n, i, r, a;
                t instanceof RegExp ? n = t : r = t, 'string' == typeof o ? i = o : a = o, r = r || ((e) = > {let t;
                const o = [], i = [];
                ...
                a = a || ((e, t) = > {for(const o of t
            )
                e.setAttribute(i, !0, o);
                e.removeSelectionAttribute(i)
            }),
                e.model.document.on('change', (t, o) = > {if('transparent' == o.type
            )
                return;
                ...
                const d = n.focus.parent, c = Ni(d).slice(0, n.focus.offset), u = r(c), m = Mi(d, u.format),
                    p = Mi(d, u.remove);
                m.length && p.length && e.model.enqueueChange((t) = > {const o = e.model.schema.getValidRanges(m, i);
                a(t, o);
        ...
        class Ph extends Vf {
            ...
            _addListAutoformats() {
                ...
                e.get('bulletedList') && new Ah(this.editor, /^[*-]\s$/, 'bulletedList'), e.get('numberedList') && new Ah(this.editor, /^\d+[.|)]\s$/, 'numberedList')
            }

            _addBasicStylesAutoformats() {
                const e = this.editor.commands;
                e.get('bold') && (new Th(this.editor, /(\*\*)([^*]+)(\*\*)$/g, 'bold'), new Th(this.editor, /(__)([^_]+)(__)$/g, 'bold')), e.get('italic') && (new Th(this.editor, /(?:^|[^*])(\*)([^*_]+)(\*)$/g, 'italic'), new Th(this.editor, /(?:^|[^_])(_)([^_]+)(_)$/g, 'italic')), e.get('code') && new Th(this.editor, /(`)([^`]+)(`)$/g, 'code')
            }

            _addHeadingAutoformats() {
                const e = this.editor.commands.get('heading');
                e && e.modelElements.filter((e) = > e.match(/^heading[1-6]$/)
            ).
                forEach((e) = > {const t = e[7], o=new RegExp(`^(#{${t}})\\s$`);
                new Ah(this.editor, o, () = > {this.editor.execute('heading', {value: e})
            })
            })
            }

            _addBlockQuoteAutoformats() {
                this.editor.commands.get('blockQuote') && new Ah(this.editor, /^>\s$/, 'blockQuote')
            }
        }
        class Eh extends Bf {
            constructor(e, t) {
            ...
            execute(e = {}) {
                ...
                t.change((e) = > {if(n.isCollapsed
            )
                i ? e.setSelectionAttribute(this.attributeKey, !0) : e.removeSelectionAttribute(this.attributeKey);
            else
                {
        ...
        class Oh extends Vf {
            init() {
                const e = this.editor;
                e.model.schema.extend('$text', {allowAttributes: Sh}), e.conversion.attributeToElement({
                    model: Sh,
                    view: 'strong',
                    upcastAlso: ['b', {styles: {"font-weight": 'bold'}}]
                }), e.commands.add(Sh, new Eh(e, Sh)), e.keystrokes.set('CTRL+B', Sh)
            }
        }
        var Rh = o(28), Ih = o.n(Rh);
        const Vh = 'bold';
        class Fh extends Vf {
            init() {
                const e = this.editor, o = e.t;
                e.ui.componentFactory.add(Vh, (t) = > {const n = e.commands.get(Vh), i=new dh(t);
                return i.set({
                    label: o('b'),
                    icon: Ih.a,
                    keystroke: 'CTRL+B',
                    tooltip: !0
                }), i.bind('isOn', 'isEnabled').to(n, 'value', 'isEnabled'), this.listenTo(i, 'execute', () = > e.execute(Vh)
            ),
                i
            })
            }
        ...
        class Dh extends Vf {
            init() {
                ...
                }), e.commands.add(Mh, new Eh(e, Mh)), e.keystrokes.set('CTRL+I', Mh)
            }
        }
        var Bh = o(29), Lh = o.n(Bh);
        const zh = 'italic';
        class jh extends Vf {
            init() {
                const e = this.editor, o = e.t;
                e.ui.componentFactory.add(zh, (t) = > {const n = e.commands.get(zh), i=new dh(t);
                return i.set({
                    label: o('c'),
                    icon: Lh.a,
                    keystroke: 'CTRL+I',
                    tooltip: !0
                }), i.bind('isOn', 'isEnabled').to(n, 'value', 'isEnabled'), this.listenTo(i, 'execute', () = > e.execute(zh)
            ),
                i
            })
            }
        ...
        class Wh extends Bf {
            ...
            execute() {
                ...
                e.change((e) = > {if(this.value
            )
                this._removeQuote(e, n.filter(Bi));
            else
                {
                    const t = n.filter((e) = > Bi(e) || zi(o, e)
                )
                    ;
            ...
            _getValue() {
                const e = Di(this.editor.model.document.selection.getSelectedBlocks());
                return !!(e && Bi(e))
            }
            ...
            _checkEnabled() {
                ...
                const e = this.editor.model.document.selection, t = this.editor.model.schema,
                    o = Di(e.getSelectedBlocks());
                return !!o && zi(t, o)
            }

            _removeQuote(e, t) {
                Li(t).reverse().forEach((t) = > {if(t.start.isAtStart && t.end.isAtEnd
            )
                return void e.unwrap(t.start.parent);
                if (t.start.isAtStart) {
                    const o = Wu.createBefore(t.start.parent);
                    return void e.move(t, o)
                }
                t.end.isAtEnd || e.split(t.end);
                const o = Wu.createAfter(t.end.parent);
                e.move(t, o)
            })
            }
            ...
            _applyQuote(e, t) {
                const o = [];
                Li(t).reverse().forEach((t) = > {let n = Bi(t.start);
                n || (n = new zu('blockQuote'), e.wrap(t, n)), o.push(n)
            }),
                o.reverse().reduce((t, o) = > t.nextSibling == o ? (e.merge(Wu.createAfter(t)), t) : o
            )
            }
        }
        class Uh extends Vf {
            init() {
                ...
                e.commands.add('blockQuote', new Wh(e)), t.register('blockQuote', {
                    allowWhere: '$block',
                    allowContentOf: '$root'
                }), t.addChildCheck((e, t) = > {if(e.endsWith('blockQuote') && 'blockQuote' == t.name
            )
                return !1
            }),
        ...
        var Hh = o(30), Kh = o.n(Hh), Gh = o(31), $h = o.n(Gh);
        class Jh extends Vf {
            init() {
                const e = this.editor, o = e.t;
                e.ui.componentFactory.add('blockQuote', (t) = > {const n = e.commands.get('blockQuote'), i=new dh(t);
                return i.set({
                    label: o('d'),
                    icon: Kh.a,
                    tooltip: !0
                }), i.bind('isOn', 'isEnabled').to(n, 'value', 'isEnabled'), this.listenTo(i, 'execute', () = > e.execute('blockQuote')
            ),
                i
            })
            }
        ...
        class Xh {
            constructor(e, t, o) {
                ...
                this.file = qi(e) ? ji(e) : e, this._token = t, this._apiAddress = o
            }

            onProgress(e) {
                return this.on('progress', (t, o) = > e(o)
            ),
                this
            }

            onError(e) {
                return this.once('error', (t, o) = > e(o)
            ),
                this
            }
            ...
            _attachXHRListeners() {
                ...
                o.addEventListener('error', e('Network Error')), o.addEventListener('abort', e('Abort')), o.upload && o.upload.addEventListener('progress', (e) = > {e.lengthComputable && this.fire('progress', {
                    total: e.total,
                    uploaded: e.loaded
                })
            }),
                o.addEventListener('load', () = > {const e = o.status, t=o.response;
            ...
            _sendRequest() {
                ...
                return e.append('file', this.file), new Promise((o, n) = > {t.addEventListener('load', () = > {
                    const e = t.status,
                    i=t.response;
                return 200 > e || 299 < e ? n(i.message || i.error) : o(i)
            }),
                t.addEventListener('error', () = > n('Network Error')
            ),
        ...
        f(Xh, is);
        const Zh = {refreshInterval: 36e5, autoRefresh: !0};
        class eb {
            constructor(e, t = Zh) {
                if (!e)throw new Error('`tokenUrl` must be provided');
                this.set('value', t.initValue), this._tokenUrl = e, this._options = Object.assign({}, Zh, t)
            }
            ...
            _refreshToken() {
                return new Promise((e, t) = > {const o = new XMLHttpRequest;
                o.open('GET', this._tokenUrl), o.addEventListener('load', () = > {const n = o.status, i=o.response;
                return 200 > n || 299 < n ? t('Cannot download new token!') : (this.set('value', i), e(this))
            }),
                o.addEventListener('error', () = > t('Network Error')
            ),
                o.addEventListener('abort', () = > t('Abort')
            ),
                o.send()
            })
            }
        ...
        class tb extends Vf {
            init() {
                ...
                return this.tokenUrl ? (this.token = new tb.Token(this.tokenUrl), this.token.init()) : void(this.token = null)
            }
        }
        tb.Token = eb;
        class ob extends Vf {
            ...
            init() {
                const e = this.editor, t = e.plugins.get(tb), o = t.token, n = t.uploadUrl;
                o && (this._uploadGateway = new ob._UploadGateway(o, n), e.plugins.get(kh).createUploadAdapter = (e) = > new nb(this._uploadGateway, e)
            )
            }
        }
        class nb {
        ...
        ob._UploadGateway = class {
            ...
            upload(e) {
                return new Xh(e, this._token, this._apiAddress)
            }
        };
        class ib {
            constructor() {
            ...
            add(e, t) {
                ...
                const i = o[0];
                n === i || Ki(n, i) || this.fire('change:top', {oldDescriptor: n, newDescriptor: i, writer: t})
            }
        ...
        f(ib, is);
        const rb = Symbol('isWidget'), ab = Symbol('label'), sb = 'ck-widget', lb = 'ck-widget_selected',
            db = Symbol('isImage');
        class cb extends Vf {
            init() {
                ...
                }), t.for('dataDowncast').add(ht({model: 'image', view: (e, t) = > ar(t)
            })),
                t.for('editingDowncast').add(ht({model: 'image', view: (e, t) = > or(ar(t), t, n('g'))
            })),
                t.for('downcast').add(Hi('src')).add(Hi('alt')).add(Ui()), t.for('upcast').add(Yt({
                        view: {
                            name: 'img',
                            attributes: {src: !0}
                ...
                add(Zt({view: {name: 'img', key: 'alt'}, model: 'alt'})).add(Zt({
                    ...
                    model: {key: 'srcset', value: (e) = > {const t = {data: e.getAttribute('srcset')};
        ...
        class fb extends Vf {
            ...
            init() {
                ...
                this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on('selection', (e, t, o) = > {this._clearPreviouslySelectedWidgets(o.writer);
                const n = o.writer, i = n.document.selection, r = i.getSelectedElement();
                for (const a of i.getRanges())for (const e of a) {
                    const t = e.item;
                    t.is('element') && Ji(t) && (n.addClass(lb, t), this._previouslySelected.add(t), t == r && n.setSelection(i.getRanges(), {
                        fake: !0,
                        label: Zi(r)
                    }))
                }
                ...
                e.addObserver(ub), this.listenTo(t, 'mousedown', (...e) =
            >
                this._onMousedown(...e
            )),
                this.listenTo(t, 'keydown', (...e) =
            >
                this._onKeydown(...e
            ),
                {
                ...
                this.listenTo(t, 'delete', (e, t) = > {this._handleDelete('forward' == t.direction) && (t.preventDefault(), e.stop())
            },
                {
                    priority:'high'
                }
            ...
            _onMousedown(e, t) {
                ...
                let r = t.target;
                if (!dr(r) && (Ji(r) || (r = r.findAncestor(Ji), !!r))) {
            ...
            _onKeydown(e, t) {
                const o = t.keyCode, n = o == Fc.delete || o == Fc.arrowdown || o == Fc.arrowright;
                let i = !1;
                sr(o) ? i = this._handleArrowKeys(n) : lr(t) && (i = this._selectAllNestedEditableContent() || this._selectAllContent()), i && (t.preventDefault(), e.stop())
            }
            ...
            _handleDelete(e) {
                ...
                if (n)return this.editor.model.change((e) = > {for(let t=o.anchor.parent;
                t.isEmpty;
            )
                {
                    const o = t;
            ...
            _handleArrowKeys(e) {
                ...
                if (r && o.isObject(r)) {
                    ...
                    return r && t.change((e) = > {e.setSelection(r)
                }),
                    !0
                }
                if (i.isCollapsed) {
                    const t = this._getObjectElementNextToSelection(e);
                    if (t instanceof zu && o.isObject(t))return this._setSelectionOverElement(t), !0
                }
            }

            _selectAllNestedEditableContent() {
                const e = this.editor.model, t = e.document.selection, o = e.schema.getLimitElement(t);
                return t.getFirstRange().root != o && (e.change((e) = > {e.setSelection(Uu.createIn(o))
            }),
                !0
            )
            }
            ...
            _selectAllContent() {
                ...
                if (r && Ji(r)) {
                    ...
                    return e.change((e) = > {e.setSelection(Uu.createIn(o))
                }),
                    !0
                }
                return !1
            ...
            _setSelectionOverElement(e) {
                this.editor.model.change((t) = > {t.setSelection(Uu.createOn(e))
            })
            }

            _getObjectElementNextToSelection(e) {
                const t = this.editor.model, o = t.schema, n = t.document.selection, i = new $u(n);
                t.modifySelection(i, {direction: e ? 'forward' : 'backward'});
                const r = e ? i.focus.nodeBefore : i.focus.nodeAfter;
                return r instanceof zu && o.isObject(r) ? r : null
            }

            _clearPreviouslySelectedWidgets(e) {
                for (const t of this._previouslySelected)e.removeClass(lb, t);
        ...
        class hb extends Bf {
            refresh() {
                ...
                this.isEnabled = rr(e), this.value = !!(rr(e) && e.hasAttribute('alt')) && e.getAttribute('alt')
            }

            execute(e) {
                const t = this.editor.model, o = t.document.selection.getSelectedElement();
                t.change((t) = > {t.setAttribute('alt', e.newValue, o)
            })
            }
        }
        class bb extends Vf {
            init() {
                this.editor.commands.add('imageTextAlternative', new hb(this.editor))
            }
        }
        var kb = o(35), _b = o.n(kb);
        class wb extends ff {
            constructor(e) {
        ...
        class Cb extends ff {
            ...
            >
                ...
                ;
                e(this.value), this.on('change:value', (t, o, n) = > {e(n)}
            )
            }
        ...
        var Ab = o(3), Tb = o.n(Ab), Pb = o(4), Eb = o.n(Pb), Sb = o(39), Ob = o.n(Sb);
        class Rb extends ff {
            constructor(e) {
                super(e);
                const o = this.locale.t;
                this.focusTracker = new rf, this.keystrokes = new Qg, this.labeledInput = this._createLabeledInputView(), this.saveButtonView = this._createButton(o('ab'), Tb.a, 'ck-button-save'), this.saveButtonView.type = 'submit', this.cancelButtonView = this._createButton(o('ac'), Eb.a, 'ck-button-cancel', 'cancel'), this._focusables = new sf, this._focusCycler = new Tf({
            ...
            render() {
                super.render(), this.keystrokes.listenTo(this.element), ur({view: this}), [this.labeledInput, this.saveButtonView, this.cancelButtonView].forEach((e) = > {this._focusables.add(e), this.focusTracker.add(e.element)
            })
            }

            _createButton(e, t, o, n) {
                const i = new dh(this.locale);
                return i.set({
                    label: e,
                    icon: t,
                    tooltip: !0
            ...
            _createLabeledInputView() {
                const e = this.locale.t, t = new vb(this.locale, Cb);
                return t.label = e('af'), t.inputView.placeholder = e('af'), t
            }
        }
        class Ib extends Vf {
            static get pluginName() {
            ...
            init() {
                this.view = new Af, this.positionLimiter = () =
            >
                {
            ...
            add(e) {
                if (this.hasView(e.view))throw new Qa('contextualballoon-add-view-exist: Cannot add configuration of the same view twice.');
                this.visibleView && this.view.content.remove(this.visibleView), this._stack.set(e.view, e), this._show(e)
            }

            remove(e) {
                if (!this.hasView(e))throw new Qa('contextualballoon-remove-view-not-exist: Cannot remove configuration of not existing view.');
        ...
        class Nb extends Vf {
            ...
            _createButton() {
                ...
                return i.set({
                    ...
                    icon: Fb.a,
                    tooltip: !0
                }), i.bind('isEnabled').to(n, 'isEnabled'), this.listenTo(i, 'execute', () = > this._showForm()
            ),
                i
            })
            }
            ...
            _createForm() {
                const e = this.editor, t = e.editing.view, o = t.document;
                this._balloon = this.editor.plugins.get('ContextualBalloon'), this._form = new Rb(e.locale), this._form.render(), this.listenTo(this._form, 'submit', () = > {e.execute('imageTextAlternative', {newValue: this._form.labeledInput.inputView.element.value}), this._hideForm(!0)
            }),
                this.listenTo(this._form, 'cancel', () = > {this._hideForm(!0)
            }),
                this._form.keystrokes.set('Esc', (e, t) = > {this._hideForm(!0), t()
            }),
                this.listenTo(t, 'render', () = > {ir(o.selection
            )
                    ? this._isVisible && mr(e) : this._hideForm(!0)
            }),
                cr({emitter: this._form, activator: () = > this._isVisible, contextElements
            :
        ...
        class zb extends ff {
            constructor(e) {
                super(e), this.buttonView = new dh(e), this._fileInputView = new jb(e), this._fileInputView.bind('acceptedType').to(this), this._fileInputView.bind('allowMultipleFiles').to(this), this._fileInputView.delegate('done').to(this), this.setTemplate({
                    tag: 'span',
        ...
        var qb = o(44), Wb = o.n(qb);
        class Ub extends Vf {
            init() {
                const e = this.editor, o = e.t;
                e.ui.componentFactory.add('imageUpload', (t) = > {const n = new zb(t), i=e.commands.get('imageUpload');
                return n.set({acceptedType: 'image/*', allowMultipleFiles: !0}), n.buttonView.set({
                    label: o('n'),
                    icon: Wb.a,
                    tooltip: !0
                }), n.buttonView.bind('isEnabled').to(i), n.on('done', (t, o) = > {for(const n of Array.from(o)
            )
                {
                    const t = fr(e.model.document.selection);
                    gr(n) && e.execute('imageUpload', {file: n, insertAt: t})
                }
            }),
                n
            })
        ...
        var Hb = o(45), Kb = o.n(Hb), Gb = o(46), $b = o.n(Gb);
        class Jb extends Vf {
            constructor(e) {
                super(e), this.placeholder = 'data:image/svg+xml;utf8,' + encodeURIComponent(Kb.a)
            }

            init() {
                const e = this.editor;
                e.editing.downcastDispatcher.on('attribute:uploadStatus:image', (...e) =
            >
            ...
            uploadStatusChange(e, t, o) {
                ...
                if (o.consumable.consume(t.item, e.name)) {
                    const e = n.plugins.get(kh), a = r ? t.attributeNewValue : null, s = this.placeholder,
                        l = n.editing.mapper.toViewElement(i), d = o.writer;
                    if ('reading' == a)return hr(l, d), void kr(s, l, d);
                    if ('uploading' == a) {
                        const t = e.loaders.get(r);
                        return hr(l, d), void(t ? (_r(l, d), wr(l, d, t, n.editing.view)) : kr(s, l, d))
                    }
                    vr(l, d), _r(l, d), br(l, d)
                }
            }
        }
        const Qb = Symbol('progress-bar');
        class Yb extends Bf {
            execute(e) {
                const t = this.editor, o = t.model.document, n = e.file, i = t.plugins.get(kh);
                t.model.change((r) = > {const a = i.createLoader(n);
                if (!a)return;
                const s = new zu('image', {uploadId: a.id});
                let l;
                l = e.insertAt ? new $u([new Uu(e.insertAt)]) : o.selection, t.model.insertContent(s, l), s.parent && r.setSelection(Uu.createOn(s))
            })
            }
        }
        class Xb extends Vf {
        ...
        class Zb extends Vf {
            ...
            init() {
                const e = this.editor, t = e.model.document, o = e.model.schema, n = e.plugins.get(kh);
                o.extend('image', {allowAttributes: ['uploadId', 'uploadStatus']}), e.commands.add('imageUpload', new Yb(e)), e.editing.view.document.on('clipboardInput', (o, n) = > {if(Cr(n.dataTransfer)
            )
                return;
                let i = new $u(n.targetRanges.map((t) = > e.editing.mapper.toModelRange(t))
            )
                ;
                for (const r of n.dataTransfer.files) {
                    const n = fr(i);
                    gr(r) && (e.execute('imageUpload', {file: r, insertAt: n}), o.stop()), i = t.selection
                }
            }),
                e.editing.view.document.on('dragover', (e, t) = > {t.preventDefault()
            }),
                t.on('change', () = > {const e = t.differ.getChanges({includeChangesInGraveyard: !0});
            ...
            _load(e, o) {
                function n() {
                    r.enqueueChange('transparent', (e) = > {e.removeAttribute('uploadId', o), e.removeAttribute('uploadStatus', o)
                }),
                    t.destroyLoader(e)
                }

                const i = this.editor, r = i.model, a = i.locale.t, t = i.plugins.get(kh), s = i.plugins.get(Xb);
                return r.enqueueChange('transparent', (e) = > {e.setAttribute('uploadStatus', 'reading', o)
            }),
                e.read().then((t) = > {const n = i.editing.mapper.toViewElement(o), a=n.getChild(0), s=e.upload();
                return i.editing.view.change((e) = > {e.setAttribute('src', t, a)
            }),
                r.enqueueChange('transparent', (e) = > {e.setAttribute('uploadStatus', 'uploading', o)
            }),
                s
            }).
                then((e) = > {r.enqueueChange('transparent', (t) = > {t.setAttributes({
                    uploadStatus: 'complete',
                    src: e.default
                }, o);
                let n = 0;
                const i = Object.keys(e).filter((e) = > {const t = parseInt(e, 10);
                if (!isNaN(t))return n = Na(n, t), !0
            }).
                map((t) = > `${e[t]} ${t}w`
            ).
                join(', ');
                ...
                catch((t) = > {if('error' !== e.status && 'aborted' !== e.status
            )
                throw t;
                'error' == e.status && s.showWarning(t, {
                    title: a('o'),
                    namespace: 'upload'
                }), n(), r.enqueueChange('transparent', (e) = > {e.remove(o)
            })
            })
            }
        }
        ...
        class ok extends Bf {
            refresh() {
                const e = this.editor.model, t = e.document, o = Di(t.selection.getSelectedBlocks());
                this.value = !!o && o.is('paragraph'), this.isEnabled = !!o && Ar(o, e.schema)
            }

            execute(e = {}) {
                const t = this.editor.model, o = t.document;
                t.change((n) = > {const i = (e.selection || o.selection).getSelectedBlocks();
                for (const e of i)!e.is('paragraph') && Ar(e, t.schema) && n.rename(e, 'paragraph')
            })
            }
        }
        class nk extends Vf {
            ...
            init() {
                ...
                e.commands.add('paragraph', new ok(e)), t.schema.register('paragraph', {inheritAllFrom: '$block'}), e.conversion.elementToElement({
                    model: 'paragraph',
                    view: 'p'
                }), o.upcastDispatcher.on('element', (e, t, o) = > {if(o.consumable.test(t.viewItem, {name: t.viewItem.name})
            )
                if (nk.paragraphLikeElements.has(t.viewItem.name)) {
                    ...
                    const {modelRange: i} = o.convertChildren(t.viewItem, Wu.createAt(e));
                    t.modelRange = new Uu(Wu.createBefore(e), i.end), t.modelCursor = t.modelRange.end
                } else Pr(t.viewItem, t.modelCursor, o.schema) && (t = Object.assign(t, Tr(t.viewItem, t.modelCursor, o)))
            },
                {
                    priority:'low'
                }
            ),
                o.upcastDispatcher.on('text', (e, t, o) = > {t.modelRange || Pr(t.viewItem, t.modelCursor, o.schema) && (t = Object.assign(t, Tr(t.viewItem, t.modelCursor, o)))
            },
                {
                    priority:'lowest'
                }
            ),
                t.document.registerPostFixer((e) = > this._autoparagraphEmptyRoots(e)
            ),
                e.on('dataReady', () = > {t.enqueueChange('transparent', (e) = > this._autoparagraphEmptyRoots(e)
            )
            },
                {
                    priority:'lowest'
        ...
        nk.paragraphLikeElements = new Set(['blockquote', 'dd', 'div', 'dt', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'li', 'p', 'td']);
        class ik extends Bf {
            constructor(e, t) {
            ...
            refresh() {
                const e = Di(this.editor.model.document.selection.getSelectedBlocks());
                this.value = !!e && this.modelElements.includes(e.name) && e.name, this.isEnabled = !!e && this.modelElements.some((t) = > Er(e, t, this.editor.model.schema)
            )
            }

            execute(e) {
                const t = this.editor.model, o = t.document, n = e.value;
                t.change((e) = > {const i = Array.from(o.selection.getSelectedBlocks()).filter((e) = > Er(e, n, t.schema)
            )
                ;
        ...
        class ak extends Vf {
            ...
            init() {
                ...
                for (const n of t)n.model !== rk && (e.model.schema.register(n.model, {inheritAllFrom: '$block'}), e.conversion.elementToElement(n), o.push(n.model));
                e.commands.add('heading', new ik(e, o))
            }
            ...
            afterInit() {
                ...
                ;
                r && !i.is(rk) && 0 === i.childCount && n.writer.rename(i, rk)
            })
            }
        }
        class sk {
            constructor(e, t) {
                t && dc(this, t), e && this.set(e)
            }
        }
        f(sk, gc);
        class lk extends ff {
        ...
        var dk = o(48), ck = o.n(dk);
        class uk extends ff {
            constructor(e, t, o) {
                super(e);
                const n = this.bindTemplate;
                this.buttonView = t, this.panelView = o, this.set('isOpen', !1), this.set('isEnabled', !0), this.focusTracker = new rf, this.keystrokes = new Qg, this.setTemplate({
                    tag: 'div',
            ...
            render() {
                super.render(), this.listenTo(this.buttonView, 'open', () = > {this.isOpen = !this.isOpen
            }),
        ...
        class gk extends dh {
            ...
            _createArrowView() {
                const e = new nh;
                return e.content = pk.a, e.extendTemplate({attributes: {class: 'ck-dropdown__arrow'}}), e
            }
        }
        var fk = o(51), hk = o.n(fk);
        class bk extends ff {
            constructor() {
                super(), this.items = this.createCollection(), this.focusTracker = new rf, this.keystrokes = new Qg, this._focusCycler = new Tf({
                    focusables: this.items,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
        ...
        class kk extends ff {
            constructor() {
                super(), this.set('tabindex', -1), this.keystrokes = new Qg;
                const e = this.bindTemplate;
                this.setTemplate({
                    tag: 'li',
                    attributes: {
        ...
        var _k = o(53), wk = o.n(_k), vk = o(55), yk = o.n(vk), xk = o(5), Ck = o.n(xk);
        class Ak extends Vf {
            init() {
                const e = this.editor, o = e.t, t = Nr(e), n = o('e'), i = o('f');
                e.ui.componentFactory.add('heading', (o) = > {
                    ...
                    d=[s];
                for (const e of t) {
                    const t = new sk({label: e.title, class: e.class});
                ...
                const c = Sr(o);
                return Or(c, a), c.buttonView.set({
                    isOn: !1,
                    withText: !0,
                    tooltip: i
                }), c.extendTemplate({attributes: {class: ['ck-heading-dropdown']}}), c.bind('isEnabled').toMany(d, 'isEnabled', (...e) =
            >
                e.some((e) = > e
            )),
                c.buttonView.bind('label').to(s, 'value', l, 'value', (e, t) = > {const o = e || t && 'paragraph';
                return r[o] ? r[o] : n
            }),
                this.listenTo(c, 'execute', (t) = > {e.execute(t.source.commandName, t.source.commandValue ? {value: t.source.commandValue} : void 0), e.editing.view.focus()
            }),
                c
            })
            }
        ...
        var Pk = o(58), Ek = o.n(Pk);
        const Sk = new WeakMap, Ok = Symbol('imageCaption');
        class Rk extends Vf {
            init() {
                ...
                n.register('caption', {
                    ...
                    isLimit: !0
                }), e.model.document.registerPostFixer((e) = > this._insertMissingModelCaptionElement(e)
            ),
                e.conversion.for('upcast').add(Yt({view: jr, model: 'caption'}));
                i.downcastDispatcher.on('insert:caption', qr((e) = > e.createContainerElement('figcaption'), !1)
            )
                ;
                const t = Lr(o, a('m'));
                r.downcastDispatcher.on('insert:caption', qr(t)), r.downcastDispatcher.on('insert', this._fixCaptionVisibility((e) = > e.item), {priority: 'high'}
            ),
                r.downcastDispatcher.on('remove', this._fixCaptionVisibility((e) = > e.position.parent), {priority: 'high'}
            ),
            ...
            _updateCaptionVisibility(e) {
                ...
                const a = i.getFirstPosition(), s = Ur(a.parent);
                if (s && (n = t.toViewElement(s)), n)return o ? o === n ? Kr(n, e) : (Hr(o, e), this._lastSelectedCaption = n, Kr(n, e)) : (this._lastSelectedCaption = n, Kr(n, e));
                if (o) {
                    const t = Hr(o, e);
            ...
            >
                {
                    const i = e(o), r = Ur(i), a = this.editor.editing.mapper, s = n.writer;
                    if (r) {
            ...
            _insertMissingModelCaptionElement(e) {
                ...
                for (const t of o)if ('insert' == t.type && 'image' == t.name) {
                    ...
                    if (!zr(o))return e.appendElement('caption', o), !0
                }
            }
        }
        var Ik = o(60), Vk = o.n(Ik);
        class Fk extends Vf {
            static get requires() {
                return [Rk]
            }
        ...
        class Nk extends Bf {
            ...
            refresh() {
                const e = this.editor.model.document.selection.getSelectedElement();
                if (this.isEnabled = rr(e), !e) this.value = !1; else if (e.hasAttribute('imageStyle')) {
            ...
            execute(e) {
                ...
                o.change((e) = > {this.styles[t].isDefault ? e.removeAttribute('imageStyle', n) : e.setAttribute('imageStyle', t, n)
            })
            }
        }
        var Mk = o(62), Dk = o.n(Mk), Bk = o(63), Lk = o.n(Bk), zk = o(64), jk = o.n(zk), qk = o(65), Wk = o.n(qk);
        const Uk = {
            full: {name: 'full', title: 'Full size image', icon: Dk.a, isDefault: !0},
            side: {name: 'side', title: 'Side image', icon: Wk.a, className: 'image-style-side'},
            alignLeft: {
                name: 'alignLeft',
        ...
        }, Hk = {full: Dk.a, left: Lk.a, right: Wk.a, center: jk.a};
        class Kk extends Vf {
            static get requires() {
                return [cb]
            }
            ...
            init() {
                ...
                const i = Qr(e.config.get('image.styles'));
                t.extend('image', {allowAttributes: 'imageStyle'});
                const r = Gr(i);
                n.downcastDispatcher.on('attribute:imageStyle:image', r), o.downcastDispatcher.on('attribute:imageStyle:image', r), o.upcastDispatcher.on('element:figure', $r(i), {priority: 'low'}), e.commands.add('imageStyle', new Nk(e, i))
            }
        }
        var Gk = o(66), $k = o.n(Gk);
        class Jk extends Vf {
            get localizedDefaultStylesTitles() {
                ...
                return {
                    "Full size image": e('h'),
                    "Side image": e('i'),
                    "Left aligned image": e('j'),
                    "Centered image": e('k'),
                    "Right aligned image": e('l')
                }
            }

            init() {
                const e = this.editor, t = e.config.get('image.styles'),
                    o = Xr(Qr(t), this.localizedDefaultStylesTitles);
                for (const e of o)this._createButton(e)
            }

            _createButton(e) {
                const t = this.editor, o = `imageStyle:${e.name}`;
                t.ui.componentFactory.add(o, (o) = > {const n = t.commands.get('imageStyle'), i=new dh(o);
                return i.set({
                    label: e.title,
                    icon: e.icon,
                    tooltip: !0
                }), i.bind('isEnabled').to(n, 'isEnabled'), i.bind('isOn').to(n, 'value', (t) = > t === e.name
            ),
                this.listenTo(i, 'execute', () = > t.execute('imageStyle', {value: e.name})
            ),
                i
            })
            }
        ...
        class Yk extends Vf {
            ...
            init() {
                ...
                t && this.listenTo(t, 'show', (t) = > {ir(e.editing.view.document.selection
            )&&
                t.stop()
            },
                {
            ...
            afterInit() {
                ...
                t && t.length && (this._balloon = this.editor.plugins.get('ContextualBalloon'), this._toolbar = new Of, this._toolbar.fillFromConfig(t, e.ui.componentFactory), this.listenTo(e.editing.view, 'render', () = > {this._checkIsVisible()
            }),
            ...
            _checkIsVisible() {
                const e = this.editor;
                e.ui.focusTracker.isFocused ? ir(e.editing.view.document.selection) ? this._showToolbar() : this._hideToolbar() : this._hideToolbar()
            }

            _showToolbar() {
                const e = this.editor;
                this._isVisible ? mr(e) : !this._balloon.hasView(this._toolbar) && this._balloon.add({
                        view: this._toolbar,
                        position: pr(e),
        ...
        class Zk extends Bf {
            ...
            execute() {
                ...
                e.change((e) = > {const o = t.isCollapsed ? [Zr(t.getFirstPosition(), t.getAttribute('linkHref'))] : t.getRanges();
                for (const t of o)e.removeAttribute('linkHref', t)
            })
            }
        }
        const e_ = Symbol('linkElement');
        class t_ {
            constructor(e, t, o) {
                this.model = e, this.attribute = o, this._modelSelection = e.document.selection, this._overrideUid = null, this._isNextGravityRestorationSkipped = !1, t.listenTo(this._modelSelection, 'change:range', (e, t) = > this._isNextGravityRestorationSkipped ? void(this._isNextGravityRestorationSkipped = !1) : void(!this._isGravityOverridden || !t.directChange && ia(this._modelSelection.getFirstPosition(), o) || this._restoreGravity())
            )
            }

            handleForwardMovement(e, t) {
                const o = this.attribute;
                return this._isGravityOverridden || e.isAtStart && this._hasSelectionAttribute ? void 0 : sa(e, o) && this._hasSelectionAttribute ? (this._preventCaretMovement(t), this._removeSelectionAttribute(), !0) : ra(e, o) ? (this._preventCaretMovement(t), this._overrideGravity(), !0) : aa(e, o) && this._hasSelectionAttribute ? (this._preventCaretMovement(t), this._overrideGravity(), !0) : void 0
            }

            handleBackwardMovement(e, t) {
                const o = this.attribute;
                if (this._isGravityOverridden)return sa(e, o) && this._hasSelectionAttribute ? (this._preventCaretMovement(t), this._restoreGravity(), this._removeSelectionAttribute(), !0) : (this._preventCaretMovement(t), this._restoreGravity(), e.isAtStart && this._removeSelectionAttribute(), !0);
                return sa(e, o) && !this._hasSelectionAttribute ? (this._preventCaretMovement(t), this._setSelectionAttributeFromTheNodeBefore(e), !0) : e.isAtEnd && aa(e, o) ? this._hasSelectionAttribute ? void(la(e, o) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity())) : (this._preventCaretMovement(t), this._setSelectionAttributeFromTheNodeBefore(e), !0) : e.isAtStart ? this._hasSelectionAttribute ? (this._removeSelectionAttribute(), this._preventCaretMovement(t), !0) : void 0 : void(la(e, o) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity()))
            }
            ...
            _restoreGravity() {
                this.model.change((e) = > {e.restoreSelectionGravity(this._overrideUid), this._overrideUid = null
            })
            }
            ...
            _removeSelectionAttribute() {
                this.model.change((e) = > {e.removeSelectionAttribute(this.attribute)
            })
            }

            _setSelectionAttributeFromTheNodeBefore(e) {
                const t = this.attribute;
                this.model.change((o) = > {o.setSelectionAttribute(this.attribute, e.nodeBefore.getAttribute(t))
            })
            }
        ...
        var o_ = o(68), n_ = o.n(o_);
        const i_ = 'ck-link_selected';
        class r_ extends Vf {
            init() {
                const e = this.editor;
                ...
                e.commands.add('link', new Xk(e)), e.commands.add('unlink', new Zk(e)), na(e.editing.view, e.model, this, 'linkHref'), this._setupLinkHighlight()
            }

            _setupLinkHighlight() {
                const e = this.editor, t = e.editing.view, o = new Set;
                t.document.registerPostFixer((t) = > {const n = e.model.document.selection;
                if (n.hasAttribute('linkHref')) {
                    const i = Zr(n.getFirstPosition(), n.getAttribute('linkHref')), r = e.editing.mapper.toViewRange(i);
                    for (const e of r.getItems())e.is('a') && (t.addClass(i_, e), o.add(e))
                }
            }),
                e.conversion.for('editingDowncast').add((e) = > {function n()
                {
                    t.change((e) = > {for(const t of o.values()
                )
                    e.removeClass(i_, t), o.delete(t)
                })
                }
        ...
        var s_ = o(70), l_ = o.n(s_);
        class d_ extends ff {
            constructor(e) {
                super(e);
                const o = e.t;
                this.focusTracker = new rf, this.keystrokes = new Qg, this.urlInputView = this._createUrlInput(), this.saveButtonView = this._createButton(o('ab'), Tb.a, 'ck-button-save'), this.saveButtonView.type = 'submit', this.cancelButtonView = this._createButton(o('ac'), Eb.a, 'ck-button-cancel', 'cancel'), this._focusables = new sf, this._focusCycler = new Tf({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {focusPrevious: 'shift + tab', focusNext: 'tab'}
            ...
            _createUrlInput() {
                const e = this.locale.t, t = new vb(this.locale, Cb);
                return t.label = e('ad'), t.inputView.placeholder = 'https://example.com', t
            }
        ...
        var c_ = o(72), u_ = o.n(c_), m_ = o(73), p_ = o.n(m_), g_ = o(74), f_ = o.n(g_);
        class h_ extends ff {
            constructor(e) {
                super(e);
                const o = e.t;
                this.focusTracker = new rf, this.keystrokes = new Qg, this.previewButtonView = this._createPreviewButton(), this.unlinkButtonView = this._createButton(o('x'), u_.a, 'unlink'), this.editButtonView = this._createButton(o('y'), p_.a, 'edit'), this.set('href'), this._focusables = new sf, this._focusCycler = new Tf({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {focusPrevious: 'shift + tab', focusNext: 'tab'}
            ...
            _createButton(e, t, o) {
                const n = new dh(this.locale);
                return n.set({label: e, icon: t, tooltip: !0}), n.delegate('execute').to(this, o), n
            }

            _createPreviewButton() {
                const e = new dh(this.locale), o = this.bindTemplate, n = this.t;
                return e.set({
                    withText: !0,
                    tooltip: n('z')
                }), e.extendTemplate({
                ...
                }), e.bind('label').to(this, 'href', (e) = > e || n('aa')
            ),
        ...
        class w_ extends Vf {
            ...
            init() {
                const e = this.editor;
                e.editing.view.addObserver(a_), this.actionsView = this._createActionsView(), this.formView = this._createFormView(), this._balloon = e.plugins.get(Ib), this._createToolbarLinkButton(), this._enableUserBalloonInteractions()
            }

            _createActionsView() {
                const e = this.editor, t = new h_(e.locale), o = e.commands.get('link'), n = e.commands.get('unlink');
                return t.bind('href').to(o, 'value'), t.editButtonView.bind('isEnabled').to(o), t.unlinkButtonView.bind('isEnabled').to(n), this.listenTo(t, 'edit', () = > {this._addFormView()
            }),
                this.listenTo(t, 'unlink', () = > {e.execute('unlink'), this._hideUI()
            }),
                t.keystrokes.set('Esc', (e, t) = > {this._hideUI(), t()
            }),
                t.keystrokes.set(__, (e, t) = > {this._addFormView(), t()
            }),
                t
            }

            _createFormView() {
                const e = this.editor, t = new d_(e.locale), o = e.commands.get('link');
                return t.urlInputView.bind('value').to(o, 'value'), t.urlInputView.bind('isReadOnly').to(o, 'isEnabled', (e) = > !e
            ),
                t.saveButtonView.bind('isEnabled').to(o), this.listenTo(t, 'submit', () = > {e.execute('link', t.urlInputView.inputView.element.value), this._removeFormView()
            }),
                this.listenTo(t, 'cancel', () = > {this._removeFormView()
            }),
                t.keystrokes.set('Esc', (e, t) = > {this._removeFormView(), t()
            }),
                t
            }
            ...
            _createToolbarLinkButton() {
                ...
                e.keystrokes.set(__, (e, t) = > {t(), o.isEnabled && this._showUI()
            }),
                e.ui.componentFactory.add('link', (e) = > {const t = new dh(e);
                return t.isEnabled = !0, t.label = n('r'), t.icon = k_.a, t.keystroke = __, t.tooltip = !0, t.bind('isEnabled').to(o, 'isEnabled'), this.listenTo(t, 'execute', () = > this._showUI()
            ),
                t
            })
            }
            ...
            _enableUserBalloonInteractions() {
                ...
                this.editor.keystrokes.set('Tab', (e, t) = > {this._areActionsVisible && !this.actionsView.focusTracker.isFocused && (this.actionsView.focus(), t())
            },
                {
                    priority:'high'
                }
            ),
                this.editor.keystrokes.set('Esc', (e, t) = > {this._isUIVisible && (this._hideUI(), t())
            }),
                cr({emitter: this.formView, activator: () = > this._isUIVisible, contextElements
            :
            ...
            _startUpdatingUIOnViewRender() {
                ...
                this.listenTo(n, 'render', () = > {const t = this._getSelectedLinkElement(), o=e();
            ...
            _getSelectedLinkElement() {
                ...
                if (e.isCollapsed)return da(e.getFirstPosition()); else {
                    const t = e.getFirstRange().getTrimmed(), o = da(t.start), n = da(t.end);
                    return o && o == n ? vc.createIn(o).getTrimmed().isEqual(t) ? o : null : null
                }
            }
        }
        class v_ extends Vf {
        ...
        class y_ extends Bf {
            ...
            execute() {
                const e = this.editor.model, t = e.document,
                    o = Array.from(t.selection.getSelectedBlocks()).filter((t) = > ua(t, e.schema)
            ),
                n = !0 === this.value;
                e.change((e) = > {
                    if(n){
                        let t = o[o.length - 1].nextSibling, n = Fa, i = [];
        ...
        class x_ extends Bf {
            ...
            execute() {
                ...
                e.change((e) = > {const t = o[o.length - 1];
        ...
        class C_ extends Vf {
            ...
            init() {
                ...
                e.model.document.registerPostFixer((t) = > Aa(e.model, t)
            ),
                o.mapper.registerViewToModelLength('li', Va), t.mapper.registerViewToModelLength('li', Va), o.mapper.on('modelToViewPosition', xa), o.mapper.on('viewToModelPosition', Ca), t.mapper.on('modelToViewPosition', xa), o.downcastDispatcher.on('insert', ka, {priority: 'high'}), o.downcastDispatcher.on('insert:listItem', ga), t.downcastDispatcher.on('insert', ka, {priority: 'high'}), t.downcastDispatcher.on('insert:listItem', ga), o.downcastDispatcher.on('attribute:type:listItem', ha), t.downcastDispatcher.on('attribute:type:listItem', ha), o.downcastDispatcher.on('attribute:indent:listItem', ba), t.downcastDispatcher.on('attribute:indent:listItem', ba), o.downcastDispatcher.on('remove:listItem', fa), o.downcastDispatcher.on('remove', _a, {priority: 'low'}), t.downcastDispatcher.on('remove:listItem', fa), t.downcastDispatcher.on('remove', _a, {priority: 'low'}), t.upcastDispatcher.on('element:ul', va, {priority: 'high'}), t.upcastDispatcher.on('element:ol', va, {priority: 'high'}), t.upcastDispatcher.on('element:li', ya, {priority: 'high'}), t.upcastDispatcher.on('element:li', wa), e.model.on('insertContent', Ta, {priority: 'high'}), e.commands.add('numberedList', new y_(e, 'numbered')), e.commands.add('bulletedList', new y_(e, 'bulleted')), e.commands.add('indentList', new x_(e, 'forward')), e.commands.add('outdentList', new x_(e, 'backward'));
                ...
                this.listenTo(n, 'delete', (e, t) = > {if('backward' === t.direction
            )
                {
        ...
        var A_ = o(77), T_ = o.n(A_), P_ = o(78), E_ = o.n(P_);
        class S_ extends Vf {
            init() {
                const e = this.editor.t;
                this._addButton('numberedList', e('p'), T_.a), this._addButton('bulletedList', e('q'), E_.a)
            }

            _addButton(e, t, o) {
                const n = this.editor;
                n.ui.componentFactory.add(e, (i) = > {const r = n.commands.get(e), a=new dh(i);
                return a.set({
                    label: t,
                    icon: o,
                    tooltip: !0
                }), a.bind('isOn', 'isEnabled').to(r, 'value', 'isEnabled'), this.listenTo(a, 'execute', () = > n.execute(e)
            ),
                a
            })
            }
        ...
        t['default'] = R_, R_.build = {
            plugins: [hh, xh, Ph, Nh, qh, Qh, tk, Tk, Lb, Fk, Qk, Yk, ek, v_, O_, nk],
            config: {
